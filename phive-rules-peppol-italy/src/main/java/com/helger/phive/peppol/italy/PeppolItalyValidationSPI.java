...
/**
 * SPI implementation that registers the Peppol Italy validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class PeppolItalyValidationSPI implements IValidationRulesRegistrarSPI
{
  @NonNull
