...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice" mode="M10" priority="1246">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:UBLVersionID" mode="M10" priority="1245">
...
<xsl:template match="/ubl:Invoice/cbc:IssueDate" mode="M10" priority="1241">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:InvoiceTypeCode" mode="M10" priority="1240">
...
<xsl:template match="/ubl:Invoice/cbc:TaxPointDate" mode="M10" priority="1238">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:DocumentCurrencyCode" mode="M10" priority="1237">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:TaxCurrencyCode" mode="M10" priority="1236">
...
<xsl:template match="/ubl:Invoice/cbc:AccountingCost" mode="M10" priority="1235">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoicePeriod" mode="M10" priority="1234">
...
<xsl:template match="/ubl:Invoice/cac:InvoicePeriod/cbc:EndDate" mode="M10" priority="1232">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:OrderReference" mode="M10" priority="1231">
...
<xsl:template match="/ubl:Invoice/cac:OrderReference/cbc:ID" mode="M10" priority="1230">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference" mode="M10" priority="1229">
...
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference/cbc:ID" mode="M10" priority="1228">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference/cbc:DocumentTypeCode" mode="M10" priority="1227">
...
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference/cbc:DocumentType" mode="M10" priority="1226">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference" mode="M10" priority="1225">
...
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment" mode="M10" priority="1222">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject" mode="M10" priority="1221">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference" mode="M10" priority="1220">
...
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI" mode="M10" priority="1219">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty" mode="M10" priority="1218">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party" mode="M10" priority="1217">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID" mode="M10" priority="1216">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification" mode="M10" priority="1215">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M10" priority="1214">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName" mode="M10" priority="1213">
...
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name" mode="M10" priority="1212">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M10" priority="1211">
...
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M10" priority="1206">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country" mode="M10" priority="1205">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M10" priority="1204">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme" mode="M10" priority="1203">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M10" priority="1202">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M10" priority="1201">
...
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M10" priority="1200">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity" mode="M10" priority="1199">
...
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M10" priority="1198">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M10" priority="1197">
...
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M10" priority="1195">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M10" priority="1194">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M10" priority="1193">
...
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M10" priority="1187">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty" mode="M10" priority="1186">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party" mode="M10" priority="1185">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID" mode="M10" priority="1184">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification" mode="M10" priority="1183">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M10" priority="1182">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyName" mode="M10" priority="1181">
...
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name" mode="M10" priority="1180">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M10" priority="1179">
...
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M10" priority="1174">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country" mode="M10" priority="1173">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M10" priority="1172">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme" mode="M10" priority="1171">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M10" priority="1170">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M10" priority="1169">
...
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M10" priority="1168">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity" mode="M10" priority="1167">
...
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M10" priority="1166">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M10" priority="1165">
...
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M10" priority="1163">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M10" priority="1162">
...
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M10" priority="1161">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact" mode="M10" priority="1160">
...
<xsl:template match="/ubl:Invoice/cac:PayeeParty" mode="M10" priority="1154">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyIdentification" mode="M10" priority="1153">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyIdentification/cbc:ID" mode="M10" priority="1152">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyName" mode="M10" priority="1151">
...
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyLegalEntity" mode="M10" priority="1149">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyLegalEntity/cbc:CompanyID" mode="M10" priority="1148">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty" mode="M10" priority="1147">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyName" mode="M10" priority="1146">
...
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyName/cbc:Name" mode="M10" priority="1145">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress" mode="M10" priority="1144">
...
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:CountrySubentity" mode="M10" priority="1139">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cac:Country" mode="M10" priority="1138">
...
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M10" priority="1137">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme" mode="M10" priority="1136">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cbc:CompanyID" mode="M10" priority="1135">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme" mode="M10" priority="1134">
...
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation" mode="M10" priority="1130">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cbc:ID" mode="M10" priority="1129">
...
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" mode="M10" priority="1123">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country" mode="M10" priority="1122">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode" mode="M10" priority="1121">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans" mode="M10" priority="1120">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cbc:PaymentMeansCode" mode="M10" priority="1119">
...
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cbc:PaymentID" mode="M10" priority="1116">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount" mode="M10" priority="1115">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID" mode="M10" priority="1114">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch" mode="M10" priority="1113">
...
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID" mode="M10" priority="1112">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution" mode="M10" priority="1111">
...
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:CountrySubentity" mode="M10" priority="1103">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country" mode="M10" priority="1102">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country/cbc:IdentificationCode" mode="M10" priority="1101">
...
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cbc:Name" mode="M10" priority="1030">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:SellersItemIdentification" mode="M10" priority="1029">
...
<xsl:template match="cac:TaxSubtotal" mode="M11" priority="1002">
    <svrl:fired-rule context="cac:TaxSubtotal" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(cbc:TaxableAmount) or string-length(substring-after(cbc:TaxableAmount, '.')) &lt;= 2" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:TaxableAmount) or string-length(substring-after(cbc:TaxableAmount, '.')) &lt;= 2">
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(cbc:TaxAmount) or string-length(substring-after(cbc:TaxAmount, '.')) &lt;= 2" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:TaxAmount) or string-length(substring-after(cbc:TaxAmount, '.')) &lt;= 2">
          <xsl:attribute name="id">NOGOV-T10-R039</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
