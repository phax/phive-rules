...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="OPENPEPPOL  T58 bound to UBL">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>OPENPEPPOL  T58 bound to UBL</svrl:text>

<!--PATTERN UBL-T58-->


	<!--RULE -->
<xsl:template match="//cbc:EndpointID" mode="M7" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cbc:ResponseCode" mode="M7" priority="1001">
    <svrl:fired-rule context="//cbc:ResponseCode" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:ResponseCode" mode="M8" priority="1001">
    <svrl:fired-rule context="cbc:ResponseCode" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( ( not(contains(normalize-space(.),' ')) and contains( ' AP RE ',concat(' ',normalize-space(.),' ') ) ) )">
