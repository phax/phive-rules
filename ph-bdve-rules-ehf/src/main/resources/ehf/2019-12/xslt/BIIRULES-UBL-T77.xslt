...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="BIIRULES  T77 bound to UBL">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>BIIRULES  T77 bound to UBL</svrl:text>

<!--PATTERN UBL-T77-->


	<!--RULE -->
<xsl:template match="/ubl:Catalogue" mode="M7" priority="1006">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cac:CatalogueLine/cac:RequiredItemLocationQuantity/cac:Price/cbc:PriceAmount/@currencyID)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ValidityPeriod/cbc:EndDate) &lt;= 1">
	...
	<!--RULE -->
<xsl:template match="//cac:ProviderParty" mode="M7" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:ReceiverParty" mode="M7" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:CatalogueLine" mode="M7" priority="1003">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:RequiredItemLocationQuantity/cac:DeliveryUnit/cbc:BatchQuantity) = 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="number(cac:RequiredItemLocationQuantity/cac:DeliveryUnit/cbc:BatchQuantity)>=0">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ComponentRelatedItem/cbc:ID) &lt;= 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ManufacturersItemIdentification/cbc:ID) &lt;= 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ItemSpecificationDocumentReference) &lt;= 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ItemSpecificationDocumentReference/cbc:DocumentDescription) &lt;= 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ManufacturerParty/cac:PartyName/cbc:Name) &lt;= 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ClassifiedTaxCategory/cbc:ID) = 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cac:ClassifiedTaxCategory/cbc:Percent) = 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(cbc:CommodityClassification) &lt;= 1">
	...
	<!--RULE -->
<xsl:template match="//cac:CommodityClassification/cbc:ItemClassificationCode" mode="M7" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:RequiredItemLocationQuantity/cac:Price" mode="M7" priority="1000">
...
<!--PATTERN CodesT77-->
	...
	<!--RULE -->
<xsl:template match="@mimeCode" mode="M8" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:ClassifiedTaxCategory/cbc:ID" mode="M8" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:ActionCode" mode="M8" priority="1003">
    <svrl:fired-rule context="cbc:ActionCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="( ( not(contains(normalize-space(.),' ')) and contains( ' true false ',concat(' ',normalize-space(.),' ') ) ) )" />
      <xsl:otherwise>
        <svrl:failed-assert test="( ( not(contains(normalize-space(.),' ')) and contains( ' true false ',concat(' ',normalize-space(.),' ') ) ) )">
	...
	<!--RULE -->
<xsl:template match="cbc:ItemClassificationCode/@listID" mode="M8" priority="1002">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( ( not(contains(normalize-space(.),' ')) and contains( ' CV GN HS CPV UNSPSC eCLASS ',concat(' ',normalize-space(.),' ') ) ) )">
	...
	<!--RULE -->
<xsl:template match="@currencyID" mode="M8" priority="1001">
