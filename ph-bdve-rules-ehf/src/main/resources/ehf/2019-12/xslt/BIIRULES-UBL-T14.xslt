...
<!--PATTERN UBL-T14-->
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge" mode="M7" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:CreditNoteLine" mode="M7" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = 'VAT']" mode="M7" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:*/@currencyID" mode="M8" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans//cbc:PaymentMeansCode" mode="M8" priority="1002">
