...
<!--PATTERN UBL-T58-->
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse" mode="M6" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:ReceiverParty" mode="M6" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:SenderParty" mode="M6" priority="1000">
