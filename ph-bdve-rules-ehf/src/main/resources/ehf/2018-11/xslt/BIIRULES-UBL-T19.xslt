...
<!--PATTERN UBL-T19-->
	...
	<!--RULE -->
<xsl:template match="/ubl:Catalogue" mode="M7" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:ContractorCustomerParty" mode="M7" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:CatalogueLine" mode="M7" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:ProviderParty" mode="M7" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:ReceiverParty" mode="M7" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:SellerSupplierParty" mode="M7" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:Item" mode="M7" priority="1005">
...
- Standard identifier</svrl:text>
	...
	<!--RULE -->
<xsl:template match="//cac:CommodityClassification/cbc:ItemClassificationCode" mode="M7" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:RequiredItemLocationQuantity/cac:Price" mode="M7" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:AdditionalItemProperty" mode="M7" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:StandardItemIdentification" mode="M7" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:ValidityPeriod" mode="M7" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( ( not(contains(normalize-space(.),' ')) and contains( ' Add Delete Update ',concat(' ',normalize-space(.),' ') ) ) )">
