...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice" mode="M11" priority="1246">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:PaymentMeans">
          ...
          <svrl:text>Element 'cac:PaymentMeans ' MUST be provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:InvoiceLine">
          <xsl:attribute name="id">EHF-T10-B00113</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:UBLVersionID" mode="M11" priority="1245">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:CustomizationID" mode="M11" priority="1244">
    <svrl:fired-rule context="/ubl:Invoice/cbc:CustomizationID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:ProfileID" mode="M11" priority="1243">
    <svrl:fired-rule context="/ubl:Invoice/cbc:ProfileID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:ID" mode="M11" priority="1242">
    <svrl:fired-rule context="/ubl:Invoice/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:IssueDate" mode="M11" priority="1241">
    <svrl:fired-rule context="/ubl:Invoice/cbc:IssueDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:InvoiceTypeCode" mode="M11" priority="1240">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:Note" mode="M11" priority="1239">
    <svrl:fired-rule context="/ubl:Invoice/cbc:Note" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:TaxPointDate" mode="M11" priority="1238">
    <svrl:fired-rule context="/ubl:Invoice/cbc:TaxPointDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:DocumentCurrencyCode" mode="M11" priority="1237">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:TaxCurrencyCode" mode="M11" priority="1236">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cbc:AccountingCost" mode="M11" priority="1235">
    <svrl:fired-rule context="/ubl:Invoice/cbc:AccountingCost" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoicePeriod" mode="M11" priority="1234">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoicePeriod/cbc:StartDate" mode="M11" priority="1233">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoicePeriod/cbc:StartDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoicePeriod/cbc:EndDate" mode="M11" priority="1232">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoicePeriod/cbc:EndDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:OrderReference" mode="M11" priority="1231">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:OrderReference/cbc:ID" mode="M11" priority="1230">
    <svrl:fired-rule context="/ubl:Invoice/cac:OrderReference/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference" mode="M11" priority="1229">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference/cbc:ID" mode="M11" priority="1228">
    <svrl:fired-rule context="/ubl:Invoice/cac:ContractDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference/cbc:DocumentTypeCode" mode="M11" priority="1227">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:ContractDocumentReference/cbc:DocumentType" mode="M11" priority="1226">
    <svrl:fired-rule context="/ubl:Invoice/cac:ContractDocumentReference/cbc:DocumentType" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference" mode="M11" priority="1225">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cbc:ID" mode="M11" priority="1224">
    <svrl:fired-rule context="/ubl:Invoice/cac:AdditionalDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cbc:DocumentType" mode="M11" priority="1223">
    <svrl:fired-rule context="/ubl:Invoice/cac:AdditionalDocumentReference/cbc:DocumentType" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment" mode="M11" priority="1222">
    <svrl:fired-rule context="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject" mode="M11" priority="1221">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference" mode="M11" priority="1220">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:URI">
          <xsl:attribute name="id">EHF-T10-B03201</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI" mode="M11" priority="1219">
    <svrl:fired-rule context="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty" mode="M11" priority="1218">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party" mode="M11" priority="1217">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID" mode="M11" priority="1216">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification" mode="M11" priority="1215">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M11" priority="1214">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName" mode="M11" priority="1213">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name" mode="M11" priority="1212">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M11" priority="1211">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M11" priority="1210">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M11" priority="1209">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M11" priority="1208">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M11" priority="1207">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M11" priority="1206">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country" mode="M11" priority="1205">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M11" priority="1204">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme" mode="M11" priority="1203">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M11" priority="1202">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M11" priority="1201">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M11" priority="1200">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity" mode="M11" priority="1199">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M11" priority="1198">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M11" priority="1197">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" mode="M11" priority="1196">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M11" priority="1195">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M11" priority="1194">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M11" priority="1193">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact" mode="M11" priority="1192">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ID" mode="M11" priority="1191">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Name" mode="M11" priority="1190">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone" mode="M11" priority="1189">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telefax" mode="M11" priority="1188">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telefax" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M11" priority="1187">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty" mode="M11" priority="1186">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party" mode="M11" priority="1185">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID" mode="M11" priority="1184">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification" mode="M11" priority="1183">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M11" priority="1182">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyName" mode="M11" priority="1181">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name" mode="M11" priority="1180">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M11" priority="1179">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M11" priority="1178">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M11" priority="1177">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M11" priority="1176">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M11" priority="1175">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M11" priority="1174">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country" mode="M11" priority="1173">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M11" priority="1172">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme" mode="M11" priority="1171">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M11" priority="1170">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M11" priority="1169">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M11" priority="1168">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity" mode="M11" priority="1167">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M11" priority="1166">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M11" priority="1165">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" mode="M11" priority="1164">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M11" priority="1163">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M11" priority="1162">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:IdentificationCode">
          <xsl:attribute name="id">EHF-T10-B10301</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M11" priority="1161">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact" mode="M11" priority="1160">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ID" mode="M11" priority="1159">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Name" mode="M11" priority="1158">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone" mode="M11" priority="1157">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telefax" mode="M11" priority="1156">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telefax" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M11" priority="1155">
    <svrl:fired-rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty" mode="M11" priority="1154">
    <svrl:fired-rule context="/ubl:Invoice/cac:PayeeParty" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyIdentification" mode="M11" priority="1153">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyIdentification/cbc:ID" mode="M11" priority="1152">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyName" mode="M11" priority="1151">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyName/cbc:Name" mode="M11" priority="1150">
    <svrl:fired-rule context="/ubl:Invoice/cac:PayeeParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyLegalEntity" mode="M11" priority="1149">
    <svrl:fired-rule context="/ubl:Invoice/cac:PayeeParty/cac:PartyLegalEntity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PayeeParty/cac:PartyLegalEntity/cbc:CompanyID" mode="M11" priority="1148">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty" mode="M11" priority="1147">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyName" mode="M11" priority="1146">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyName/cbc:Name" mode="M11" priority="1145">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress" mode="M11" priority="1144">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:StreetName" mode="M11" priority="1143">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:AdditionalStreetName" mode="M11" priority="1142">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:AdditionalStreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:CityName" mode="M11" priority="1141">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:PostalZone" mode="M11" priority="1140">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:CountrySubentity" mode="M11" priority="1139">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cac:Country" mode="M11" priority="1138">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:IdentificationCode">
          <xsl:attribute name="id">EHF-T10-B12901</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M11" priority="1137">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme" mode="M11" priority="1136">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cbc:CompanyID" mode="M11" priority="1135">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme" mode="M11" priority="1134">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M11" priority="1133">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery" mode="M11" priority="1132">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cbc:ActualDeliveryDate" mode="M11" priority="1131">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cbc:ActualDeliveryDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation" mode="M11" priority="1130">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cbc:ID" mode="M11" priority="1129">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M11" priority="1128">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" mode="M11" priority="1127">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName" mode="M11" priority="1126">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" mode="M11" priority="1125">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" mode="M11" priority="1124">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" mode="M11" priority="1123">
    <svrl:fired-rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country" mode="M11" priority="1122">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:IdentificationCode">
          <xsl:attribute name="id">EHF-T10-B14701</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode" mode="M11" priority="1121">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans " mode="M11" priority="1120">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:PaymentMeansCode">
          <xsl:attribute name="id">EHF-T10-B15001</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:PaymentDueDate">
          <xsl:attribute name="id">EHF-T10-B15002</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>Element 'cbc:PaymentDueDate' MUST be provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:PayeeFinancialAccount">
          <xsl:attribute name="id">EHF-T10-B15003</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>Element 'cac:PayeeFinancialAccount' MUST be provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentMeansCode" mode="M11" priority="1119">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@listID">
          <xsl:attribute name="id">EHF-T10-B15101</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentDueDate" mode="M11" priority="1118">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentDueDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentChannelCode" mode="M11" priority="1117">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentChannelCode" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentID" mode="M11" priority="1116">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount" mode="M11" priority="1115">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ID">
          <xsl:attribute name="id">EHF-T10-B15601</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cbc:ID" mode="M11" priority="1114">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch" mode="M11" priority="1113">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID" mode="M11" priority="1112">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution" mode="M11" priority="1111">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ID">
          <xsl:attribute name="id">EHF-T10-B16101</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cbc:ID" mode="M11" priority="1110">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cbc:Name" mode="M11" priority="1109">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address" mode="M11" priority="1108">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:StreetName" mode="M11" priority="1107">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:AdditionalStreetName" mode="M11" priority="1106">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:CityName" mode="M11" priority="1105">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:PostalZone" mode="M11" priority="1104">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:CountrySubentity" mode="M11" priority="1103">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country" mode="M11" priority="1102">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country/cbc:IdentificationCode" mode="M11" priority="1101">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country/cbc:IdentificationCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(@listID) or @listID = 'ISO3166-1:Alpha2'" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(@listID) or @listID = 'ISO3166-1:Alpha2'">
          <xsl:attribute name="id">EHF-T10-B17201</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>Attribute 'listID' MUST contain value 'ISO3166-1:Alpha2'</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentTerms" mode="M11" priority="1100">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:PaymentTerms/cbc:Note" mode="M11" priority="1099">
    <svrl:fired-rule context="/ubl:Invoice/cac:PaymentTerms/cbc:Note" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge" mode="M11" priority="1098">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cbc:ChargeIndicator" mode="M11" priority="1097">
    <svrl:fired-rule context="/ubl:Invoice/cac:AllowanceCharge/cbc:ChargeIndicator" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode" mode="M11" priority="1096">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@listID">
          <xsl:attribute name="id">EHF-T10-B17801</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cbc:AllowanceChargeReason" mode="M11" priority="1095">
    <svrl:fired-rule context="/ubl:Invoice/cac:AllowanceCharge/cbc:AllowanceChargeReason" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cbc:Amount" mode="M11" priority="1094">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory" mode="M11" priority="1093">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory/cbc:ID" mode="M11" priority="1092">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory/cbc:Percent" mode="M11" priority="1091">
    <svrl:fired-rule context="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory/cbc:Percent" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme" mode="M11" priority="1090">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ID">
          <xsl:attribute name="id">EHF-T10-B18701</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID" mode="M11" priority="1089">
    <svrl:fired-rule context="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxExchangeRate" mode="M11" priority="1088">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:SourceCurrencyCode">
          <xsl:attribute name="id">EHF-T10-B18901</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:TargetCurrencyCode">
          <xsl:attribute name="id">EHF-T10-B18902</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:CalculationRate">
          <xsl:attribute name="id">EHF-T10-B18903</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:MathematicOperatorCode">
          <xsl:attribute name="id">EHF-T10-B18904</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxExchangeRate/cbc:SourceCurrencyCode" mode="M11" priority="1087">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxExchangeRate/cbc:TargetCurrencyCode" mode="M11" priority="1086">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@listID">
          <xsl:attribute name="id">EHF-T10-B19201</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxExchangeRate/cbc:CalculationRate" mode="M11" priority="1085">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxExchangeRate/cbc:CalculationRate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxExchangeRate/cbc:MathematicOperatorCode" mode="M11" priority="1084">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxExchangeRate/cbc:Date" mode="M11" priority="1083">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxExchangeRate/cbc:Date" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal" mode="M11" priority="1082">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:TaxSubtotal">
          <xsl:attribute name="id">EHF-T10-B19702</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cbc:TaxAmount" mode="M11" priority="1081">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B19801</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal" mode="M11" priority="1080">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:TaxableAmount">
          <xsl:attribute name="id">EHF-T10-B20001</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:TaxAmount">
          <xsl:attribute name="id">EHF-T10-B20002</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:TaxCategory">
          <xsl:attribute name="id">EHF-T10-B20003</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount" mode="M11" priority="1079">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount" mode="M11" priority="1078">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cbc:TransactionCurrencyTaxAmount" mode="M11" priority="1077">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory" mode="M11" priority="1076">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID" mode="M11" priority="1075">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@schemeID">
          <xsl:attribute name="id">EHF-T10-B20801</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent" mode="M11" priority="1074">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReason" mode="M11" priority="1073">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReason" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme" mode="M11" priority="1072">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ID">
          <xsl:attribute name="id">EHF-T10-B21201</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID" mode="M11" priority="1071">
    <svrl:fired-rule context="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal" mode="M11" priority="1070">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:LineExtensionAmount">
          <xsl:attribute name="id">EHF-T10-B21401</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:TaxExclusiveAmount">
          <xsl:attribute name="id">EHF-T10-B21402</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:TaxInclusiveAmount">
          <xsl:attribute name="id">EHF-T10-B21403</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:PayableAmount">
          <xsl:attribute name="id">EHF-T10-B21404</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount" mode="M11" priority="1069">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B21501</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount" mode="M11" priority="1068">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B21701</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount" mode="M11" priority="1067">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount" mode="M11" priority="1066">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount" mode="M11" priority="1065">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B22301</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:PrepaidAmount" mode="M11" priority="1064">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B22501</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:PayableRoundingAmount" mode="M11" priority="1063">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B22701</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:PayableAmount" mode="M11" priority="1062">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B22901</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine" mode="M11" priority="1061">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ID">
          <xsl:attribute name="id">EHF-T10-B23101</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:InvoicedQuantity">
          <xsl:attribute name="id">EHF-T10-B23102</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:LineExtensionAmount">
          <xsl:attribute name="id">EHF-T10-B23103</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:Item">
          <xsl:attribute name="id">EHF-T10-B23104</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:Price">
          <xsl:attribute name="id">EHF-T10-B23105</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cbc:ID" mode="M11" priority="1060">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cbc:Note" mode="M11" priority="1059">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cbc:Note" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cbc:InvoicedQuantity" mode="M11" priority="1058">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@unitCode">
          <xsl:attribute name="id">EHF-T10-B23401</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@unitCodeListID">
          <xsl:attribute name="id">EHF-T10-B23402</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cbc:LineExtensionAmount" mode="M11" priority="1057">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B23701</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cbc:AccountingCost" mode="M11" priority="1056">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cbc:AccountingCost" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod" mode="M11" priority="1055">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:StartDate" mode="M11" priority="1054">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:StartDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:EndDate" mode="M11" priority="1053">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:EndDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:OrderLineReference" mode="M11" priority="1052">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:OrderLineReference/cbc:LineID" mode="M11" priority="1051">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:OrderLineReference/cbc:LineID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery" mode="M11" priority="1050">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ActualDeliveryDate">
          <xsl:attribute name="id">EHF-T10-B24501</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cbc:ActualDeliveryDate" mode="M11" priority="1049">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cbc:ActualDeliveryDate" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation" mode="M11" priority="1048">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cbc:ID" mode="M11" priority="1047">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M11" priority="1046">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:Country">
          <xsl:attribute name="id">EHF-T10-B25001</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" mode="M11" priority="1045">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName" mode="M11" priority="1044">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" mode="M11" priority="1043">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" mode="M11" priority="1042">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" mode="M11" priority="1041">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country" mode="M11" priority="1040">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:IdentificationCode">
          <xsl:attribute name="id">EHF-T10-B25601</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode" mode="M11" priority="1039">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge" mode="M11" priority="1038">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ChargeIndicator">
          <xsl:attribute name="id">EHF-T10-B25901</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:Amount">
          <xsl:attribute name="id">EHF-T10-B25902</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:ChargeIndicator" mode="M11" priority="1037">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:ChargeIndicator" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:AllowanceChargeReason" mode="M11" priority="1036">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:AllowanceChargeReason" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:Amount" mode="M11" priority="1035">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B26201</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:TaxTotal" mode="M11" priority="1034">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:TaxAmount">
          <xsl:attribute name="id">EHF-T10-B26401</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:TaxTotal/cbc:TaxAmount" mode="M11" priority="1033">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B26501</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item" mode="M11" priority="1032">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:ClassifiedTaxCategory">
          <xsl:attribute name="id">EHF-T10-B26702</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cbc:Description" mode="M11" priority="1031">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cbc:Description" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cbc:Name" mode="M11" priority="1030">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:SellersItemIdentification" mode="M11" priority="1029">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:SellersItemIdentification" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cbc:ID" mode="M11" priority="1028">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:StandardItemIdentification" mode="M11" priority="1027">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cbc:ID" mode="M11" priority="1026">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:OriginCountry" mode="M11" priority="1025">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:IdentificationCode">
          <xsl:attribute name="id">EHF-T10-B27501</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:OriginCountry/cbc:IdentificationCode" mode="M11" priority="1024">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:CommodityClassification" mode="M11" priority="1023">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ItemClassificationCode">
          <xsl:attribute name="id">EHF-T10-B27801</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode" mode="M11" priority="1022">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory" mode="M11" priority="1021">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ID">
          <xsl:attribute name="id">EHF-T10-B28101</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:TaxScheme">
          <xsl:attribute name="id">EHF-T10-B28102</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID" mode="M11" priority="1020">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:Percent" mode="M11" priority="1019">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:Percent" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme" mode="M11" priority="1018">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ID">
          <xsl:attribute name="id">EHF-T10-B28501</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:ID" mode="M11" priority="1017">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty" mode="M11" priority="1016">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:Name">
          <xsl:attribute name="id">EHF-T10-B28701</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:Value">
          <xsl:attribute name="id">EHF-T10-B28702</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:Name" mode="M11" priority="1015">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:Value" mode="M11" priority="1014">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty/cbc:Value" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty" mode="M11" priority="1013">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cac:PartyName">
          <xsl:attribute name="id">EHF-T10-B29001</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyName" mode="M11" priority="1012">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:Name">
          <xsl:attribute name="id">EHF-T10-B29101</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyName/cbc:Name" mode="M11" priority="1011">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyLegalEntity" mode="M11" priority="1010">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyLegalEntity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyLegalEntity/cbc:CompanyID" mode="M11" priority="1009">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@schemeID">
          <xsl:attribute name="id">EHF-T10-B29401</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price" mode="M11" priority="1008">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:PriceAmount">
          <xsl:attribute name="id">EHF-T10-B29601</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cbc:PriceAmount" mode="M11" priority="1007">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B29701</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cbc:BaseQuantity" mode="M11" priority="1006">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cbc:BaseQuantity" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge" mode="M11" priority="1005">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ChargeIndicator">
          <xsl:attribute name="id">EHF-T10-B30001</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:Amount">
          <xsl:attribute name="id">EHF-T10-B30002</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:ChargeIndicator" mode="M11" priority="1004">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:ChargeIndicator" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:AllowanceChargeReason" mode="M11" priority="1003">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:AllowanceChargeReason" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:MultiplierFactorNumeric" mode="M11" priority="1002">
    <svrl:fired-rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:MultiplierFactorNumeric" />
    <xsl:apply-templates mode="M11" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:Amount" mode="M11" priority="1001">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B30401</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount" mode="M11" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@currencyID">
          <xsl:attribute name="id">EHF-T10-B30601</xsl:attribute>
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:variable name="isB2C" select="$isZ01 or //cac:AdditionalDocumentReference/cbc:DocumentType = 'elektroniskB2Cfaktura'" />
  <xsl:variable name="documentCurrencyCode" select="/ubl:Invoice/cbc:DocumentCurrencyCode" />
	...
	<!--RULE -->
<xsl:template match="cbc:ProfileID" mode="M12" priority="1020">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:InvoiceTypeCode" mode="M12" priority="1019">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party" mode="M12" priority="1018">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans" mode="M12" priority="1017">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID[@schemeID = 'BBAN']" mode="M12" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID[@schemeID = 'IBAN']" mode="M12" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:OrderReference" mode="M12" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine" mode="M12" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Item" mode="M12" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:OriginCountry" mode="M12" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:ManufacturerParty" mode="M12" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CommodityClassification" mode="M12" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice" mode="M12" priority="1008">
    <svrl:fired-rule context="ubl:Invoice" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:PaymentTerms" mode="M12" priority="1007">
    <svrl:fired-rule context="ubl:Invoice/cac:PaymentTerms" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxRepresentativeParty" mode="M12" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:TaxTotal" mode="M12" priority="1005">
    <svrl:fired-rule context="ubl:Invoice/cac:TaxTotal" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:Amount | cbc:TaxableAmount | cbc:TaxAmount | cbc:LineExtensionAmount | cbc:PriceAmount | cbc:BaseAmount | cac:LegalMonetaryTotal/cbc:*" mode="M12" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" mode="M12" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxSubtotal" mode="M12" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AllowanceCharge" mode="M12" priority="1001">
    <svrl:fired-rule context="ubl:Invoice/cac:AllowanceCharge" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal" mode="M12" priority="1000">
...
<xsl:variable name="taxCategoryPercents" select="for $cat in /ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory return u:cat2str($cat)" />
  <xsl:variable name="taxCategories" select="for $cat in /ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory return normalize-space($cat/cbc:ID)" />
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice" mode="M13" priority="1015">
    <svrl:fired-rule context="ubl:Invoice" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:UBLVersionID" mode="M13" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party" mode="M13" priority="1013">
    <svrl:fired-rule context="cac:AccountingSupplierParty/cac:Party" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" mode="M13" priority="1012">
    <svrl:fired-rule context="cac:AccountingCustomerParty/cac:Party" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Delivery/cac:DeliveryLocation/cbc:ID[@schemeID]" mode="M13" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PartyLegalEntity" mode="M13" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PayeeFinancialAccount/cbc:ID[@schemeID]" mode="M13" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal" mode="M13" priority="1008">
    <svrl:fired-rule context="cac:LegalMonetaryTotal" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge" mode="M13" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine" mode="M13" priority="1006">
    <svrl:fired-rule context="cac:InvoiceLine" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Price/cbc:BaseQuantity" mode="M13" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxSubtotal" mode="M13" priority="1004">
    <svrl:fired-rule context="cac:TaxSubtotal" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge/cac:TaxCategory[cbc:Percent] | cac:Item/cac:ClassifiedTaxCategory[cbc:Percent]" mode="M13" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge/cac:TaxCategory | cac:Item/cac:ClassifiedTaxCategory" mode="M13" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxScheme" mode="M13" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxScheme/cbc:ID" mode="M13" priority="1000">
