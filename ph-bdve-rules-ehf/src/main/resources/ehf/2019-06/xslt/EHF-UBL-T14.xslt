...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote" mode="M9" priority="1247">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:UBLVersionID" mode="M9" priority="1246">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:CustomizationID" mode="M9" priority="1245">
    <svrl:fired-rule context="/ubl:CreditNote/cbc:CustomizationID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:ProfileID" mode="M9" priority="1244">
    <svrl:fired-rule context="/ubl:CreditNote/cbc:ProfileID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:ID" mode="M9" priority="1243">
    <svrl:fired-rule context="/ubl:CreditNote/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:IssueDate" mode="M9" priority="1242">
    <svrl:fired-rule context="/ubl:CreditNote/cbc:IssueDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:TaxPointDate" mode="M9" priority="1241">
    <svrl:fired-rule context="/ubl:CreditNote/cbc:TaxPointDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:Note" mode="M9" priority="1240">
    <svrl:fired-rule context="/ubl:CreditNote/cbc:Note" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:DocumentCurrencyCode" mode="M9" priority="1239">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:TaxCurrencyCode" mode="M9" priority="1238">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cbc:AccountingCost" mode="M9" priority="1237">
    <svrl:fired-rule context="/ubl:CreditNote/cbc:AccountingCost" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:InvoicePeriod" mode="M9" priority="1236">
    <svrl:fired-rule context="/ubl:CreditNote/cac:InvoicePeriod" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:InvoicePeriod/cbc:StartDate" mode="M9" priority="1235">
    <svrl:fired-rule context="/ubl:CreditNote/cac:InvoicePeriod/cbc:StartDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:InvoicePeriod/cbc:EndDate" mode="M9" priority="1234">
    <svrl:fired-rule context="/ubl:CreditNote/cac:InvoicePeriod/cbc:EndDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:OrderReference" mode="M9" priority="1233">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:OrderReference/cbc:ID" mode="M9" priority="1232">
    <svrl:fired-rule context="/ubl:CreditNote/cac:OrderReference/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:BillingReference" mode="M9" priority="1231">
    <svrl:fired-rule context="/ubl:CreditNote/cac:BillingReference" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference" mode="M9" priority="1230">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" mode="M9" priority="1229">
    <svrl:fired-rule context="/ubl:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate" mode="M9" priority="1228">
    <svrl:fired-rule context="/ubl:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:BillingReference/cac:CreditNoteDocumentReference" mode="M9" priority="1227">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:BillingReference/cac:CreditNoteDocumentReference/cbc:ID" mode="M9" priority="1226">
    <svrl:fired-rule context="/ubl:CreditNote/cac:BillingReference/cac:CreditNoteDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:BillingReference/cac:CreditNoteDocumentReference/cbc:IssueDate" mode="M9" priority="1225">
    <svrl:fired-rule context="/ubl:CreditNote/cac:BillingReference/cac:CreditNoteDocumentReference/cbc:IssueDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:ContractDocumentReference" mode="M9" priority="1224">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:ContractDocumentReference/cbc:ID" mode="M9" priority="1223">
    <svrl:fired-rule context="/ubl:CreditNote/cac:ContractDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:ContractDocumentReference/cbc:DocumentTypeCode" mode="M9" priority="1222">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:ContractDocumentReference/cbc:DocumentType" mode="M9" priority="1221">
    <svrl:fired-rule context="/ubl:CreditNote/cac:ContractDocumentReference/cbc:DocumentType" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AdditionalDocumentReference" mode="M9" priority="1220">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AdditionalDocumentReference/cbc:ID" mode="M9" priority="1219">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AdditionalDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentType" mode="M9" priority="1218">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentType" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AdditionalDocumentReference/cac:Attachment" mode="M9" priority="1217">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AdditionalDocumentReference/cac:Attachment" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject" mode="M9" priority="1216">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference" mode="M9" priority="1215">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI" mode="M9" priority="1214">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty" mode="M9" priority="1213">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party" mode="M9" priority="1212">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID" mode="M9" priority="1211">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification" mode="M9" priority="1210">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M9" priority="1209">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName" mode="M9" priority="1208">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name" mode="M9" priority="1207">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M9" priority="1206">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M9" priority="1205">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M9" priority="1204">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M9" priority="1203">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M9" priority="1202">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M9" priority="1201">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country" mode="M9" priority="1200">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M9" priority="1199">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme" mode="M9" priority="1198">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M9" priority="1197">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M9" priority="1196">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M9" priority="1195">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity" mode="M9" priority="1194">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M9" priority="1193">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M9" priority="1192">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" mode="M9" priority="1191">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M9" priority="1190">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M9" priority="1189">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M9" priority="1188">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact" mode="M9" priority="1187">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ID" mode="M9" priority="1186">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Name" mode="M9" priority="1185">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone" mode="M9" priority="1184">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telefax" mode="M9" priority="1183">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telefax" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M9" priority="1182">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty" mode="M9" priority="1181">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party" mode="M9" priority="1180">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID" mode="M9" priority="1179">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification" mode="M9" priority="1178">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M9" priority="1177">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyName" mode="M9" priority="1176">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name" mode="M9" priority="1175">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M9" priority="1174">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M9" priority="1173">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M9" priority="1172">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M9" priority="1171">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M9" priority="1170">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M9" priority="1169">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country" mode="M9" priority="1168">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M9" priority="1167">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme" mode="M9" priority="1166">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M9" priority="1165">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M9" priority="1164">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M9" priority="1163">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity" mode="M9" priority="1162">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M9" priority="1161">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M9" priority="1160">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact" mode="M9" priority="1159">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ID" mode="M9" priority="1158">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Name" mode="M9" priority="1157">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone" mode="M9" priority="1156">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telefax" mode="M9" priority="1155">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telefax" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M9" priority="1154">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PayeeParty" mode="M9" priority="1153">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PayeeParty" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PayeeParty/cac:PartyIdentification" mode="M9" priority="1152">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PayeeParty/cac:PartyIdentification/cbc:ID" mode="M9" priority="1151">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PayeeParty/cac:PartyName" mode="M9" priority="1150">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PayeeParty/cac:PartyName/cbc:Name" mode="M9" priority="1149">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PayeeParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PayeeParty/cac:PartyLegalEntity" mode="M9" priority="1148">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PayeeParty/cac:PartyLegalEntity/cbc:CompanyID" mode="M9" priority="1147">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxRepresentativeParty" mode="M9" priority="1146">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyName" mode="M9" priority="1145">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyName/cbc:Name" mode="M9" priority="1144">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme" mode="M9" priority="1143">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cbc:CompanyID" mode="M9" priority="1142">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme" mode="M9" priority="1141">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M9" priority="1140">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery" mode="M9" priority="1139">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cbc:ActualDeliveryDate" mode="M9" priority="1138">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cbc:ActualDeliveryDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation" mode="M9" priority="1137">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cbc:ID" mode="M9" priority="1136">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M9" priority="1135">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" mode="M9" priority="1134">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName" mode="M9" priority="1133">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" mode="M9" priority="1132">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" mode="M9" priority="1131">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" mode="M9" priority="1130">
    <svrl:fired-rule context="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country" mode="M9" priority="1129">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode" mode="M9" priority="1128">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans" mode="M9" priority="1127">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cbc:PaymentMeansCode" mode="M9" priority="1126">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cbc:PaymentDueDate" mode="M9" priority="1125">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentMeans/cbc:PaymentDueDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cbc:PaymentChannelCode" mode="M9" priority="1124">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentMeans/cbc:PaymentChannelCode" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cbc:PaymentID" mode="M9" priority="1123">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentMeans/cbc:PaymentID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount" mode="M9" priority="1122">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID" mode="M9" priority="1121">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch" mode="M9" priority="1120">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID" mode="M9" priority="1119">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution" mode="M9" priority="1118">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cbc:ID" mode="M9" priority="1117">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cbc:Name" mode="M9" priority="1116">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address" mode="M9" priority="1115">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:StreetName" mode="M9" priority="1114">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:AdditionalStreetName" mode="M9" priority="1113">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:CityName" mode="M9" priority="1112">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:PostalZone" mode="M9" priority="1111">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:CountrySubentity" mode="M9" priority="1110">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country" mode="M9" priority="1109">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country/cbc:IdentificationCode" mode="M9" priority="1108">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentTerms" mode="M9" priority="1107">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentTerms/cbc:Note" mode="M9" priority="1106">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentTerms/cbc:Note" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxExchangeRate" mode="M9" priority="1105">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxExchangeRate/cbc:SourceCurrencyCode" mode="M9" priority="1104">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxExchangeRate/cbc:TargetCurrencyCode" mode="M9" priority="1103">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxExchangeRate/cbc:CalculationRate" mode="M9" priority="1102">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxExchangeRate/cbc:CalculationRate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxExchangeRate/cbc:MathematicOperatorCode" mode="M9" priority="1101">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxExchangeRate/cbc:MathematicOperatorCode" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxExchangeRate/cbc:Date" mode="M9" priority="1100">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxExchangeRate/cbc:Date" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge" mode="M9" priority="1099">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cbc:ChargeIndicator" mode="M9" priority="1098">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AllowanceCharge/cbc:ChargeIndicator" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode" mode="M9" priority="1097">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReason" mode="M9" priority="1096">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReason" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cbc:Amount" mode="M9" priority="1095">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory" mode="M9" priority="1094">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:ID" mode="M9" priority="1093">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:Percent" mode="M9" priority="1092">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:Percent" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme" mode="M9" priority="1091">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID" mode="M9" priority="1090">
    <svrl:fired-rule context="/ubl:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal" mode="M9" priority="1089">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cbc:TaxAmount" mode="M9" priority="1088">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal" mode="M9" priority="1087">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount" mode="M9" priority="1086">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount" mode="M9" priority="1085">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TransactionCurrencyTaxAmount" mode="M9" priority="1084">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory" mode="M9" priority="1083">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID" mode="M9" priority="1082">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent" mode="M9" priority="1081">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReason" mode="M9" priority="1080">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReason" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme" mode="M9" priority="1079">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID" mode="M9" priority="1078">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal" mode="M9" priority="1077">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount" mode="M9" priority="1076">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount" mode="M9" priority="1075">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount" mode="M9" priority="1074">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount" mode="M9" priority="1073">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount" mode="M9" priority="1072">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:PrepaidAmount" mode="M9" priority="1071">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:PayableRoundingAmount" mode="M9" priority="1070">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount" mode="M9" priority="1069">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine" mode="M9" priority="1068">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cbc:ID" mode="M9" priority="1067">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cbc:Note" mode="M9" priority="1066">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cbc:Note" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cbc:CreditedQuantity" mode="M9" priority="1065">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cbc:LineExtensionAmount" mode="M9" priority="1064">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cbc:AccountingCost" mode="M9" priority="1063">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cbc:AccountingCost" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod" mode="M9" priority="1062">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:StartDate" mode="M9" priority="1061">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:StartDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:EndDate" mode="M9" priority="1060">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:EndDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:OrderLineReference" mode="M9" priority="1059">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:OrderLineReference/cbc:LineID" mode="M9" priority="1058">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:OrderLineReference/cbc:LineID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference" mode="M9" priority="1057">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:InvoiceDocumentReference" mode="M9" priority="1056">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" mode="M9" priority="1055">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:CreditNoteDocumentReference" mode="M9" priority="1054">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:CreditNoteDocumentReference/cbc:ID" mode="M9" priority="1053">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:CreditNoteDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:BillingReferenceLine" mode="M9" priority="1052">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:BillingReferenceLine/cbc:ID" mode="M9" priority="1051">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:BillingReferenceLine/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery" mode="M9" priority="1050">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cbc:ActualDeliveryDate" mode="M9" priority="1049">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cbc:ActualDeliveryDate" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation" mode="M9" priority="1048">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cbc:ID" mode="M9" priority="1047">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M9" priority="1046">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" mode="M9" priority="1045">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName" mode="M9" priority="1044">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" mode="M9" priority="1043">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" mode="M9" priority="1042">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity" mode="M9" priority="1041">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country" mode="M9" priority="1040">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode" mode="M9" priority="1039">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:TaxTotal" mode="M9" priority="1038">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:TaxTotal/cbc:TaxAmount" mode="M9" priority="1037">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge" mode="M9" priority="1036">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:ChargeIndicator" mode="M9" priority="1035">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:ChargeIndicator" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReason" mode="M9" priority="1034">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReason" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:Amount" mode="M9" priority="1033">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item" mode="M9" priority="1032">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Description" mode="M9" priority="1031">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Description" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Name" mode="M9" priority="1030">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:SellerItemIdentification" mode="M9" priority="1029">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:SellerItemIdentification/cbc:ID" mode="M9" priority="1028">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:SellerItemIdentification/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification" mode="M9" priority="1027">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID" mode="M9" priority="1026">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:OriginCountry" mode="M9" priority="1025">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:OriginCountry" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:OriginCountry/cbc:IdentificationCode" mode="M9" priority="1024">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:OriginCountry/cbc:IdentificationCode" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification" mode="M9" priority="1023">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode" mode="M9" priority="1022">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory" mode="M9" priority="1021">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID" mode="M9" priority="1020">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:Percent" mode="M9" priority="1019">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:Percent" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme" mode="M9" priority="1018">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:ID" mode="M9" priority="1017">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty" mode="M9" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Name" mode="M9" priority="1015">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Value" mode="M9" priority="1014">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Value" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ManufacturerParty" mode="M9" priority="1013">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ManufacturerParty" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ManufacturerParty/cac:PartyName" mode="M9" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ManufacturerParty/cac:PartyName/cbc:Name" mode="M9" priority="1011">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ManufacturerParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ManufacturerParty/cac:PartyLegalEntity" mode="M9" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Item/cac:ManufacturerParty/cac:PartyLegalEntity/cbc:CompanyID" mode="M9" priority="1009">
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price" mode="M9" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cbc:PriceAmount" mode="M9" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cbc:BaseQuantity" mode="M9" priority="1006">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cbc:BaseQuantity" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge" mode="M9" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:ChargeIndicator" mode="M9" priority="1004">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:ChargeIndicator" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:AllowanceChargeReason" mode="M9" priority="1003">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:AllowanceChargeReason" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:MultiplierFactorNumeric" mode="M9" priority="1002">
    <svrl:fired-rule context="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:MultiplierFactorNumeric" />
    <xsl:apply-templates mode="M9" select="*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:Amount" mode="M9" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount" mode="M9" priority="1000">
...
<xsl:variable name="isB2C" select="//cac:AdditionalDocumentReference/cbc:DocumentType = 'elektroniskB2Cfaktura'" />
  <xsl:variable name="documentCurrencyCode" select="/ubl:CreditNote/cbc:DocumentCurrencyCode" />
	...
	<!--RULE -->
<xsl:template match="cbc:ProfileID" mode="M10" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:CreditNote" mode="M10" priority="1011">
    <svrl:fired-rule context="ubl:CreditNote" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party" mode="M10" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:Amount | cbc:TaxableAmount | cbc:TaxAmount | cbc:LineExtensionAmount | cbc:PriceAmount | cbc:BaseAmount | cac:LegalMonetaryTotal/cbc:*" mode="M10" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Item" mode="M10" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" mode="M10" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:CreditNote/cac:TaxTotal" mode="M10" priority="1006">
    <svrl:fired-rule context="ubl:CreditNote/cac:TaxTotal" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxRepresentativeParty" mode="M10" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID[@schemeID = 'BBAN']" mode="M10" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID[@schemeID = 'IBAN']" mode="M10" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CommodityClassification" mode="M10" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxSubtotal" mode="M10" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:CreditNote/cac:AllowanceCharge" mode="M10" priority="1000">
    <svrl:fired-rule context="ubl:CreditNote/cac:AllowanceCharge" />
...
<xsl:variable name="taxCategories" select="for $cat in /ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory return u:cat2str($cat)" />
	...
	<!--RULE -->
<xsl:template match="ubl:CreditNote" mode="M11" priority="1013">
    <svrl:fired-rule context="ubl:CreditNote" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:UBLVersionID" mode="M11" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party" mode="M11" priority="1011">
    <svrl:fired-rule context="cac:AccountingSupplierParty/cac:Party" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" mode="M11" priority="1010">
    <svrl:fired-rule context="cac:AccountingCustomerParty/cac:Party" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PartyLegalEntity" mode="M11" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Delivery/cac:DeliveryLocation/cbc:ID[@schemeID]" mode="M11" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PayeeFinancialAccount/cbc:ID[@schemeID]" mode="M11" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal" mode="M11" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge" mode="M11" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:CreditNoteLine" mode="M11" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Price/cbc:BaseQuantity" mode="M11" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxScheme/cbc:ID" mode="M11" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxScheme" mode="M11" priority="1000">
