...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2" schemaVersion="ISO19757-3">
  ...
  <pattern id="F1-START-TOTAL-COHERENCE-G1.53">
    <rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote">
      ...
      <let name="deviseFacture" value="cbc:DocumentCurrencyCode"/>
      <let name="totalTVA" value="cac:TaxTotal[cbc:TaxAmount/@currencyID = $deviseFacture]/cbc:TaxAmount"/>
  ...
  <pattern id="F1-COMPLETE-UBL-G1.10-G1.12-DEVISES">
    <rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote">
      ...
      <let name="deviseBT5" value="cbc:DocumentCurrencyCode"/>
      <let name="occurrencesBT110" value="cac:TaxTotal/cbc:TaxAmount"/>
