...
<!-- Factur-X release metadata
     ...
     fix-FR04 : BR-FXEXT-X-01, for X = S, Z, ... : Xpath corrected - BR-FXEXT-CO-10, 12,13 : addition of /xs:decimal(.) » in Xpath in sum() functions to avoid rounding issues
     APPLICABLE EN FRANCE EN RECEPTION AU PLUS TARD LE 1ER OCTOBRE 2026 ET EN EMISSION A COMPTER DU 1ER OCTOBRE 2026 
