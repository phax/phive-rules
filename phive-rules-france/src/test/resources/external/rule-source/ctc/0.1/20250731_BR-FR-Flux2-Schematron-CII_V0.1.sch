...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern id="BR-FR-05">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:ExchangedDocument">
      ...
      <assert test="exists($notes[ram:SubjectCode = 'PMT'])" flag="warning">
  ...
  <pattern id="BR-FR-06">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:ExchangedDocument">
      ...
      <!-- PMT -->
      <assert test="count($notes[ram:SubjectCode = 'PMT']) le 1" flag="warning">
      ...
      <!-- PMD -->
      <assert test="count($notes[ram:SubjectCode = 'PMD']) le 1" flag="warning">
        BR-FR-06/BT-21 : Le code sujet PMD (pénalités de retard) ne doit apparaître qu'une seule fois dans les notes (BG-3).
      </assert>
      
      <!-- AAB -->
      <assert test="count($notes[ram:SubjectCode = 'AAB']) le 1" flag="warning">
      ...
      <!-- TXD -->
      <assert test="count($notes[ram:SubjectCode = 'TXD']) le 1" flag="warning">
  ...
  <pattern id="BR-FR-10">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="$siren and matches(normalize-space($siren), '^\d{9}$')" flag="warning">
  ...
  <pattern id="BR-FR-11">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="not($barTreatment = 'B2B') or matches($siren, '^\d{9}$')" flag="warning">
  ...
  <pattern id="BR-FR-12">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="string($endpointID)" flag="warning">
  ...
  <pattern id="BR-FR-17">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument[ram:TypeCode = '916']">
      ...
      <assert test="not($code) or custom:is-valid-attachment-code($code)" flag="warning">
  ...
  <pattern id="BR-FR-20">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:IncludedNote[ram:SubjectCode = 'BAR']">
      ...
      <assert test="custom:is-valid-bar-treatment($barTreatment)" flag="warning">
  ...
  <pattern id="BR-FR-21">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <!-- Contrôle -->
      <assert test="not($isB2B and not($isExcludedDocType)) or (starts-with($endpointID, $siren) and $endpointSchemeID = '0225')" flag="warning">
  ...
  <pattern id="BR-FR-22">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <!-- Contrôle -->
      <assert test="not($isB2B and $isExcludedDocType) or (starts-with($endpointID, $siren) and $endpointSchemeID = '0225')" flag="warning">
  ...
  <pattern id="BR-FR-CO-04">
    ...
    <!--  <let name="refCount" value="count($references[ram:IssuerAssignedID and ram:FormattedIssueDateTime/udt:DateTimeString])"/> -->
      ...
      <assert test="not($typeCode = ('384', '471', '472', '473')) or $refCount = 1" flag="warning">
  ...
  <pattern id="BR-FR-CO-05">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="not($typeCode = ('261', '381', '396', '502', '503')) or ($headerRefCount ge 1 or $lineRefsValid)" flag="warning">
  ...
  <pattern id="BR-FR-CO-08">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="not($frameworkCode = ('B4', 'S4', 'M4')) or not($typeCode = ('386', '500', '503'))" flag="warning">
  ...
  <pattern id="BR-FR-CO-09">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <let name="paidAmount" value="rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/ram:PaidAmount"/>
      ...
      <assert test="not($isPaidMode) or ($paidAmount = $totalAmount)" flag="warning">
      ...
      <assert test="not($isPaidMode) or ($dueAmount = 0)" flag="warning">
      ...
      <assert test="not($isPaidMode) or string($dueDate)" flag="warning">
  ...
  <pattern id="BR-FR-CO-10">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:GlobalID/@schemeID" flag="warning">
      ...
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:GlobalID/@schemeID" flag="warning">
        BR-FR-CO-10/BT-46 : Si l’identifiant global du client (BT-46) est renseigné, alors son schéma doit également être renseigné.
      </assert>
      
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:PayeeTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:PayeeTradeParty/ram:GlobalID/@schemeID" flag="warning">
      ...
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerAgentTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerAgentTradeParty/ram:GlobalID/@schemeID" flag="warning">
      ...
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:PayerTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:PayerTradeParty/ram:GlobalID/@schemeID" flag="warning">
        BR-FR-CO-10/EXT-FR-FE-46 : Si l’identifiant global du payeur est renseigné, alors son schéma doit également être renseigné.
      </assert>
      
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SalesAgentTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SalesAgentTradeParty/ram:GlobalID/@schemeID" flag="warning">
      ...
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceeTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceeTradeParty/ram:GlobalID/@schemeID" flag="warning">
      ...
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoicerTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoicerTradeParty/ram:GlobalID/@schemeID" flag="warning">
      ...
      <assert test="not(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:GlobalID) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:GlobalID/@schemeID" flag="warning">
  ...
  <pattern id="BR-FR-CO-12">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="not($invoiceCurrency != 'EUR') or 
        ($accountingCurrency = 'EUR' and string($taxAmountEUR))" flag="warning">
  ...
  <pattern id="BR-FR-CO-15">
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="not($isAU) or (exists($fiscalRep) and string($fiscalVAT))" flag="warning">
  ...
  <pattern id="BR-FR-DEC-01">
    ...
    <rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/ram:GrandTotalAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert test="custom:is-valid-decimal-19-2($amount)" flag="warning">
  ...
  <pattern id="BR-FR-DEC-03">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:NetPriceProductTradePrice/ram:ChargeAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert test="custom:is-valid-decimal-19-6-positive($amount)" flag="warning">
