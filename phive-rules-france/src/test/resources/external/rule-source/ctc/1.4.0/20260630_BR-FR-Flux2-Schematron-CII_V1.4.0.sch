...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <!-- BR-FR-17 : types de pièces jointes CYS 1.3.1 : Ajout de RECAPITULATIF_COTRAITANCE -->
  ...
  <!-- BR-FR-23 et BR-FR-24 - V1.3.1 correction : suppression du "/" et ajout du "." -->
  ...
  <pattern id="BR-FR-CO-09"> <!-- CYS3 CORRECTION Xpath BT-113 et Ajouter number(.) pour comparer des montants et nombres -->
    ...
    <rule context="rsm:CrossIndustryInvoice">
      ...
      <assert test="not($isPaidMode) or (number($paidAmount) = number($totalAmount))" flag="fatal" id="BR-FR-CO-09_BT-23-1">
      ...
      <assert test="not($isPaidMode) or (number($dueAmount) = 0)" flag="fatal" id="BR-FR-CO-09_BT-23-2">
      ...
      <assert test="not($isPaidMode) or string($dueDate)" flag="fatal" id="BR-FR-CO-09_BT-23-3">
