...
-->
<!-- Schematron 2026-06-30_BR-FR-Flux2-Schematron-UBL_V1.4.0 - last update 2026 06 30 
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <!-- BR-FR-17 : types de pièces jointes CYS 1.3.1 : Ajoute RECAPITULATIF_COTRAITANCE -->
  <xsl:function name="custom:is-valid-attachment-code" as="xs:boolean">
    ...
    <xsl:variable name="validCodes" select="(
      ...
      'BORDEREAU_SUIVI_VALIDATION', 'ETAT_ACOMPTE', 'FACTURE_PAIEMENT_DIRECT', 'RECAPITULATIF_COTRAITANCE'
      )"/>
    <xsl:sequence select="$code = $validCodes"/>
  </xsl:function>
  
  
  <!-- BR-FR-23 et BR-FR-24 - V1.3.1 correction : suppression du "/" -->
  ...
  <pattern id="BR-FR-01">
    ...
    <rule context="ubl:Invoice/cbc:ID | cn:CreditNote/cbc:ID">
      <assert test="string-length(.) le 35" flag="fatal" id="BR-FR-01_BT-1-1">
      ...
      <assert test="custom:is-valid-id-format(.)" flag="fatal" id="BR-FR-01_BT-1-2">
    ...
    <rule context="ubl:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID | cn:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID">
      <assert test="string-length(.) le 35" flag="fatal" id="BR-FR-01_BT-25-1">
      ...
      <assert test="custom:is-valid-id-format(.)" flag="fatal" id="BR-FR-01_BT-25-2">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:BillingReference/cac:DocumentReference/cbc:ID | cn:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:DocumentReference/cbc:ID">
      <assert test="string-length(.) le 35" flag="fatal" id="BR-FR-01_EXT-FR-FE-136-1">
      ...
      <assert test="custom:is-valid-id-format(.)" flag="fatal" id="BR-FR-01_BT-EXT-FR-FE-136-2">
  ...
  <pattern id="BR-FR-03">
    ...
    <rule context="ubl:Invoice/cbc:IssueDate | cn:CreditNote/cbc:IssueDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-2">
    ...
    <rule context="ubl:Invoice/cbc:TaxPointDate | cn:CreditNote/cbc:TaxPointDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-7">
    ...
    <rule context="ubl:Invoice/cbc:DueDate | cn:CreditNote/cbc:DueDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-9">
    ...
    <rule context="ubl:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate | cn:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-26">
    ...
    <rule context="ubl:Invoice/cac:Delivery/cbc:ActualDeliveryDate | cn:CreditNote/cac:Delivery/cbc:ActualDeliveryDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-72">
    ...
    <rule context="ubl:Invoice/cac:InvoicePeriod/cbc:StartDate | cn:CreditNote/cac:InvoicePeriod/cbc:StartDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-73">
    ...
    <rule context="ubl:Invoice/cac:InvoicePeriod/cbc:EndDate | cn:CreditNote/cac:InvoicePeriod/cbc:EndDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-74">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:DocumentReference/cbc:IssueDate | cn:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:IssueDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_EXT-FR-FE-138">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:Delivery/cbc:ActualDeliveryDate | cn:CreditNote/cac:CreditNoteLine/cac:Delivery/cbc:ActualDeliveryDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_EXT-FR-FE-158">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:StartDate | cn:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:StartDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-134">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:EndDate | cn:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:EndDate">
      <assert test="custom:is-valid-date-format(.)" flag="fatal" id="BR-FR-03_BT-135">
  ...
  <pattern id="BR-FR-04">
    ...
    <rule context="ubl:Invoice/cbc:InvoiceTypeCode | cn:CreditNote/cbc:CreditNoteTypeCode">
      <assert test=". = ('380','389','393','501','386','500','384','471','472','473','261','262','381','396','502','503')" flag="fatal" id="BR-FR-04_BT-3">
    ...
    <rule context="ubl:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode | cn:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode">
      <assert test=". = ('380','389','393','501','386','500','384','471','472','473','261','262','381','396','502','503')" flag="fatal" id="BR-FR-04_EXT-FR-FE-02">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode | cn:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode">
      <assert test=". = ('380','389','393','501','386','500','384','471','472','473','261','262','381','396','502','503')" flag="fatal" id="BR-FR-04_EXT-FR-FE-137">
  ...
  <pattern id="BR-FR-05">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="contains($allNotes, '#PMD#')" flag="fatal" id="BR-FR-05_BT-22-2">
        [BR-FR-05/BT-22] : La mention relative aux pénalités de retard (code PMD) est absente. Elle est obligatoire dans les notes (BG-3).
      </assert>
      <assert test="contains($allNotes, '#AAB#')" flag="fatal" id="BR-FR-05_BT-22-3">
  ...
  <pattern id="BR-FR-06">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="count(tokenize($allNotes, '#PMD#')) - 1  le 1" flag="fatal" id="BR-FR-06_BT-21-2">
        [BR-FR-06/BT-21] : Le code sujet PMD (pénalités de retard) ne doit apparaître qu'une seule fois dans les notes (BG-3).
      </assert>
      <assert test="count(tokenize($allNotes, '#AAB#')) - 1  le 1" flag="fatal" id="BR-FR-06_BT-21-3">
      ...
      <assert test="count(tokenize($allNotes, '#TXD#')) - 1  le 1" flag="fatal" id="BR-FR-06_BT-21-4">
  ...
  <pattern id="BR-FR-12">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="normalize-space($endpointID) != ''" flag="fatal" id="BR-FR-12_BT-49">
  ...
  <pattern id="BR-FR-13">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="normalize-space($endpointID) != ''" flag="fatal" id="BR-FR-13_BT-34">
  ...
  <pattern id="BR-FR-15">
    ...
    <rule context="cac:AllowanceCharge/cac:TaxCategory">
      ...
      <assert test="not($categoryCode) or custom:is-valid-vat-category-code($categoryCode)" flag="fatal" id="BR-FR-15_BT-95_BT-102-1">
      ...
      <assert test="not($categoryCode = ('L', 'M'))" flag="fatal" id="BR-FR-15_BT-95_BT-102-2">
    ...
    <rule context="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory">
      <let name="categoryCode" value="cbc:ID"/>
      <assert test="not($categoryCode) or custom:is-valid-vat-category-code($categoryCode)" flag="fatal" id="BR-FR-15_BT-118-1">
      ...
      <assert test="not($categoryCode = ('L', 'M'))" flag="fatal" id="BR-FR-15_BT-118-2">
    ...
    <rule context="cac:Item/cac:ClassifiedTaxCategory">
      <let name="categoryCode" value="cbc:ID"/>
      <assert test="not($categoryCode) or custom:is-valid-vat-category-code($categoryCode)" flag="fatal" id="BR-FR-15_BT-151-1">
      ...
      <assert test="not($categoryCode = ('L', 'M'))" flag="fatal" id="BR-FR-08_BT-151-2">
  ...
  <pattern id="BR-FR-16">
    ...
    <rule context="cac:AllowanceCharge/cac:TaxCategory">
      ...
      <assert test="not($vatRate) or custom:is-valid-vat-rate($vatRate)" flag="fatal" id="BR-FR-16_BT-96">
    ...
    <rule context="cac:AllowanceCharge/cac:TaxCategory">
      <let name="vatRate" value="cbc:Percent"/>
      <assert test="not($vatRate) or custom:is-valid-vat-rate($vatRate)" flag="fatal" id="BR-FR-16_BT-103">
    ...
    <rule context="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory">
      <let name="vatRate" value="cbc:Percent"/>
      <assert test="not($vatRate) or custom:is-valid-vat-rate($vatRate)" flag="fatal" id="BR-FR-16_BT-119">
    ...
    <rule context="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory">
      <let name="vatRate" value="cbc:Percent"/>
      <assert test="not($vatRate) or custom:is-valid-vat-rate($vatRate)" flag="fatal" id="BR-FR-16_BT-152">
  ...
  <pattern id="BR-FR-17"> <!-- CYS2 - CORRECTION not($docTypeDESC) instead of cbc:DocumentTypeCode -->
    ...
    <rule context="cac:AdditionalDocumentReference">
      ...
      <assert test="not($docTypeDESC) or custom:is-valid-attachment-code($docTypeDESC)" flag="fatal" id="BR-FR-17_BT-123">
  ...
  <pattern id="BR-FR-20">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="not($invalidNotes)" flag="fatal" id="BR-FR-20_BT-21">
  ...
  <pattern id="BR-FR-21">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="not($treatment='B2B') or $typeCode = ('389', '501', '500', '471', '473', '261', '502') or (starts-with($endpointID, $siren) and $schemeID = '0225')" flag="fatal" id="BR-FR-21_BT-49">
  ...
  <pattern id="BR-FR-31"> 
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="($countBarB2B + $countBarB2BINT + $countBarB2C + $countBarB2CINT + $countBarOUTOFSCOPE + $countBarARCHIVEONLY) &lt;= 1" flag="fatal" id="BR-FR-30_BT-21">
  ...
  <pattern id="BR-FR-32"> 
    ...
    <rule context="//cac:PartyIdentification/cbc:ID[@schemeID = '0002' or @schemeID = '0231']">
      ...
      <assert test="matches(normalize-space(.), '^\d{9}$')" flag="fatal" id="BR-FR-32-ID">
  ...
  <pattern id="BR-FR-CO-04">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="not($typeCode = '384' or $typeCode = '471' or $typeCode = '472' or $typeCode = '473') or count($references) = 1"
        flag="fatal" id="BR-FR-CO-04_BT-3">
  ...
  <pattern id="BR-FR-CO-05">
    ...
    <rule context="cn:CreditNote">
      ...
      <assert test="not($typeCode = ('261', '381', '396', '502', '503')) or ($headerRefCount ge 1 or $lineRefCount = $lineCount)" flag="fatal" id="BR-FR-CO-05_BT-3">
  ...
  <pattern id="BR-FR-CO-08">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="not($billingContext = 'B4' or $billingContext = 'S4' or $billingContext = 'M4') or not($typeCode = '386' or $typeCode = '500' or $typeCode = '503')"
        flag="fatal" id="BR-FR-CO-08_BT-23">
  ...
  <pattern id="BR-FR-CO-09"> <!-- CYS3 CORRECTION Xpath BT-113 et Ajouter number(.) pour comparer des montants et nombres -->
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="not($billingContext = 'B2' or $billingContext = 'S2' or $billingContext = 'M2') or string($dueDate)"
        flag="fatal" id="BR-FR-CO-09_BT-23-3">
  ...
  <pattern id="BR-FR-CO-10"> <!-- CYS2 Revue du code pour l'unicité des schemeID -->
    ...
    <rule context="cac:AccountingSupplierParty/cac:Party">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_BT-29-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_BT-29-2">
    ...
    <rule context="cac:AccountingCustomerParty/cac:Party">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_BT-46-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_BT-46-2">
    ...
    <rule context="cac:PayeeParty">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_BT-60-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_BT-60-2">
    ...
    <rule context="cac:AccountingCustomerParty/cac:Party/cac:AgentParty">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-06-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-06-2">
    ...
    <rule context="cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-46-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-46-2">
    ...
    <rule context="cac:AccountingSupplierParty/cac:Party/cac:AgentParty">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-69-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-69-2">
    ...
    <rule context="cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-92-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-92-2">
    ...
    <rule context="cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party">
      ...
      <assert test="empty(cac:PartyIdentification/cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-115-1">
      ...
      <assert test="count(distinct-values(cac:PartyIdentification/cbc:ID/@schemeID)) = count(cac:PartyIdentification/cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-115-2">
    ...
    <rule context="ubl:Invoice/cac:Delivery/cac:DeliveryLocation | cn:CreditNote/cac:Delivery/cac:DeliveryLocation">
      ...
      <assert test="empty(cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_BT-71-1">
      ...
      <assert test="count(distinct-values(cbc:ID/@schemeID)) = count(cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_BT-71-2">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation | cn:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation">
      ...
      <assert test="empty(cbc:ID[not(@schemeID)])" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-146-1">
      ...
      <assert test="count(distinct-values(cbc:ID/@schemeID)) = count(cbc:ID/@schemeID)" flag="fatal" id="BR-FR-CO-10_EXT-FR-FE-146-2">
  ...
  <pattern id="BR-FR-CO-12">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="not($invoiceCurrency != 'EUR') or ($accountingCurrency = 'EUR' and string($taxAmountValueEUR))"
        flag="fatal" id="BR-FR-CO-12_BT-5">
  ...
  <pattern id="BR-FR-CO-15">
    ...
    <rule context="ubl:Invoice | cn:CreditNote">
      ...
      <assert test="not($isAU) or (exists($fiscalRep) and string($fiscalRepVAT))" flag="fatal" id="BR-FR-CO-15_BT-29-1">
  ...
  <pattern id="BR-FR-DEC-01">
    ...
    <rule context="ubl:Invoice/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:AllowanceCharge/cbc:BaseAmount">
      ...
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-93_BT-100">
    ...
    <rule context="ubl:Invoice/cac:AllowanceCharge/cbc:Amount | cn:CreditNote/cac:AllowanceCharge/cbc:Amount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-92_BT-99">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:LineExtensionAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-106">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-107">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:ChargeTotalAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-108">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-109">
    ...
    <rule context="cac:TaxTotal/cbc:TaxAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-110">
    ...
    <rule context="cac:TaxTotal/cbc:TaxAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-111">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-112">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:PrepaidAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-113">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:PayableRoundingAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-114">
    ...
    <rule context="cac:LegalMonetaryTotal/cbc:PayableAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-115">
    ...
    <rule context="cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-116">
    ...
    <rule context="cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-117">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cbc:LineExtensionAmount | cn:CreditNote/cac:CreditNoteLine/cbc:LineExtensionAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-131">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:Amount | cn:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:Amount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-136_BT-141">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:BaseAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert flag="fatal" test="custom:is-valid-decimal-19-2($amount)" id="BR-FR-DEC-01_BT-137_BT-142">
  ...
  <pattern id="BR-FR-DEC-02">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine">
      ...
      <assert test="not($quantity) or custom:is-valid-decimal-19-4($quantity)" flag="fatal" id="BR-FR-DEC-02_BT-149">
  ...
  <pattern id="BR-FR-DEC-03"> <!-- V1.4 - MàJ pour autoriser PU négatifs pour factures BD  -->
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine">
      ...
      <assert test="not($amount) or (custom:isSpecialContractBD(/ubl:Invoice|/cn:CreditNote) and custom:is-valid-decimal-19-6($amount)) or (not(custom:isSpecialContractBD(/ubl:Invoice|/cn:CreditNote)) and custom:is-valid-decimal-19-6-positive($amount))" flag="fatal" id="BR-FR-DEC-03_BT-146">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge | cn:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge">
      ...
      <assert test="not($amount) or (custom:isSpecialContractBD(/ubl:Invoice|/cn:CreditNote) and custom:is-valid-decimal-19-6($amount)) or (not(custom:isSpecialContractBD(/ubl:Invoice|/cn:CreditNote)) and custom:is-valid-decimal-19-6-positive($amount))" flag="fatal" id="BR-FR-DEC-03_BT-147">
    ...
    <rule context="ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert test="not($amount) or (custom:isSpecialContractBD(/ubl:Invoice|/cn:CreditNote) and custom:is-valid-decimal-19-6($amount)) or (not(custom:isSpecialContractBD(/ubl:Invoice|/cn:CreditNote)) and custom:is-valid-decimal-19-6-positive($amount))" flag="fatal" id="BR-FR-DEC-03_BT-148">
