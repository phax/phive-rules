...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(ram:GlobalID!='') or ../ram:ProcessConditionCode = '501'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="ram:GlobalID[@schemeID='0002']!='' or ../ram:ProcessConditionCode = '501'">
