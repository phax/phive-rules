...
<xsl:function as="xs:boolean" name="custom:is-valid-id-format">
  ...
  <xsl:function as="xs:boolean" name="custom:is-valid-billing-mode">
    <xsl:param as="xs:string" name="code" />
    <xsl:variable as="xs:string" name="custom:billing-modes" select="'B1 S1 M1 B2 S2 M2 B4 S4 M4 S5 S6 B7 S7'" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(ram:FormattedIssueDateTime) or rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext/ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID = '501'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(ram:GlobalID) or /rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext/ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID = '501'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(ram:ProcessConditionCode = '212') or ram:SpecifiedDocumentStatus/ram:SpecifiedDocumentCharacteristic[ram:TypeCode = 'MEN' and ram:ValueAmount]">
...
<svrl:text>BR-FR-CDV-CL-01 — Liste fermée de valeurs pour MDT-2</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext" mode="M39" priority="1000">
    <svrl:fired-rule context="rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext" />
    <xsl:variable name="TestPPF" select="(count(../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:GlobalID) = 1 and ../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:GlobalID[@schemeID='0238'] = '9998' and ../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:RoleCode = 'DFH')" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(not($TestPPF) and (./ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID = 'REGULATED' or . = 'NON_REGULATED' or . = 'B2C' or . = 'B2BINT' or . = 'OUTOFSCOPE')) or ($TestPPF and (string-length(normalize-space(./ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID)) &lt;= 3))">
...
<svrl:text>BR-FR-CDV-CL-02 — Contrôle de cohérence entre MDT-77 et MDT-21</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument" mode="M40" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument" />
...
<svrl:text>BR-FR-CDV-CL-04 — Liste fermée de valeurs pour MDT-59</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:RecipientTradeParty/ram:RoleCode" mode="M42" priority="1000">
...
<svrl:text>BR-FR-CDV-CL-05 — Contrôle des statuts MDT-88 selon MDT-77</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" mode="M43" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="../ram:TypeCode != '23' or ram:StatusCode = '45' or ram:StatusCode = '39' or ram:StatusCode = '37' or ram:StatusCode = '50' or ram:StatusCode = '49' or ram:StatusCode = '47' or ram:StatusCode = '46' or ram:StatusCode = '1'or not(ram:StatusCode)">
...
<svrl:text>BR-FR-CDV-CL-06 — Liste fermée de codes statuts de facture</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode" mode="M44" priority="1001">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:ProcessConditionCode" mode="M44" priority="1000">
...
<svrl:text>BR-FR-CDV-CL-07 — Vérification de la valeur de MDT-132</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:IssuerTradeParty/ram:RoleCode" mode="M45" priority="1000">
...
<svrl:text>BR-FR-CDV-CL-08 — Liste fermée de valeurs pour MDT-158</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:RecipientTradeParty/ram:RoleCode" mode="M46" priority="1000">
...
<svrl:text>BR-FR-CDV-CL-09 — Liste fermée de codes motifs de statuts</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:ReasonCode" mode="M47" priority="1000">
...
<svrl:text>BR-FR-CDV-CL-10 — Liste fermée de codes actions de facture</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:RequestedActionCode" mode="M48" priority="1000">
...
<svrl:text>BR-FR-CDV-CL-11 — Liste fermée de codes pour MDT-207</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:SpecifiedDocumentCharacteristic/ram:TypeCode" mode="M49" priority="1000">
