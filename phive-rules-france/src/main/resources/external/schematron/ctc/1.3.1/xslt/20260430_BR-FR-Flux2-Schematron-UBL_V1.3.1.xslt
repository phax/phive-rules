...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:BillingReference/cac:DocumentReference/cbc:ID | cn:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:DocumentReference/cbc:ID" mode="M21" priority="1000">
...
<svrl:text>BR-FR-02 — Validation du format des identifiants de facture</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:ID | cn:CreditNote/cbc:ID" mode="M22" priority="1002">
    <svrl:fired-rule context="ubl:Invoice/cbc:ID | cn:CreditNote/cbc:ID" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID | cn:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" mode="M22" priority="1001">
    <svrl:fired-rule context="ubl:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID | cn:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID | cn:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" mode="M22" priority="1000">
...
<svrl:text>BR-FR-03 — Validation de l'année dans les dates (2000–2099)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:IssueDate | cn:CreditNote/cbc:IssueDate" mode="M23" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:TaxPointDate | cn:CreditNote/cbc:TaxPointDate" mode="M23" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:DueDate | cn:CreditNote/cbc:DueDate" mode="M23" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate | cn:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate" mode="M23" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Delivery/cbc:ActualDeliveryDate | cn:CreditNote/cac:Delivery/cbc:ActualDeliveryDate" mode="M23" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoicePeriod/cbc:StartDate | cn:CreditNote/cac:InvoicePeriod/cbc:StartDate" mode="M23" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoicePeriod/cbc:EndDate | cn:CreditNote/cac:InvoicePeriod/cbc:EndDate" mode="M23" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:DocumentReference/cbc:IssueDate | cn:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:IssueDate" mode="M23" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Delivery/cbc:ActualDeliveryDate | cn:CreditNote/cac:CreditNoteLine/cac:Delivery/cbc:ActualDeliveryDate" mode="M23" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:StartDate | cn:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:StartDate" mode="M23" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:InvoicePeriod/cbc:EndDate | cn:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod/cbc:EndDate" mode="M23" priority="1000">
...
<svrl:text>BR-FR-04 — Validation du code type de document</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:InvoiceTypeCode | cn:CreditNote/cbc:CreditNoteTypeCode" mode="M24" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode | cn:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode" mode="M24" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode | cn:CreditNote/cac:CreditNoteLine/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode" mode="M24" priority="1000">
...
<svrl:text>BR-FR-06 — Unicité des codes sujets dans les notes (BG-3)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice | cn:CreditNote" mode="M26" priority="1000">
    <svrl:fired-rule context="ubl:Invoice | cn:CreditNote" />
    <xsl:variable name="allNotes" select="string-join(./cbc:Note, '')" />
...
<svrl:text>BR-FR-08 — Validation du mode de facturation (BT-23)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:ProfileID | cn:CreditNote/cbc:ProfileID" mode="M27" priority="1000">
...
<svrl:text>BR-FR-09 — Cohérence entre SIRET (ID avec schemeId = 0009) et SIREN (Legal ID)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party | cn:CreditNote/cac:AccountingSupplierParty/cac:Party" mode="M28" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party | cn:CreditNote/cac:AccountingCustomerParty/cac:Party" mode="M28" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:PayeeParty | cn:CreditNote/cac:PayeeParty" mode="M28" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:AgentParty" mode="M28" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty | cn:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty" mode="M28" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:AgentParty | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:AgentParty" mode="M28" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party" mode="M28" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party" mode="M28" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Delivery | cn:CreditNote/cac:Delivery" mode="M28" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation | cn:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation" mode="M28" priority="1000">
...
<svrl:text>BR-FR-10 — SIREN du vendeur obligatoire et valide (BT-30)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity" mode="M29" priority="1000">
...
<svrl:text>BR-FR-13 — Vérification de la présence du BT-34</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice | cn:CreditNote" mode="M32" priority="1000">
    <svrl:fired-rule context="ubl:Invoice | cn:CreditNote" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Item/cac:ClassifiedTaxCategory" mode="M33" priority="1000">
...
<svrl:text>BR-FR-16 — Vérification des taux de TVA autorisés (BT-96, BT-103, BT-119, BT-152)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge/cac:TaxCategory" mode="M34" priority="1003">
    <svrl:fired-rule context="cac:AllowanceCharge/cac:TaxCategory" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge/cac:TaxCategory" mode="M34" priority="1002">
    <svrl:fired-rule context="cac:AllowanceCharge/cac:TaxCategory" />
    <xsl:variable name="vatRate" select="cbc:Percent" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory" mode="M34" priority="1001">
    <svrl:fired-rule context="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory" />
    <xsl:variable name="vatRate" select="cbc:Percent" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory" mode="M34" priority="1000">
...
<svrl:text>BR-FR-17 — Codes autorisés pour qualifier les pièces jointes (BT-123)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cac:AdditionalDocumentReference" mode="M35" priority="1000">
...
<svrl:text>BR-FR-23 — Validation du format des adresses électroniques avec schemeID = 0225</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:PayeeParty/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:PayeeParty/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:AgentParty/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:AgentParty/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID[@schemeID='0225'] | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID[@schemeID='0225']" mode="M40" priority="1000">
...
<svrl:text>BR-FR-24 — Validation du format des identifiants privés avec schemeID = 0224</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224'] | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224']" mode="M41" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224'] | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224']" mode="M41" priority="1000">
...
<svrl:text>BR-FR-25 — Longueur maximale des adresses électroniques</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID" mode="M42" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID" mode="M42" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cbc:EndpointID | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cbc:EndpointID" mode="M42" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:PayeeParty/cbc:EndpointID | cn:CreditNote/cac:PayeeParty/cbc:EndpointID" mode="M42" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty/cbc:EndpointID | cn:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty/cbc:EndpointID" mode="M42" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:AgentParty/cbc:EndpointID | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:AgentParty/cbc:EndpointID" mode="M42" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID" mode="M42" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party/cbc:EndpointID" mode="M42" priority="1000">
...
<svrl:text>BR-FR-26 — Longueur maximale des identifiants privés avec schemeID = 0224</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224'] | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224']" mode="M43" priority="1001">
    <svrl:fired-rule context="ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224'] | cn:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224']" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224'] | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224']" mode="M43" priority="1000">
    <svrl:fired-rule context="ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224'] | cn:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='0224']" />
...
<svrl:text>BR-FR-27 — Validation du groupe Attribut d’article (BG-32)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Item/cac:AdditionalItemProperty | cn:CreditNote/cac:Item/cac:AdditionalItemProperty" mode="M44" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Item/cac:AdditionalItemProperty/cbc:Name | cn:CreditNote/cac:Item/cac:AdditionalItemProperty/cbc:Name" mode="M44" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Item/cac:AdditionalItemProperty/cbc:NameCode | cn:CreditNote/cac:Item/cac:AdditionalItemProperty/cbc:NameCode" mode="M44" priority="1000">
...
<svrl:text>BR-FR-28 — Validation de la valeur d’attribut d’article (BG-32)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Item/cac:AdditionalItemProperty | cn:CreditNote/cac:Item/cac:AdditionalItemProperty" mode="M45" priority="1003">
    <svrl:fired-rule context="ubl:Invoice/cac:Item/cac:AdditionalItemProperty | cn:CreditNote/cac:Item/cac:AdditionalItemProperty" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Item/cac:AdditionalItemProperty/cbc:Value | cn:CreditNote/cac:Item/cac:AdditionalItemProperty/cbc:Value" mode="M45" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Item/cac:AdditionalItemProperty/cbc:ValueQuantity | cn:CreditNote/cac:Item/cac:AdditionalItemProperty/cbc:ValueQuantity" mode="M45" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Item/cac:AdditionalItemProperty/cbc:ValueQuantity/@unitCode | cn:CreditNote/cac:Item/cac:AdditionalItemProperty/cbc:ValueQuantity/@unitCode" mode="M45" priority="1000">
...
<svrl:text>BR-FR-29 — Vérification des identifiants d’objets facturés (BT-18)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AdditionalDocumentReference | cn:CreditNote/cac:AdditionalDocumentReference" mode="M46" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AdditionalDocumentReference/cbc:ID[@schemeID='AFL'] | cn:CreditNote/cac:AdditionalDocumentReference/cbc:ID[@schemeID='AFL']" mode="M46" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AdditionalDocumentReference/cbc:ID[@schemeID='AVV'] | cn:CreditNote/cac:AdditionalDocumentReference/cbc:ID[@schemeID='AVV']" mode="M46" priority="1000">
...
<svrl:text>BR-FR-30 — Vérification des identifiants d’objets facturés à la ligne (BT-128)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:DocumentReference | cn:CreditNote/cac:CreditNoteLine/cac:DocumentReference" mode="M47" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:DocumentReference/cbc:ID[@schemeID='AFL'] | cn:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:ID[@schemeID='AFL']" mode="M47" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:DocumentReference/cbc:ID[@schemeID='AVV'] | cn:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:ID[@schemeID='AVV']" mode="M47" priority="1000">
...
<svrl:text>BR-FR-31 — Note avec code sujet BAR : une seule valeur possible dans la liste</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice | cn:CreditNote" mode="M48" priority="1000">
    <svrl:fired-rule context="ubl:Invoice | cn:CreditNote" />
...
<svrl:text>BR-FR-CO-03 — Présence obligatoire du contrat et de la période de facturation si type de facture = 262 (Avoir Remise Globale)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cn:CreditNote" mode="M49" priority="1000">
...
<svrl:text>BR-FR-CO-04 — Une seule référence à une facture antérieure obligatoire pour les factures rectificatives (BT-3)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice | cn:CreditNote" mode="M50" priority="1000">
    <svrl:fired-rule context="ubl:Invoice | cn:CreditNote" />
...
<svrl:text>BR-FR-CO-05] — Référence obligatoire à une facture antérieure pour les avoirs (BT-3)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cn:CreditNote" mode="M51" priority="1000">
    <svrl:fired-rule context="cn:CreditNote" />
    <xsl:variable name="typeCode" select="cbc:CreditNoteTypeCode" />
...
<xsl:template match="ubl:Invoice | cn:CreditNote" mode="M54" priority="1000">
    ...
    <xsl:variable name="dueDate" select=" if (self::ubl:Invoice)          then cbc:DueDate         else if (self::cn:CreditNote)         then cac:PaymentMeans/cbc:PaymentDueDate         else ()" />
...
<svrl:text>BR-FR-CO-10 — Vérification de la présence du schéma d’identifiant global (BT-29 et équivalents)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party" mode="M55" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" mode="M55" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PayeeParty" mode="M55" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party/cac:AgentParty" mode="M55" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty" mode="M55" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party/cac:AgentParty" mode="M55" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party" mode="M55" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party" mode="M55" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:Delivery/cac:DeliveryLocation | cn:CreditNote/cac:Delivery/cac:DeliveryLocation" mode="M55" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation | cn:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation" mode="M55" priority="1000">
    <svrl:fired-rule context="ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation | cn:CreditNote/cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation" />
...
<svrl:text>BR-FR-DEC-01 — Format des montants numériques (max 19 caractères, 2 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:AllowanceCharge/cbc:BaseAmount" mode="M59" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AllowanceCharge/cbc:Amount | cn:CreditNote/cac:AllowanceCharge/cbc:Amount" mode="M59" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:LineExtensionAmount" mode="M59" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount" mode="M59" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:ChargeTotalAmount" mode="M59" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount" mode="M59" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cbc:TaxAmount" mode="M59" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cbc:TaxAmount" mode="M59" priority="1009">
    <svrl:fired-rule context="cac:TaxTotal/cbc:TaxAmount" />
    <xsl:variable name="amount" select="normalize-space(.)" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount" mode="M59" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:PrepaidAmount" mode="M59" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:PayableRoundingAmount" mode="M59" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:PayableAmount" mode="M59" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount" mode="M59" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount" mode="M59" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cbc:LineExtensionAmount | cn:CreditNote/cac:CreditNoteLine/cbc:LineExtensionAmount" mode="M59" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:Amount | cn:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:Amount" mode="M59" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:BaseAmount" mode="M59" priority="1000">
...
<svrl:text>BR-FR-DEC-02 — Format des quantités numériques (max 19 caractères, 4 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cbc:InvoicedQuantity | cn:CreditNote/cac:CreditNoteLine/cbc:CreditedQuantity" mode="M60" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine" mode="M60" priority="1000">
...
<svrl:text>BR-FR-DEC-03 — Format des montants positifs (max 19 caractères, 6 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine" mode="M61" priority="1002">
    <svrl:fired-rule context="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge | cn:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge" mode="M61" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount" mode="M61" priority="1000">
...
<svrl:text>BR-FR-DEC-04 — Format des taux de TVA (max 4 caractères, 2 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge/cac:TaxCategory/cbc:Percent" mode="M62" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent" mode="M62" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Item/cac:ClassifiedTaxCategory/cbc:Percent" mode="M62" priority="1000">
...
<xsl:variable name="invoiceID" select="(ubl:Invoice|/cn:CreditNote)/cbc:ID" />
  <svrl:text>BR-FR-MV-01 — lorsque le cadre de facturation est S8, B8 ou M8, Vérification du sous-type de ligne  - BR-FR-MV-02 — Vérification de la présence d'une ligne GROUP sans parent </svrl:text>

	<!--RULE -->
<xsl:template match="cac:InvoiceLine|cac:CreditNoteLine" mode="M63" priority="1000">
...
<svrl:text>BR-FR-MV-02 — lorsque le cadre de facturation est S8, B8 ou M8, Vérification de la présence d'une ligne GROUP sans parent </svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice|/cn:CreditNote" mode="M64" priority="1000">
    <svrl:fired-rule context="ubl:Invoice|/cn:CreditNote" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(custom:isSpecialContract(/ubl:Invoice|/cn:CreditNote)) or (count((cac:InvoiceLine|cac:CreditNoteLine)/cac:BillingReference[(cac:InvoiceDocumentReference/cbc:ID = $invoiceID) and (cac:InvoiceDocumentReference/cbc:DocumentStatusCode = 'GROUP') and not(cac:BillingReferenceLine/cbc:ID)]) >= 1)">
...
<svrl:text>BR-FR-MV-03 — Vérification des données obligatoires pour les lignes GROUP sans parent lorsque le cadre de facturation est S8, B8 ou M8</svrl:text>
	...
	<!--RULE -->
<xsl:template match="(ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine)/cac:BillingReference[(cac:InvoiceDocumentReference/cbc:ID = $invoiceID) and (cac:InvoiceDocumentReference/cbc:DocumentStatusCode = 'GROUP') and not(cac:BillingReferenceLine/cbc:ID)]" mode="M65" priority="1000">
...
<svrl:text>BR-FR-MV-05 — Vérification de la cohérence des totaux HT entre la ligne GROUP et ses lignes enfants</svrl:text>
	...
	<!--RULE -->
<xsl:template match="(ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine)/cac:BillingReference[(cac:InvoiceDocumentReference/cbc:ID = $invoiceID)][(cac:InvoiceDocumentReference/cbc:DocumentStatusCode = 'GROUP') and not(cac:BillingReferenceLine/cbc:ID)]" mode="M66" priority="1000">
...
<svrl:text>BR-FR-MV-06 — Vérification de la cohérence de l'identifiant légal du vendeur entre une ligne et sa ligne parent</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine" mode="M67" priority="1000">
    <svrl:fired-rule context="ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine" />
...
<svrl:text>BR-FR-MV-07 — Vérification de la cohérence du numéro de facture codifié AFL entre une ligne et sa ligne parent</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine" mode="M68" priority="1000">
    <svrl:fired-rule context="ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine" />
    <xsl:variable name="parentlineID" select="cac:BillingReference[cac:InvoiceDocumentReference/cbc:ID = $invoiceID]/cac:BillingReferenceLine/cbc:ID" />
...
<svrl:text>BR-FR-MV-08 — Vérification de la raison d'exemption TVA contenant le numéro de sous-facture en ligne entre #</svrl:text>
	...
	<!--RULE -->
<xsl:template match="(ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine)[cac:BillingReference[cac:InvoiceDocumentReference/cbc:ID = $invoiceID]/cac:InvoiceDocumentReference/cbc:DocumentStatusCode = 'DETAIL']" mode="M69" priority="1000">
...
<svrl:text>BR-FR-MV-09 — Vérification de la cohérence du montant total TVA pour une ligne GROUP avec la somme des ventilations TVA liées</svrl:text>
	...
	<!--RULE -->
<xsl:template match="(ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine)/cac:BillingReference[cac:InvoiceDocumentReference/cbc:ID = $invoiceID][(cac:InvoiceDocumentReference/cbc:DocumentStatusCode = 'GROUP') and not(cac:BillingReferenceLine/cbc:ID)]" mode="M70" priority="1000">
    <svrl:fired-rule context="(ubl:Invoice/cac:InvoiceLine|cn:CreditNote/cac:CreditNoteLine)/cac:BillingReference[cac:InvoiceDocumentReference/cbc:ID = $invoiceID][(cac:InvoiceDocumentReference/cbc:DocumentStatusCode = 'GROUP') and not(cac:BillingReferenceLine/cbc:ID)]" />
    <xsl:variable name="numfact" select="normalize-space(../cac:DocumentReference[cbc:DocumentTypeCode = '130']/cbc:ID[@schemeID = 'AFL'])" />
...
<svrl:text>BR-FR-MV-12 — Vérification de l'unicité des numéros de facture AFL pour les lignes GROUP sans parent</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice|/cn:CreditNote" mode="M73" priority="1000">
    <svrl:fired-rule context="ubl:Invoice|/cn:CreditNote" />
...
<svrl:text>BR-FR-MV-13 — Vérification que le code type de facture (BT-3) n'est pas un type auto-facturé interdit</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:InvoiceTypeCode|/cn:CreditNote/cbc:CreditNoteTypeCode" mode="M74" priority="1000">
    <svrl:fired-rule context="ubl:Invoice/cbc:InvoiceTypeCode|/cn:CreditNote/cbc:CreditNoteTypeCode" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(custom:isSpecialContract(/ubl:Invoice|/cn:CreditNote)) or (normalize-space(.) != '' and not(. = '389' or . = '261' or . = '501' or . = '500' or . = '502' or . = '471' or . = '473'))">
