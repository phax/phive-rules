...
<xsl:function as="xs:boolean" name="custom:is-valid-id-format">
  ...
  <xsl:function as="xs:boolean" name="custom:is-valid-billing-mode">
    <xsl:param as="xs:string" name="code" />
    <xsl:variable as="xs:string" name="custom:billing-modes" select="'B1 S1 M1 B2 S2 S3 M2 B4 S4 M4 S5 S6 B7 S7 B8 S8 M8 B9 S9 M9'" />
  ...
  <xsl:function as="xs:boolean" name="custom:is-valid-invoice-status-code">
    <xsl:param as="xs:string" name="code" />
    <xsl:variable as="xs:string" name="custom:invoice-status-codes" select="'200 201 202 203 204 205 206 207 208 209 210 211 212 213 214                220 221 224 225 226 227 228                250 251                300 301 400 401 500 501 601'" />
    <xsl:sequence select="$code = tokenize($custom:invoice-status-codes, '\s+')" />
  </xsl:function>
  <xsl:function as="xs:boolean" name="custom:is-valid-status-reason-code">
    <xsl:param as="xs:string" name="code" />
    <xsl:variable as="xs:string" name="custom:status-reason-codes" select="'RETRAIT_MAN_SERV ST_CT_NON_DECLAR SUPPR_COMP_AVOIR TRANSF_PMNT_REGIE CONTACT_ACHTR NON_TRANSMISE JUSTIF_ABS ROUTAGE_ERR AUTRE COORD_BANC_ERR TX_TVA_ERR MONTANTTOTAL_ERR CALCUL_ERR NON_CONFORME DOUBLON DEST_INC DEST_ERR TRANSAC_INC EMMET_INC CONTRAT_TERM DOUBLE_FACT CMD_ERR ADR_ERR SIRET_ERR CODE_ROUTAGE_ERR REF_CT_ABSENT REF_ERR PU_ERR REM_ERR QTE_ERR ART_ERR MODPAI_ERR QUALITE_ERR LIVR_INCOMP REJ_SEMAN REJ_UNI REJ_COH REJ_ADR REJ_CONT_B2G REJ_REF_PJ REJ_ASS_PJ IRR_VIDE_F IRR_TYPE_F IRR_SYNTAX IRR_TAILLE_PJ IRR_NOM_PJ IRR_VID_PJ IRR_EXT_DOC IRR_TAILLE_F IRR_ANTIVIRUS IRR_NOM_F'" />
    <xsl:sequence select="$code = tokenize($custom:status-reason-codes, '\s+')" />
  </xsl:function>
  <xsl:function as="xs:boolean" name="custom:is-valid-invoice-action-code">
    <xsl:param as="xs:string" name="code" />
    <xsl:variable as="xs:string" name="custom:invoice-action-codes" select="'NOA PIN NIN CNF CNP CNA OTH'" />
...
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="">
      ...
      <svrl:ns-prefix-in-attribute-values prefix="rsm" uri="urn:un:unece:uncefact:data:standard:CrossDomainAcknowledgementAndResponse:100" />
...
<svrl:text>BR-FR-04 — Validation des codes de type de document</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:TypeCode" mode="M23" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:TypeCode" />
...
<svrl:text>BR-FR-CDV-01 — Présence obligatoire de MDG-3</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocumentContext/ram:GuidelineSpecifiedDocumentContextParameter" mode="M24" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocumentContext/ram:GuidelineSpecifiedDocumentContextParameter" />
...
<svrl:text>BR-FR-CDV-02 — Vérification de la valeur de MDT-3</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext" mode="M25" priority="1000">
    <svrl:fired-rule context="rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="./ram:GuidelineSpecifiedDocumentContextParameter/ram:ID = 'urn.cpro.gouv.fr:1p0:CDV:invoice' or (./ram:GuidelineSpecifiedDocumentContextParameter/ram:ID = 'urn.cpro.gouv.fr:1p0:CDV:einvoicingF2' and count(../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:GlobalID) = 1 and ../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:GlobalID[@schemeID='0238'] = '0000' and ../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:RoleCode = 'DFH')">
...
<svrl:text>BR-FR-CDV-03 — Présence obligatoire de MDT-4</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument" mode="M26" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="ram:ID">
...
<svrl:text>BR-FR-CDV-04 — Présence obligatoire de MDG-4</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:IssueDateTime" mode="M27" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument/ram:IssueDateTime" />
...
<svrl:text>BR-FR-CDV-05 — Présence obligatoire de MDG-9</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:SenderTradeParty" mode="M28" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument/ram:SenderTradeParty" />
...
<svrl:text>BR-FR-CDV-06 — Présence obligatoire de MDT-21</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:SenderTradeParty/ram:RoleCode" mode="M29" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument/ram:SenderTradeParty/ram:RoleCode" />
...
<svrl:text>BR-FR-CDV-07 — Validation conditionnelle de MDT-38 selon MDT-77</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:IssuerTradeParty" mode="M30" priority="1001">
    <svrl:fired-rule context="rsm:ExchangedDocument/ram:IssuerTradeParty" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="../../rsm:AcknowledgementDocument/ram:TypeCode != '23' or ram:GlobalID" />
      <xsl:otherwise>
        <svrl:failed-assert test="../../rsm:AcknowledgementDocument/ram:TypeCode != '23' or ram:GlobalID">
	...
	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:IssuerTradeParty" mode="M30" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument/ram:IssuerTradeParty" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../rsm:AcknowledgementDocument/ram:TypeCode != '305' or count(../ram:RecipientTradeParty/ram:RoleCode='DFH') ge 0) or not(ram:GlobalID)">
...
<svrl:text>BR-FR-CDV-08 — Obligation conditionnelle de MDT-73</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:RecipientTradeParty" mode="M31" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument/ram:RecipientTradeParty" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(ram:RoleCode = 'WK' or ram:RoleCode = 'DFH') or ram:URIUniversalCommunication/ram:URIID" />
      <xsl:otherwise>
        <svrl:failed-assert test="(ram:RoleCode = 'WK' or ram:RoleCode = 'DFH') or ram:URIUniversalCommunication/ram:URIID">
...
<svrl:text>BR-FR-CDV-09 — Présence et valeur de MDT-77</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:TypeCode" mode="M32" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:TypeCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test=". = '23' or . = '305'" />
      <xsl:otherwise>
        <svrl:failed-assert test=". = '23' or . = '305'">
...
<svrl:text>BR-FR-CDV-10 — Présence obligatoire de MDT-87</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:IssuerAssignedID" mode="M33" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:IssuerAssignedID" />
...
<svrl:text>BR-FR-CDV-11 — Présence obligatoire de MDG-35</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" mode="M34" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(ram:FormattedIssueDateTime) or /rsm:CrossDomainAcknowledgementAndResponse/rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode = '501'">
...
<svrl:text>BR-FR-CDV-12 — Présence obligatoire de MDT-105</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" mode="M35" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(ram:ProcessConditionCode)">
...
<svrl:text>BR-FR-CDV-13 — Présence obligatoire de MDT-129</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:IssuerTradeParty" mode="M36" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:IssuerTradeParty" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(ram:GlobalID) or /rsm:CrossDomainAcknowledgementAndResponse/rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode = '501'">
...
<svrl:text>BR-FR-CDV-14 — Vérification des caractéristiques en cas de statut "Encaissé"</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" mode="M37" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(ram:ProcessConditionCode = '212') or ((count(ram:SpecifiedDocumentStatus/ram:SpecifiedDocumentCharacteristic[ram:TypeCode = 'MEN']) ge 1 ) and (count(ram:SpecifiedDocumentStatus/ram:SpecifiedDocumentCharacteristic[ram:TypeCode = 'MEN']) = count(ram:SpecifiedDocumentStatus/ram:SpecifiedDocumentCharacteristic[ram:TypeCode = 'MEN' and ram:ValueAmount and ram:ValuePercent])))">
...
<svrl:text>BR-FR-CDV-14 — Vérification des caractéristiques en cas de statut "Encaissé"</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode" mode="M38" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not((.) = '210' or (.) = '213' or (.) = '501' or (.) = '207' or (.) = '206' or (.) = '208') or (((.) = '210' or (.) = '213' or (.) = '501' or (.) = '207' or (.) = '206' or (.) = '208') and ../ram:SpecifiedDocumentStatus/ram:ReasonCode)">
...
<svrl:text>BR-FR-CDV-16 — Présence obligatoire de MDT-124-2</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus" mode="M39" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(ram:SequenceNumeric)" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(ram:SequenceNumeric)">
          ...
          <svrl:text>
        [BR-FR-CDV-13/MDT-124-2] : Le numéro incrémental de détail de statut (MDT-124-2) est obligatoire si un détail de statut (MDG-37) est présent.
      </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<svrl:text>BR-FR-CDV-CL-01 — Liste fermée de valeurs pour MDT-2</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext" mode="M40" priority="1000">
    <svrl:fired-rule context="rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext" />
    <xsl:variable name="TestPPF" select="(count(../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:GlobalID) = 1 and ../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:GlobalID[@schemeID='0238'] = '0000' and ../rsm:ExchangedDocument/ram:RecipientTradeParty/ram:RoleCode = 'DFH')" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(not($TestPPF) and (./ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID = 'REGULATED' or . = 'NON_REGULATED' or . = 'B2C' or . = 'B2CINT' or . = 'B2BINT' or . = 'OUTOFSCOPE')) or ($TestPPF and (string-length(normalize-space(./ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID)) &lt;= 3))">
...
<svrl:text>BR-FR-CDV-CL-02 — Contrôle de cohérence entre MDT-77 et MDT-21</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument" mode="M41" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(../rsm:AcknowledgementDocument/ram:TypeCode = '305') or ram:SenderTradeParty/ram:RoleCode = 'WK'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(../rsm:AcknowledgementDocument/ram:TypeCode = '23') or ram:SenderTradeParty/ram:RoleCode = 'BY' or ram:SenderTradeParty/ram:RoleCode = 'AB' or ram:SenderTradeParty/ram:RoleCode = 'DL' or ram:SenderTradeParty/ram:RoleCode = 'SE' or ram:SenderTradeParty/ram:RoleCode = 'SR' or ram:SenderTradeParty/ram:RoleCode = 'WK' or ram:SenderTradeParty/ram:RoleCode = 'PE' or ram:SenderTradeParty/ram:RoleCode = 'PR' or ram:SenderTradeParty/ram:RoleCode = 'II' or ram:SenderTradeParty/ram:RoleCode = 'IV'">
...
<svrl:text>BR-FR-CDV-CL-03 — Contrôle de cohérence entre MDT-77 et MDT-40</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument" mode="M42" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(../rsm:AcknowledgementDocument/ram:TypeCode = '305') or ram:IssuerTradeParty/ram:RoleCode = 'WK'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(../rsm:AcknowledgementDocument/ram:TypeCode = '23') or ram:IssuerTradeParty/ram:RoleCode = 'BY' or ram:IssuerTradeParty/ram:RoleCode = 'AB' or ram:IssuerTradeParty/ram:RoleCode = 'DL' or ram:IssuerTradeParty/ram:RoleCode = 'SE' or ram:IssuerTradeParty/ram:RoleCode = 'SR' or ram:IssuerTradeParty/ram:RoleCode = 'PE' or ram:IssuerTradeParty/ram:RoleCode = 'PR' or ram:IssuerTradeParty/ram:RoleCode = 'II' or ram:IssuerTradeParty/ram:RoleCode = 'IV'">
...
<svrl:text>BR-FR-CDV-CL-04 — Liste fermée de valeurs pour MDT-59</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument/ram:RecipientTradeParty/ram:RoleCode" mode="M43" priority="1000">
    <svrl:fired-rule context="rsm:ExchangedDocument/ram:RecipientTradeParty/ram:RoleCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test=". = 'BY' or . = 'AB' or . = 'DL' or . = 'SE' or . = 'SR' or          . = 'PE' or . = 'PR' or . = 'II' or . = 'IV' or . = 'WK' or . = 'DFH'" />
      <xsl:otherwise>
        <svrl:failed-assert test=". = 'BY' or . = 'AB' or . = 'DL' or . = 'SE' or . = 'SR' or . = 'PE' or . = 'PR' or . = 'II' or . = 'IV' or . = 'WK' or . = 'DFH'">
...
<svrl:text>BR-FR-CDV-CL-05 — Contrôle des statuts MDT-88 selon MDT-77</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" mode="M44" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="../ram:TypeCode != '305' or ram:StatusCode = '10' or ram:StatusCode = '51' or ram:StatusCode = '43' or ram:StatusCode = '8' or ram:StatusCode = '48' or not(ram:StatusCode)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="../ram:TypeCode != '23' or ram:StatusCode = '45' or ram:StatusCode = '39' or ram:StatusCode = '37' or ram:StatusCode = '50' or ram:StatusCode = '49' or ram:StatusCode = '47' or ram:StatusCode = '46' or ram:StatusCode = '1'or ram:StatusCode = '5'or not(ram:StatusCode)">
...
<svrl:text>BR-FR-CDV-CL-06 — Liste fermée de codes statuts de facture</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode" mode="M45" priority="1001">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="custom:is-valid-invoice-status-code(.)">
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:ProcessConditionCode" mode="M45" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:ProcessConditionCode" />
...
<svrl:text>BR-FR-CDV-CL-07 — Vérification de la valeur de MDT-132</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:IssuerTradeParty/ram:RoleCode" mode="M46" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:IssuerTradeParty/ram:RoleCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test=". = 'SE'" />
      <xsl:otherwise>
        <svrl:failed-assert test=". = 'SE'">
...
<svrl:text>BR-FR-CDV-CL-08 — Liste fermée de valeurs pour MDT-158</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:RecipientTradeParty/ram:RoleCode" mode="M47" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:RecipientTradeParty/ram:RoleCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test=". = 'BY' or . = 'AB' or . = 'DL' or . = 'SE' or . = 'SR' or          . = 'WK' or . = 'DFH' or . = 'PE' or . = 'PR' or          . = 'II' or . = 'IV'" />
      <xsl:otherwise>
        <svrl:failed-assert test=". = 'BY' or . = 'AB' or . = 'DL' or . = 'SE' or . = 'SR' or . = 'WK' or . = 'DFH' or . = 'PE' or . = 'PR' or . = 'II' or . = 'IV'">
...
<svrl:text>BR-FR-CDV-CL-09 — Liste fermée de codes motifs de statuts</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:ReasonCode" mode="M48" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:ReasonCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="custom:is-valid-status-reason-code(.)" />
      <xsl:otherwise>
        <svrl:failed-assert test="custom:is-valid-status-reason-code(.)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '200' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '200' )) or (../../ram:ProcessConditionCode = '200' and ../ram:ProcessConditionCode != '200' ) or (.) = 'NON_TRANSMISE'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '213' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '213' )) or (../../ram:ProcessConditionCode = '213' and ../ram:ProcessConditionCode != '213' ) or (.) = 'MONTANTTOTAL_ERR' or (.) = 'CALCUL_ERR' or (.) = 'DOUBLON' or (.) = 'DEST_INC' or (.) = 'ADR_ERR' or (.) = 'REJ_SEMAN' or (.) = 'REJ_UNI' or (.) = 'REJ_COH' or (.) = 'REJ_ADR' or (.) = 'REJ_CONT_B2G' or (.) = 'REJ_REF_PJ' or (.) = 'REJ_ASS_PJ'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '210' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '210' )) or (../../ram:ProcessConditionCode = '210' and ../ram:ProcessConditionCode != '210' ) or (/rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocument/ram:SenderTradeParty/ram:GlobalID[@schemeID = '0238'] = '9999') or (.) = 'TX_TVA_ERR' or (.) = 'MONTANTTOTAL_ERR' or (.) = 'CALCUL_ERR' or (.) = 'NON_CONFORME' or (.) = 'DOUBLON' or (.) = 'DEST_ERR' or (.) = 'TRANSAC_INC' or (.) = 'EMMET_INC' or (.) = 'CONTRAT_TERM' or (.) = 'DOUBLE_FACT' or (.) = 'CMD_ERR' or (.) = 'ADR_ERR' or (.) = 'REF_CT_ABSENT'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '207' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '207' )) or (../../ram:ProcessConditionCode = '207' and ../ram:ProcessConditionCode != '207' ) or (.) = 'AUTRE' or (.) = 'COORD_BANC_ERR' or (.) = 'TX_TVA_ERR' or (.) = 'MONTANTTOTAL_ERR' or (.) = 'CALCUL_ERR' or (.) = 'NON_CONFORME' or (.) = 'DOUBLON' or (.) = 'DEST_INC' or (.) = 'DEST_ERR' or (.) = 'TRANSAC_INC' or (.) = 'EMMET_INC' or (.) = 'CONTRAT_TERM' or (.) = 'DOUBLE_FACT' or (.) = 'CMD_ERR' or (.) = 'ADR_ERR' or (.) = 'SIRET_ERR' or (.) = 'CODE_ROUTAGE_ERR' or (.) = 'REF_CT_ABSENT' or (.) = 'REF_ERR' or (.) = 'PU_ERR' or (.) = 'REM_ERR' or (.) = 'QTE_ERR' or (.) = 'ART_ERR' or (.) = 'MODPAI_ERR' or (.) = 'QUALITE_ERR' or (.) = 'LIVR_INCOMP'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '206' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '206' )) or (../../ram:ProcessConditionCode = '206' and ../ram:ProcessConditionCode != '206' ) or (.) = 'AUTRE' or (.) = 'CMD_ERR' or (.) = 'SIRET_ERR' or (.) = 'CODE_ROUTAGE_ERR' or (.) = 'REF_CT_ABSENT' or (.) = 'REF_ERR' or (.) = 'PU_ERR' or (.) = 'REM_ERR' or (.) = 'QTE_ERR' or (.) = 'ART_ERR' or (.) = 'MODPAI_ERR' or (.) = 'QUALITE_ERR' or (.) = 'LIVR_INCOMP'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '208' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '208' )) or (../../ram:ProcessConditionCode = '208' and ../ram:ProcessConditionCode != '208' ) or (.) = 'JUSTIF_ABS' or (.) = 'COORD_BANC_ERR' or (.) = 'CMD_ERR' or (.) = 'SIRET_ERR' or (.) = 'CODE_ROUTAGE_ERR' or (.) = 'REF_CT_ABSENT' or (.) = 'REF_ERR'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '221' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '221' )) or (../../ram:ProcessConditionCode = '221' and ../ram:ProcessConditionCode != '221' ) or (.) = 'ROUTAGE_ERR'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(../../ram:ProcessConditionCode != '501' and (not(../ram:ProcessConditionCode) or ../ram:ProcessConditionCode != '501' )) or (../../ram:ProcessConditionCode = '501' and ../ram:ProcessConditionCode != '501' ) or (.) = 'IRR_VIDE_F' or (.) = 'IRR_TYPE_F' or (.) = 'IRR_SYNTAX' or (.) = 'IRR_TAILLE_PJ' or (.) = 'IRR_NOM_PJ' or (.) = 'IRR_VID_PJ' or (.) = 'IRR_EXT_DOC' or (.) = 'IRR_TAILLE_F' or (.) = 'IRR_ANTIVIRUS' or (.) = 'IRR_NOM_F'">
...
<svrl:text>BR-FR-CDV-CL-10 — Liste fermée de codes actions de facture</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:RequestedActionCode" mode="M49" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:RequestedActionCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="custom:is-valid-invoice-action-code(.)" />
      <xsl:otherwise>
        <svrl:failed-assert test="custom:is-valid-invoice-action-code(.)">
...
<svrl:text>BR-FR-CDV-CL-11 — Liste fermée de codes pour MDT-207</svrl:text>

	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:SpecifiedDocumentCharacteristic/ram:TypeCode" mode="M50" priority="1000">
    <svrl:fired-rule context="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:SpecifiedDocumentStatus/ram:SpecifiedDocumentCharacteristic/ram:TypeCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test=". = 'MEN' or . = 'MPA' or . = 'RAP' or . = 'ESC' or . = 'RAB' or . = 'REM' or . = 'MAP' or . = 'MAPTTC' or . = 'MNA' or . = 'MNATTC' or . = 'CBB' or . = 'DIV' or . = 'DVA' or . = 'MAJ'" />
      <xsl:otherwise>
        <svrl:failed-assert test=". = 'MEN' or . = 'MPA' or . = 'RAP' or . = 'ESC' or . = 'RAB' or . = 'REM' or . = 'MAP' or . = 'MAPTTC' or . = 'MNA' or . = 'MNATTC' or . = 'CBB' or . = 'DIV' or . = 'DVA' or . = 'MAJ'">
