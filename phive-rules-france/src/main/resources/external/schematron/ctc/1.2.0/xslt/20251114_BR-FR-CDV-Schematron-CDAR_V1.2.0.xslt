...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="ram:RoleCode != '23' or ram:GlobalID">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="ram:RoleCode != '305' or not(ram:GlobalID)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="ram:FormattedIssueDateTime or rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext/ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID = '501'">
...
<svrl:text>BR-FR-CDV-12 — Présence obligatoire de MDT-105</svrl:text>
	...
	<!--RULE -->
<xsl:template match="rsm:AcknowledgementDocument/ram:ReferenceReferencedDocument/ram:ProcessConditionCode" mode="M35" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="ram:GlobalID or /rsm:CrossDomainAcknowledgementAndResponse/rsm:ExchangedDocumentContext/ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID = '501'">
