...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:DocumentReference/cbc:ID | cn:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:ID" mode="M20" priority="1000">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxPointDate | cn:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxPointDate" mode="M22" priority="1009">
    <svrl:fired-rule context="ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxPointDate | cn:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxPointDate" />
...
<svrl:text>BR-FR-04 — Validation du code type de document</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cbc:InvoiceTypeCode | cn:CreditNote/cbc:InvoiceTypeCode" mode="M23" priority="1002">
    <svrl:fired-rule context="ubl:Invoice/cbc:InvoiceTypeCode | cn:CreditNote/cbc:InvoiceTypeCode" />
...
<xsl:template match="ubl:Invoice/cac:PayeeParty | cn:CreditNote/cac:PayeeParty" mode="M27" priority="1007">
    ...
    <xsl:variable name="siret" select="cac:PartyIdentification/cbc:ID[@schemeID='0009']" />
    <xsl:variable name="siren" select="if (string(cac:PartyLegalEntity/cbc:CompanyID[@schemeID='0002'])) then cac:PartyLegalEntity/cbc:CompanyID[@schemeID='0002'] else substring($siret, 1, 9)" />
...
<xsl:template match="ubl:Invoice/cac:Delivery | cn:CreditNote/cac:Delivery" mode="M27" priority="1001">
    ...
    <xsl:variable name="siren" select="if (string(cac:DeliveryParty/cac:PartyLegalEntity/cbc:CompanyID[@schemeID='0002'])) then cac:DeliveryParty/cac:PartyLegalEntity/cbc:CompanyID[@schemeID='0002'] else substring($siret, 1, 9)" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:DocumentTypeCode or custom:is-valid-attachment-code($docTypeDESC)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<svrl:text>BR-FR-CO-03 — Présence obligatoire du contrat et de la période de facturation si type de facture = 262 (Avoir Remise Globale)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cn:CreditNote" mode="M43" priority="1000">
...
<svrl:text>BR-FR-CO-04 — Une seule référence à une facture antérieure obligatoire pour les factures rectificatives (BT-3)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice | cn:CreditNote" mode="M44" priority="1000">
    <svrl:fired-rule context="ubl:Invoice | cn:CreditNote" />
...
<svrl:text>BR-FR-CO-05 — Référence obligatoire à une facture antérieure pour les avoirs (BT-3)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cn:CreditNote" mode="M45" priority="1000">
    <svrl:fired-rule context="cn:CreditNote" />
    <xsl:variable name="typeCode" select="cbc:CreditNoteTypeCode" />
...
<svrl:text>BR-FR-CO-07 — La date d’échéance (BT-9) doit être postérieure ou égale à la date de facture (BT-2), sauf cas particuliers</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice | cn:CreditNote" mode="M46" priority="1000">
    <svrl:fired-rule context="ubl:Invoice | cn:CreditNote" />
    <xsl:variable name="typeCode" select="cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not($billingContext = 'B2' or $billingContext = 'S2' or $billingContext = 'M2') or ($paidAmount = $grandTotal)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not($billingContext = 'B2' or $billingContext = 'S2' or $billingContext = 'M2') or ($payableAmount = 0)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID) or cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID) or cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:PayeeParty/cac:PartyIdentification/cbc:ID) or cac:PayeeParty/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cac:PartyIdentification/cbc:ID) or cac:AccountingCustomerParty/cac:Party/cac:AgentParty/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty/cac:PartyIdentification/cbc:ID) or cac:PaymentMeans/cac:PaymentMandate/cac:PayerParty/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:AccountingSupplierParty/cac:Party/cac:AgentParty/cac:PartyIdentification/cbc:ID) or cac:AccountingSupplierParty/cac:Party/cac:AgentParty/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party/cac:PartyIdentification/cbc:ID) or cac:AccountingCustomerParty/cac:Party/cac:ServiceProviderParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party/cac:PartyIdentification/cbc:ID) or cac:AccountingSupplierParty/cac:Party/cac:ServiceProviderParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<svrl:text>BR-FR-DEC-01 — Format des montants numériques (max 19 caractères, 2 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:AllowanceCharge/cbc:BaseAmount" mode="M53" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:AllowanceCharge/cbc:Amount | cn:CreditNote/cac:AllowanceCharge/cbc:Amount" mode="M53" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:LineExtensionAmount" mode="M53" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount" mode="M53" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:ChargeTotalAmount" mode="M53" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount" mode="M53" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cbc:TaxAmount" mode="M53" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cbc:TaxAmount" mode="M53" priority="1009">
    <svrl:fired-rule context="cac:TaxTotal/cbc:TaxAmount" />
    <xsl:variable name="amount" select="normalize-space(.)" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount" mode="M53" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:PrepaidAmount" mode="M53" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:PayableRoundingAmount" mode="M53" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal/cbc:PayableAmount" mode="M53" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount" mode="M53" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount" mode="M53" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cbc:LineExtensionAmount | cn:CreditNote/cac:CreditNoteLine/cbc:LineExtensionAmount" mode="M53" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:Amount | cn:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:Amount" mode="M53" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:BaseAmount" mode="M53" priority="1000">
...
<svrl:text>BR-FR-DEC-02 — Format des quantités numériques (max 19 caractères, 4 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cbc:InvoicedQuantity | cn:CreditNote/cac:CreditNoteLine/cbc:CreditedQuantity" mode="M54" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine" mode="M54" priority="1000">
...
<svrl:text>BR-FR-DEC-03 — Format des montants positifs (max 19 caractères, 6 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine" mode="M55" priority="1002">
    <svrl:fired-rule context="ubl:Invoice/cac:InvoiceLine | cn:CreditNote/cac:CreditNoteLine" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge | cn:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge" mode="M55" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount | cn:CreditNote/cac:CreditNoteLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount" mode="M55" priority="1000">
...
<svrl:text>BR-FR-DEC-04 — Format des taux de TVA (max 4 caractères, 2 décimales, séparateur « . »)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge/cac:TaxCategory/cbc:Percent" mode="M56" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent" mode="M56" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Item/cac:ClassifiedTaxCategory/cbc:Percent" mode="M56" priority="1000">
