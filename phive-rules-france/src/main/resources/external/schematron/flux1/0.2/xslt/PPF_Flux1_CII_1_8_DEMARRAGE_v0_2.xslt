...
<!--PATTERN F1-START-VENDEUR-TVA-G2.33-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty" mode="M9" priority="1000">
...
<!--PATTERN F1-START-ACHETEUR-TVA-G2.33-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty" mode="M12" priority="1000">
...
<!--PATTERN F1-START-ACHETEUR-PAYS-G2.01-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID" mode="M13" priority="1000">
...
<!--PATTERN F1-START-TAXE-TYPE-G1.103-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:TypeCode" mode="M14" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-CONDITIONS-P1.11-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:DueDateTypeCode" mode="M15" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-MOYEN-BT81-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans/ram:TypeCode" mode="M16" priority="1000">
...
<!--PATTERN F1-START-LOGISTIQUE-TRANSPORT-BT80-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeDelivery/ram:SpecifiedBorderTransportMeans/ram:ModeCode" mode="M17" priority="1000">
...
<!--PATTERN F1-START-TVA-CATEGORIE-G2.31-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:CategoryCode" mode="M18" priority="1000">
...
<!--PATTERN F1-START-TVA-TAUX-G1.24-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:RateApplicablePercent" mode="M19" priority="1000">
...
<!--PATTERN F1-START-TOTAL-FORMATS-G1.14-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/*[ends-with(local-name(), 'Amount')]" mode="M20" priority="1000">
...
<!--PATTERN F1-START-TOTAL-COHERENCE-G1.53-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" mode="M21" priority="1000">
...
<!--PATTERN F1-START-LIGNE-PRIX-G1.55-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:NetPriceProductTradePrice" mode="M22" priority="1000">
...
<!--PATTERN F1-START-LIGNE-QUANTITE-G1.15-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeDelivery/ram:BilledQuantity" mode="M23" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-BG23-G6.08-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" mode="M25" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.09-DATES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//udt:DateTimeString" mode="M28" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G6.25-PERIODES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:BillingSpecifiedPeriod[ram:StartDateTime/udt:DateTimeString and ram:EndDateTime/udt:DateTimeString]" mode="M29" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.05-REF-ID-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceReferencedDocument/ram:IssuerAssignedID" mode="M31" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.14-MONTANTS-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//*[local-name() = ('ActualAmount','BasisAmount','CalculatedAmount','TaxBasisTotalAmount','TaxTotalAmount','LineTotalAmount','GrandTotalAmount','AllowanceTotalAmount','ChargeTotalAmount','TotalPrepaidAmount','DuePayableAmount')][not(ancestor::ram:GrossPriceProductTradePrice)][not(ancestor::ram:NetPriceProductTradePrice)]" mode="M32" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.16-PRIX-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem//ram:SpecifiedLineTradeAgreement//*[ends-with(local-name(), 'Amount')]" mode="M33" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.14-ASSUJETTI-UNIQUE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:GlobalID" mode="M35" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.17-QUALIFIANTS-TVA-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//ram:SpecifiedTaxRegistration/ram:ID" mode="M36" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.24-G2.31-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" mode="M39" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" />
...
<!--PATTERN F1-COMPLETE-CII-G1.53-COHERENCE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" mode="M40" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" />
