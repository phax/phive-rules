...
<!--PATTERN F1-FULL-UBL-G6.09-CONTENU-LIGNE-->
	...
	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine" mode="M41" priority="1000">
...
<!--PATTERN F1-CIBLE-UBL-G1.31-REFERENCES-ANTERIEURES-->
	...
	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" mode="M42" priority="1000">
    <svrl:fired-rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" />
...
<!--PATTERN F1-CIBLE-UBL-BT26-DATE-FACTURE-ANTERIEURE-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate | (/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate" mode="M43" priority="1000">
...
<!--PATTERN F1-CIBLE-UBL-G6.16-ADRESSE-LIVRAISON-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:Delivery/cac:DeliveryLocation/cac:Address | (/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M44" priority="1000">
...
<!--PATTERN F1-CIBLE-UBL-G6.25-PERIODES-LIGNE-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:InvoicePeriod[cbc:StartDate and cbc:EndDate]" mode="M46" priority="1000">
...
<!--PATTERN F1-FULL-UBL-ALLOWANCE-CHARGE-DOCUMENT-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AllowanceCharge" mode="M47" priority="1000">
...
<!--PATTERN F1-FULL-UBL-ALLOWANCE-CHARGE-LIGNE-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:AllowanceCharge" mode="M48" priority="1000">
