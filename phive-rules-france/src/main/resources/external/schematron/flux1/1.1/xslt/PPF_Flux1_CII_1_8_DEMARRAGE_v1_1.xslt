...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="ISO19757-3" title="PPF — Flux 1 CII e-invoicing &amp; e-reporting — Profil de Base (Trajectoire DÉMARRAGE)">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>PPF — Flux 1 CII e-invoicing &amp; e-reporting — Profil de Base (Trajectoire DÉMARRAGE)</svrl:text>

<!--PATTERN F1-START-FACTURE-ID-G1.05-->


	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:ID" mode="M5" priority="1000">
...
<!--PATTERN F1-START-FACTURE-TYPE-G1.01-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:TypeCode" mode="M6" priority="1000">
...
<!--PATTERN F1-START-FACTURE-DATE-G1.09-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:IssueDateTime/udt:DateTimeString" mode="M7" priority="1000">
...
<!--PATTERN F1-START-VENDEUR-ID-G2.19-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedLegalOrganization/ram:ID" mode="M8" priority="1000">
...
<!--PATTERN F1-START-VENDEUR-PAYS-G2.01-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:PostalTradeAddress/ram:CountryID" mode="M9" priority="1000">
...
<!--PATTERN F1-START-ACHETEUR-ID-G2.19-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:SpecifiedLegalOrganization/ram:ID" mode="M10" priority="1000">
...
<!--PATTERN F1-START-ACHETEUR-PAYS-G2.01-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID" mode="M11" priority="1000">
...
<!--PATTERN F1-START-TAXE-TYPE-G1.103-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:TypeCode" mode="M12" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-CONDITIONS-P1.11-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:DueDateTypeCode" mode="M13" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-MOYEN-BT81-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans/ram:TypeCode" mode="M14" priority="1000">
...
<!--PATTERN F1-START-LOGISTIQUE-TRANSPORT-BT80-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeDelivery/ram:SpecifiedBorderTransportMeans/ram:ModeCode" mode="M15" priority="1000">
...
<!--PATTERN F1-START-TVA-CATEGORIE-G2.31-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:CategoryCode" mode="M16" priority="1000">
...
<!--PATTERN F1-START-TVA-TAUX-G1.24-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:RateApplicablePercent" mode="M17" priority="1000">
...
<!--PATTERN F1-START-TOTAL-FORMATS-G1.14-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/*[ends-with(local-name(), 'Amount')]" mode="M18" priority="1000">
...
<!--PATTERN F1-START-TOTAL-COHERENCE-G1.53-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" mode="M19" priority="1000">
...
<!--PATTERN F1-START-LIGNE-PRIX-G1.55-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:NetPriceProductTradePrice" mode="M20" priority="1000">
...
<!--PATTERN F1-START-LIGNE-QUANTITE-G1.15-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeDelivery/ram:BilledQuantity" mode="M21" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G6.08-OBLIGATOIRES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice" mode="M22" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-BG23-G6.08-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" mode="M23" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.09-DATES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//udt:DateTimeString" mode="M26" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G6.25-PERIODES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:BillingSpecifiedPeriod[ram:StartDateTime/udt:DateTimeString and ram:EndDateTime/udt:DateTimeString]" mode="M27" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(rsm:ExchangedDocument/ram:TypeCode = ('261','381','396','502','503')) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceReferencedDocument/ram:IssuerAssignedID" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(rsm:ExchangedDocument/ram:TypeCode = ('261','381','396','502','503')) or rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceReferencedDocument/ram:IssuerAssignedID">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN F1-COMPLETE-CII-G1.05-REF-ID-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceReferencedDocument/ram:IssuerAssignedID" mode="M29" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.14-MONTANTS-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//*[local-name() = ('ActualAmount','BasisAmount','CalculatedAmount','TaxBasisTotalAmount','TaxTotalAmount','LineTotalAmount','GrandTotalAmount','AllowanceTotalAmount','ChargeTotalAmount','TotalPrepaidAmount','DuePayableAmount')][not(ancestor::ram:GrossPriceProductTradePrice)][not(ancestor::ram:NetPriceProductTradePrice)]" mode="M30" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.16-PRIX-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem//ram:SpecifiedLineTradeAgreement//*[ends-with(local-name(), 'Amount')]" mode="M31" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.14-ASSUJETTI-UNIQUE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:GlobalID" mode="M33" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.17-QUALIFIANTS-TVA-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//ram:SpecifiedTaxRegistration/ram:ID" mode="M34" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.13-DUE-DATE-TYPE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" mode="M35" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" />
...
<!--PATTERN F1-COMPLETE-CII-G1.24-G2.31-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" mode="M37" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" />
