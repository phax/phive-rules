...
<!--PATTERN F1-START-VENDEUR-PAYS-G2.01-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:PostalTradeAddress/ram:CountryID" mode="M10" priority="1000">
...
<!--PATTERN F1-START-ACHETEUR-ID-G2.19-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:SpecifiedLegalOrganization/ram:ID" mode="M11" priority="1000">
...
<!--PATTERN F1-START-ACHETEUR-PAYS-G2.01-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID" mode="M12" priority="1000">
...
<!--PATTERN F1-START-TAXE-TYPE-G1.103-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:TypeCode" mode="M13" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-CONDITIONS-P1.11-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:DueDateTypeCode" mode="M14" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-MOYEN-BT81-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans/ram:TypeCode" mode="M15" priority="1000">
...
<!--PATTERN F1-START-LOGISTIQUE-TRANSPORT-BT80-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeDelivery/ram:SpecifiedBorderTransportMeans/ram:ModeCode" mode="M16" priority="1000">
...
<!--PATTERN F1-START-TVA-CATEGORIE-G2.31-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:CategoryCode" mode="M17" priority="1000">
...
<!--PATTERN F1-START-TVA-TAUX-G1.24-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:RateApplicablePercent" mode="M18" priority="1000">
...
<!--PATTERN F1-START-TOTAL-FORMATS-G1.14-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/*[ends-with(local-name(), 'Amount')]" mode="M19" priority="1000">
...
<!--PATTERN F1-START-TOTAL-COHERENCE-G1.53-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" mode="M20" priority="1000">
    ...
    <xsl:variable name="deviseFacture" select="ram:InvoiceCurrencyCode" />
    <xsl:variable name="totalTVA" select="ram:SpecifiedTradeSettlementHeaderMonetarySummation/ram:TaxTotalAmount[@currencyID = $deviseFacture]" />
...
<!--PATTERN F1-START-LIGNE-PRIX-G1.55-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:NetPriceProductTradePrice" mode="M21" priority="1000">
...
<!--PATTERN F1-START-LIGNE-QUANTITE-G1.15-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeDelivery/ram:BilledQuantity" mode="M22" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G6.08-OBLIGATOIRES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice" mode="M23" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-BG23-G6.08-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" mode="M24" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.10-G1.12-DEVISES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice" mode="M26" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice" />
...
<xsl:choose>
    ...
    <xsl:variable name="deviseBT5" select="rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceCurrencyCode" />
    <xsl:variable name="occurrencesBT110" select="rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation/ram:TaxTotalAmount" />
...
<!--PATTERN F1-COMPLETE-CII-G1.09-DATES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//udt:DateTimeString" mode="M27" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G6.25-PERIODES-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:BillingSpecifiedPeriod[ram:StartDateTime/udt:DateTimeString and ram:EndDateTime/udt:DateTimeString]" mode="M28" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.05-REF-ID-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:InvoiceReferencedDocument/ram:IssuerAssignedID" mode="M30" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.14-MONTANTS-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//*[local-name() = ('ActualAmount','BasisAmount','CalculatedAmount','TaxBasisTotalAmount','TaxTotalAmount','LineTotalAmount','GrandTotalAmount','AllowanceTotalAmount','ChargeTotalAmount','TotalPrepaidAmount','DuePayableAmount')][not(ancestor::ram:GrossPriceProductTradePrice)][not(ancestor::ram:NetPriceProductTradePrice)]" mode="M31" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-G1.16-PRIX-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem//ram:SpecifiedLineTradeAgreement//*[ends-with(local-name(), 'Amount')]" mode="M32" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.14-ASSUJETTI-UNIQUE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:GlobalID" mode="M34" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.17-QUALIFIANTS-TVA-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//ram:SpecifiedTaxRegistration/ram:ID" mode="M35" priority="1000">
...
<!--PATTERN F1-COMPLETE-CII-S1.13-DUE-DATE-TYPE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" mode="M36" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" />
...
<xsl:choose>
    ...
    <xsl:variable name="idsCii" select="rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:CategoryCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not((every $c in $idsCii satisfies ($c = 'O')) or (every $c in $idsCii satisfies ($c = 'E') and exists(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:ExemptionReasonCode[. = ('VATEX-FR-CGI261-1','VATEX-FR-CGI261-2','VATEX-FR-CGI261-3','VATEX-FR-CGI261-4','VATEX-FR-CGI261-5','VATEX-FR-CGI261-7','VATEX-FR-CGI261-8','VATEX-FR-CGI261A','VATEX-FR-CGI261B','VATEX-FR-CGI261C-1','VATEX-FR-CGI261C-2','VATEX-FR-CGI261C-3','VATEX-FR-CGI261D-1','VATEX-FR-CGI261D-1BIS','VATEX-FR-CGI261D-2','VATEX-FR-CGI261D-3','VATEX-FR-CGI261D-4','VATEX-FR-CGI261E-1','VATEX-FR-CGI261E-2')])) or (every $c in $idsCii satisfies $c = ('O','E')) and (some $c1 in $idsCii satisfies $c1 = 'O') and (some $c2 in $idsCii satisfies $c2 = 'E'))" />
      <xsl:otherwise>
        <svrl:failed-assert test="not((every $c in $idsCii satisfies ($c = 'O')) or (every $c in $idsCii satisfies ($c = 'E') and exists(rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:ExemptionReasonCode[. = ('VATEX-FR-CGI261-1','VATEX-FR-CGI261-2','VATEX-FR-CGI261-3','VATEX-FR-CGI261-4','VATEX-FR-CGI261-5','VATEX-FR-CGI261-7','VATEX-FR-CGI261-8','VATEX-FR-CGI261A','VATEX-FR-CGI261B','VATEX-FR-CGI261C-1','VATEX-FR-CGI261C-2','VATEX-FR-CGI261C-3','VATEX-FR-CGI261D-1','VATEX-FR-CGI261D-1BIS','VATEX-FR-CGI261D-2','VATEX-FR-CGI261D-3','VATEX-FR-CGI261D-4','VATEX-FR-CGI261E-1','VATEX-FR-CGI261E-2')])) or (every $c in $idsCii satisfies $c = ('O','E')) and (some $c1 in $idsCii satisfies $c1 = 'O') and (some $c2 in $idsCii satisfies $c2 = 'E'))">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN F1-COMPLETE-CII-G1.24-G2.31-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" mode="M38" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax" />
...
<!--PATTERN F1-COMPLETE-CII-G1.53-COHERENCE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" mode="M39" priority="1000">
    <svrl:fired-rule context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement" />
...
<!--PATTERN F1-FULL-CII-G6.09-CONTENU-LIGNE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem" mode="M41" priority="1000">
...
<!--PATTERN F1-CIBLE-CII-BT26-DATE-FACTURE-ANTERIEURE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice//ram:InvoiceReferencedDocument/ram:FormattedIssueDateTime/qdt:DateTimeString" mode="M43" priority="1000">
...
<!--PATTERN F1-CIBLE-CII-G6.16-ADRESSE-LIVRAISON-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:PostalTradeAddress | /rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeDelivery/ram:ShipToTradeParty/ram:PostalTradeAddress" mode="M44" priority="1000">
...
<!--PATTERN F1-CIBLE-CII-G6.25-PERIODES-LIGNE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:BillingSpecifiedPeriod[ram:StartDateTime/udt:DateTimeString and ram:EndDateTime/udt:DateTimeString]" mode="M46" priority="1000">
...
<!--PATTERN F1-FULL-CII-ALLOWANCE-CHARGE-DOCUMENT-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/                  rsm:SupplyChainTradeTransaction/                  ram:ApplicableHeaderTradeSettlement/                  ram:SpecifiedTradeAllowanceCharge" mode="M47" priority="1000">
...
<!--PATTERN F1-FULL-CII-ALLOWANCE-CHARGE-LIGNE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeAllowanceCharge" mode="M48" priority="1000">
...
<!--PATTERN F1-FULL-CII-G1.16-PRIX-LIGNE-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement//ram:*[local-name() = ('ChargeAmount','ActualAmount','BasisAmount')]" mode="M49" priority="1000">
