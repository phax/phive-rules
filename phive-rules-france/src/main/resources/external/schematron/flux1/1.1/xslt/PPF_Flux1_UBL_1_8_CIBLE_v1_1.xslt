...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="ISO19757-3" title="PPF — Flux 1 UBL e-invoicing &amp; e-reporting — Profil de Base (Trajectoire DÉMARRAGE) - Extension FULL/CIBLE">
      <xsl:comment>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-FULL-UBL-G6.09-LIGNES-OBLIGATOIRES</xsl:attribute>
        <xsl:attribute name="name">F1-FULL-UBL-G6.09-LIGNES-OBLIGATOIRES</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-FULL-UBL-G6.09-CONTENU-LIGNE</xsl:attribute>
        <xsl:attribute name="name">F1-FULL-UBL-G6.09-CONTENU-LIGNE</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-CIBLE-UBL-G1.31-REFERENCES-ANTERIEURES</xsl:attribute>
        <xsl:attribute name="name">F1-CIBLE-UBL-G1.31-REFERENCES-ANTERIEURES</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-CIBLE-UBL-BT26-DATE-FACTURE-ANTERIEURE</xsl:attribute>
        <xsl:attribute name="name">F1-CIBLE-UBL-BT26-DATE-FACTURE-ANTERIEURE</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-CIBLE-UBL-G6.16-ADRESSE-LIVRAISON</xsl:attribute>
        <xsl:attribute name="name">F1-CIBLE-UBL-G6.16-ADRESSE-LIVRAISON</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-CIBLE-UBL-DATES-LIGNE</xsl:attribute>
        <xsl:attribute name="name">F1-CIBLE-UBL-DATES-LIGNE</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-CIBLE-UBL-G6.25-PERIODES-LIGNE</xsl:attribute>
        <xsl:attribute name="name">F1-CIBLE-UBL-G6.25-PERIODES-LIGNE</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-FULL-UBL-ALLOWANCE-CHARGE-DOCUMENT</xsl:attribute>
        <xsl:attribute name="name">F1-FULL-UBL-ALLOWANCE-CHARGE-DOCUMENT</xsl:attribute>
      </svrl:active-pattern>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">F1-FULL-UBL-ALLOWANCE-CHARGE-LIGNE</xsl:attribute>
        <xsl:attribute name="name">F1-FULL-UBL-ALLOWANCE-CHARGE-LIGNE</xsl:attribute>
      </svrl:active-pattern>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>PPF — Flux 1 UBL e-invoicing &amp; e-reporting — Profil de Base (Trajectoire DÉMARRAGE) - Extension FULL/CIBLE</svrl:text>
...
<!--PATTERN F1-START-VENDEUR-PAYS-G2.01-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M10" priority="1000">
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(., '^[A-Z]{2}$')">
          ...
          <svrl:text>[G2.01] Le code pays du vendeur (<xsl:text />
            <xsl:value-of select="." />
            <xsl:text />) doit comporter 2 lettres majuscules ISO 3166-1 alpha-2 ('EL' requis pour la Grèce). | Source : Annexe 7 v1.8 G2.01</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M10" select="*" />
...
<!--PATTERN F1-START-ACHETEUR-ID-G2.19-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M11" priority="1000">
...
<!--PATTERN F1-START-ACHETEUR-PAYS-G2.01-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M12" priority="1000">
...
<!--PATTERN F1-START-TAXE-TYPE-G1.103-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID" mode="M13" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-CONDITIONS-P1.11-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:InvoicePeriod/cbc:DescriptionCode" mode="M14" priority="1000">
...
<!--PATTERN F1-START-PAIEMENT-MOYEN-BT81-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:PaymentMeans/cbc:PaymentMeansCode" mode="M15" priority="1000">
...
<!--PATTERN F1-START-LOGISTIQUE-TRANSPORT-BT80-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:Delivery/cac:Shipment/cac:ShipmentStage/cac:TransportMeans/cbc:TransportModeCode" mode="M16" priority="1000">
...
<!--PATTERN F1-START-TVA-CATEGORIE-G2.31-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID" mode="M17" priority="1000">
...
<!--PATTERN F1-START-TVA-TAUX-G1.24-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent" mode="M18" priority="1000">
...
<!--PATTERN F1-START-TOTAL-FORMATS-G1.14-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:LegalMonetaryTotal/*[ends-with(local-name(), 'Amount')]" mode="M19" priority="1000">
...
<!--PATTERN F1-START-TOTAL-COHERENCE-G1.53-->
	...
	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" mode="M20" priority="1000">
    ...
    <xsl:variable name="deviseFacture" select="cbc:DocumentCurrencyCode" />
    <xsl:variable name="totalTVA" select="cac:TaxTotal[cbc:TaxAmount/@currencyID = $deviseFacture]/cbc:TaxAmount" />
    <xsl:variable name="sommeTVA" select="cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount" />
    <xsl:variable name="sommeBasesHTDec" select="for $x in $sommeBasesHT return xs:decimal($x)" />
    <xsl:variable name="sommeTVADec" select="for $x in $sommeTVA return xs:decimal($x)" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not($totalHT) or not($sommeBasesHT) or (abs(xs:decimal($totalHT) - sum($sommeBasesHTDec)) &lt;= 0.01)" />
      <xsl:otherwise>
        <svrl:failed-assert test="not($totalHT) or not($sommeBasesHT) or (abs(xs:decimal($totalHT) - sum($sommeBasesHTDec)) &lt;= 0.01)">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[G1.53] Écart sur le Total Hors Taxe global (<xsl:text />
            ...
            <xsl:value-of select="sum($sommeBasesHTDec)" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not($totalTVA) or not($sommeTVA) or (abs(xs:decimal($totalTVA) - sum($sommeTVADec)) &lt;= 0.01)" />
      <xsl:otherwise>
        <svrl:failed-assert test="not($totalTVA) or not($sommeTVA) or (abs(xs:decimal($totalTVA) - sum($sommeTVADec)) &lt;= 0.01)">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[G1.53] Écart sur le Montant Total de TVA global (<xsl:text />
            ...
            <xsl:value-of select="sum($sommeTVADec)" />
            <xsl:text />). Tolérance de 0,01 EUR. | Source : Annexe 7 v1.8 G1.53</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<!--PATTERN F1-START-LIGNE-PRIX-G1.55-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:Price" mode="M21" priority="1000">
...
<!--PATTERN F1-START-LIGNE-QUANTITE-G1.15-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cbc:InvoicedQuantity | (/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cbc:CreditedQuantity" mode="M22" priority="1000">
...
<!--PATTERN F1-COMPLETE-UBL-G6.08-OBLIGATOIRES-->
	...
	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" mode="M23" priority="1000">
    <svrl:fired-rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" />
...
<!--PATTERN F1-COMPLETE-UBL-BG23-G6.08-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:TaxTotal/cac:TaxSubtotal" mode="M24" priority="1000">
...
<!--PATTERN F1-COMPLETE-UBL-G1.10-G1.12-DEVISES-->
	...
	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" mode="M26" priority="1000">
    <svrl:fired-rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" />
...
<xsl:choose>
    ...
    <xsl:variable name="deviseBT5" select="cbc:DocumentCurrencyCode" />
    <xsl:variable name="occurrencesBT110" select="cac:TaxTotal/cbc:TaxAmount" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="($deviseBT5 = 'EUR' and count($occurrencesBT110) = 1 and $occurrencesBT110[@currencyID = 'EUR']) or ($deviseBT5 != 'EUR' and count($occurrencesBT110) = 2 and $occurrencesBT110[@currencyID = $deviseBT5] and $occurrencesBT110[@currencyID = 'EUR'])" />
      <xsl:otherwise>
        <svrl:failed-assert test="($deviseBT5 = 'EUR' and count($occurrencesBT110) = 1 and $occurrencesBT110[@currencyID = 'EUR']) or ($deviseBT5 != 'EUR' and count($occurrencesBT110) = 2 and $occurrencesBT110[@currencyID = $deviseBT5] and $occurrencesBT110[@currencyID = 'EUR'])">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[G1.12] Si BT-5 est different de EUR, le document doit comporter exactement 2 occurrences du montant total de TVA (BT-110/BT-111) : une en devise BT-5 et une en EUR. Si BT-5 est EUR, une seule occurrence en EUR est attendue. | Source : Annexe 7 v1.8 G1.12</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M26" select="*" />
...
<!--PATTERN F1-COMPLETE-UBL-G6.25-PERIODES-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)//cac:InvoicePeriod[cbc:StartDate and cbc:EndDate]" mode="M28" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not((self::ubl-invoice:Invoice and cbc:InvoiceTypeCode = ('261','381','396','502','503')) or (self::ubl-creditnote:CreditNote and cbc:CreditNoteTypeCode = ('261','381','396','502','503'))) or cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID or (count(cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID) = 0 and exists((cac:InvoiceLine | cac:CreditNoteLine)) and (every $l in (cac:InvoiceLine | cac:CreditNoteLine) satisfies ($l/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID and $l/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate)))" />
      <xsl:otherwise>
        <svrl:failed-assert test="not((self::ubl-invoice:Invoice and cbc:InvoiceTypeCode = ('261','381','396','502','503')) or (self::ubl-creditnote:CreditNote and cbc:CreditNoteTypeCode = ('261','381','396','502','503'))) or cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID or (count(cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID) = 0 and exists((cac:InvoiceLine | cac:CreditNoteLine)) and (every $l in (cac:InvoiceLine | cac:CreditNoteLine) satisfies ($l/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID and $l/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate)))">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN F1-COMPLETE-UBL-G1.05-REF-ID-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID" mode="M30" priority="1000">
...
<!--PATTERN F1-COMPLETE-UBL-G1.16-PRIX-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:Price//cbc:*[local-name() = ('PriceAmount','BaseAmount','Amount')]" mode="M32" priority="1000">
...
<!--PATTERN F1-COMPLETE-UBL-G2.19-G1.63-SIREN-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID | (/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M33" priority="1000">
...
<!--PATTERN F1-COMPLETE-UBL-S1.14-ASSUJETTI-UNIQUE-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M34" priority="1000">
...
<!--PATTERN F1-COMPLETE-UBL-S1.17-QUALIFIANTS-TVA-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)//cac:PartyTaxScheme/cac:TaxScheme/cbc:ID | (/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)//cac:TaxCategory/cac:TaxScheme/cbc:ID" mode="M35" priority="1000">
...
<!--PATTERN F1-COMPLETE-UBL-G1.41-G1.47-G2.32-G6.21-->
	...
	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" mode="M36" priority="1000">
    <svrl:fired-rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" />
...
<xsl:choose>
    ...
    <xsl:variable name="idsUbl" select="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not((every $c in $idsUbl satisfies ($c = 'O')) or (every $c in $idsUbl satisfies ($c = 'E') and exists(cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReasonCode[. = ('VATEX-FR-CGI261-1','VATEX-FR-CGI261-2','VATEX-FR-CGI261-3','VATEX-FR-CGI261-4','VATEX-FR-CGI261-5','VATEX-FR-CGI261-7','VATEX-FR-CGI261-8','VATEX-FR-CGI261A','VATEX-FR-CGI261B','VATEX-FR-CGI261C-1','VATEX-FR-CGI261C-2','VATEX-FR-CGI261C-3','VATEX-FR-CGI261D-1','VATEX-FR-CGI261D-1BIS','VATEX-FR-CGI261D-2','VATEX-FR-CGI261D-3','VATEX-FR-CGI261D-4','VATEX-FR-CGI261E-1','VATEX-FR-CGI261E-2')])) or (every $c in $idsUbl satisfies $c = ('O','E')) and (some $c1 in $idsUbl satisfies $c1 = 'O') and (some $c2 in $idsUbl satisfies $c2 = 'E'))" />
      <xsl:otherwise>
        <svrl:failed-assert test="not((every $c in $idsUbl satisfies ($c = 'O')) or (every $c in $idsUbl satisfies ($c = 'E') and exists(cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReasonCode[. = ('VATEX-FR-CGI261-1','VATEX-FR-CGI261-2','VATEX-FR-CGI261-3','VATEX-FR-CGI261-4','VATEX-FR-CGI261-5','VATEX-FR-CGI261-7','VATEX-FR-CGI261-8','VATEX-FR-CGI261A','VATEX-FR-CGI261B','VATEX-FR-CGI261C-1','VATEX-FR-CGI261C-2','VATEX-FR-CGI261C-3','VATEX-FR-CGI261D-1','VATEX-FR-CGI261D-1BIS','VATEX-FR-CGI261D-2','VATEX-FR-CGI261D-3','VATEX-FR-CGI261D-4','VATEX-FR-CGI261E-1','VATEX-FR-CGI261E-2')])) or (every $c in $idsUbl satisfies $c = ('O','E')) and (some $c1 in $idsUbl satisfies $c1 = 'O') and (some $c2 in $idsUbl satisfies $c2 = 'E'))">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[G2.32] Rejet si la facture comporte uniquement des codes TVA O, ou uniquement des codes TVA E avec un code d'exoneration CGI261, ou un melange de codes O et E. | Source : Annexe 7 v1.8 G2.32</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M36" select="*" />
...
<!--PATTERN F1-COMPLETE-UBL-G1.24-G2.31-->
	...
	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory" mode="M37" priority="1000">
...
<!--PATTERN F1-FULL-UBL-G6.09-LIGNES-OBLIGATOIRES-->
...
<xsl:template match="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" mode="M38" priority="1000">
    <svrl:fired-rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(self::ubl-invoice:Invoice and cac:InvoiceLine) or (self::ubl-creditnote:CreditNote and cac:CreditNoteLine)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(self::ubl-invoice:Invoice and cac:InvoiceLine) or (self::ubl-creditnote:CreditNote and cac:CreditNoteLine)">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN F1-FULL-UBL-G6.09-CONTENU-LIGNE-->


	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine" mode="M39" priority="1000">
    <svrl:fired-rule context="/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(self::cac:InvoiceLine and cbc:InvoicedQuantity) or (self::cac:CreditNoteLine and cbc:CreditedQuantity)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(self::cac:InvoiceLine and cbc:InvoicedQuantity) or (self::cac:CreditNoteLine and cbc:CreditedQuantity)">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[G6.09] BT-129 Quantite facturee/creditee obligatoire en profil FULL/CIBLE. | Source : Annexe 1 Flux 1 / Annexe 7 G6.09</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="cbc:InvoicedQuantity/@unitCode or cbc:CreditedQuantity/@unitCode" />
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:InvoicedQuantity/@unitCode or cbc:CreditedQuantity/@unitCode">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="cac:Price/cac:AllowanceCharge[cbc:ChargeIndicator = 'false']/cbc:BaseAmount" />
      <xsl:otherwise>
        <svrl:failed-assert test="cac:Price/cac:AllowanceCharge[cbc:ChargeIndicator = 'false']/cbc:BaseAmount">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[G6.09] BT-148 Prix brut unitaire obligatoire lorsque le detail prix est renseigne en profil FULL/CIBLE. | Source : Annexe 1 Flux 1 / Annexe 7 G6.09</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<!--PATTERN F1-CIBLE-UBL-G1.31-REFERENCES-ANTERIEURES-->


	<!--RULE -->
<xsl:template match="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" mode="M40" priority="1000">
    <svrl:fired-rule context="/ubl-invoice:Invoice | /ubl-creditnote:CreditNote" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID and (cac:InvoiceLine | cac:CreditNoteLine)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID)" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID and (cac:InvoiceLine | cac:CreditNoteLine)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID)">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN F1-CIBLE-UBL-BT26-DATE-FACTURE-ANTERIEURE-->


	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate | (/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate" mode="M41" priority="1000">
    <svrl:fired-rule context="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate | (/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(., '^\d{4}-\d{2}-\d{2}$')">
          ...
          <svrl:text>[G1.09] BT-26 Date de facture anterieure au format UBL AAAA-MM-JJ. | Source : Annexe 1 Flux 1 / Annexe 7 G1.09</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<!--PATTERN F1-CIBLE-UBL-G6.16-ADRESSE-LIVRAISON-->


	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:Delivery/cac:DeliveryLocation/cac:Address | (/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M42" priority="1000">
    <svrl:fired-rule context="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:Delivery/cac:DeliveryLocation/cac:Address | (/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:Delivery/cac:DeliveryLocation/cac:Address" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(cac:Country/cbc:IdentificationCode) or (matches(cac:Country/cbc:IdentificationCode, '^[A-Z]{2}$') and not(cac:Country/cbc:IdentificationCode = 'EL'))" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:Country/cbc:IdentificationCode) or (matches(cac:Country/cbc:IdentificationCode, '^[A-Z]{2}$') and not(cac:Country/cbc:IdentificationCode = 'EL'))">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(., '^\d{4}-\d{2}-\d{2}$')">
          ...
          <svrl:text>[G1.09] Les dates de ligne FULL/CIBLE doivent respecter le format UBL AAAA-MM-JJ. | Source : Annexe 7 v1.8 G1.09</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<!--PATTERN F1-CIBLE-UBL-G6.25-PERIODES-LIGNE-->


	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:InvoicePeriod[cbc:StartDate and cbc:EndDate]" mode="M44" priority="1000">
    <svrl:fired-rule context="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:InvoicePeriod[cbc:StartDate and cbc:EndDate]" />
...
<!--PATTERN F1-FULL-UBL-ALLOWANCE-CHARGE-DOCUMENT-->


	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AllowanceCharge" mode="M45" priority="1000">
    <svrl:fired-rule context="(/ubl-invoice:Invoice | /ubl-creditnote:CreditNote)/cac:AllowanceCharge" />
...
<xsl:choose>
      ...
      | Source : Annexe 1 Flux 1
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="cbc:ChargeIndicator = ('true', '1')             or normalize-space(cac:TaxCategory/cbc:Percent) != ''" />
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:ChargeIndicator = ('true', '1') or normalize-space(cac:TaxCategory/cbc:Percent) != ''">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      | Source : Annexe 7 v1.8 S1.17
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(cac:TaxCategory/cbc:ID)             or cac:TaxCategory/cbc:ID = ('S','E','AE','K','G','O','Z')" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:TaxCategory/cbc:ID) or cac:TaxCategory/cbc:ID = ('S','E','AE','K','G','O','Z')">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
      ...
      | Source : Annexe 7 v1.8 G2.31
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(cac:TaxCategory/cbc:Percent)             or number(cac:TaxCategory/cbc:Percent) =                (0, 0.9, 1.05, 1.75, 2.1, 5.5, 7, 8.5, 9.2, 9.6, 10, 13, 19.6, 20, 20.6)" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:TaxCategory/cbc:Percent) or number(cac:TaxCategory/cbc:Percent) = (0, 0.9, 1.05, 1.75, 2.1, 5.5, 7, 8.5, 9.2, 9.6, 10, 13, 19.6, 20, 20.6)">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN F1-FULL-UBL-ALLOWANCE-CHARGE-LIGNE-->


	<!--RULE -->
<xsl:template match="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:AllowanceCharge" mode="M46" priority="1000">
    <svrl:fired-rule context="(/ubl-invoice:Invoice/cac:InvoiceLine | /ubl-creditnote:CreditNote/cac:CreditNoteLine)/cac:AllowanceCharge" />
