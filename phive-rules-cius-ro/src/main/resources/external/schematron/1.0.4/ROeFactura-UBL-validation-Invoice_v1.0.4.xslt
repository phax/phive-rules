...
<xsl:variable name="RO-MAJOR-MINOR-PATCH-VERSION" select="'1.0.0'" />
  ...
  <xsl:variable name="SECTOR-RO-CODES" select="('SECTOR1', 'SECTOR2', 'SECTOR3', 'SECTOR4', 'SECTOR5', 'SECTOR6')" />
	...
	<!--RULE -->
<xsl:template match="cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode" mode="M10" priority="1018">
    <svrl:fired-rule context="cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(self::cbc:InvoiceTypeCode and ((not(contains(normalize-space(.), ' ')) and contains(' 380 384 389 751 ', concat(' ', normalize-space(.), ' '))))) or (self::cbc:CreditNoteTypeCode and ((not(contains(normalize-space(.), ' ')) and contains(' 381 ', concat(' ', normalize-space(.), ' ')))))" />
      <xsl:otherwise>
        <svrl:failed-assert test="(self::cbc:InvoiceTypeCode and ((not(contains(normalize-space(.), ' ')) and contains(' 380 384 389 751 ', concat(' ', normalize-space(.), ' '))))) or (self::cbc:CreditNoteTypeCode and ((not(contains(normalize-space(.), ' ')) and contains(' 381 ', concat(' ', normalize-space(.), ' ')))))">
...
<xsl:if test="normalize-space(upper-case(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
      <svrl:successful-report test="normalize-space(upper-case(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
        ...
        <svrl:text>[BR-RO-110]-Daca Codul ţării vânzătorului (BT-40) este "RO", atunci Subdiviziunea ţării vânzătorului (BT-39) trebuie să fie codificată folosind lista de coduri ISO 3166-2:RO (ex. "RO-B" pentru Municipiul Bucuresti, "RO-AB" pentru judetul Alba...).
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress | /ubl:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress" mode="M10" priority="1016">
...
<xsl:if test="normalize-space(upper-case(cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
      <svrl:successful-report test="normalize-space(upper-case(cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
        ...
        <svrl:text>[BR-RO-170]-Daca Codul ţării Reprezentantului fiscal al vânzătorului (BT-69) este "RO", atunci Subdiviziunea ţării Reprezentantului fiscal al vânzătorului (BT-68) trebuie să fie codificată folosind lista de coduri ISO 3166-2:RO (ex. "RO-B" pentru Municipiul Bucuresti, "RO-AB" pentru judetul Alba...).
	...
	<!--RULE -->
<xsl:template match="//cac:PaymentMeans" mode="M10" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address | /ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M10" priority="1014">
...
<xsl:if test="normalize-space(upper-case(cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
      <svrl:successful-report test="normalize-space(upper-case(cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
        ...
        <svrl:text>[BR-RO-210]-Daca Codul ţării de livrare (BT-80) este "RO", atunci Subdiviziunea ţării de livrare (BT-79) trebuie să fie codificată folosind lista de coduri ISO 3166-2:RO (ex. "RO-B" pentru Municipiul Bucuresti, "RO-AB" pentru judetul Alba...).
	...
	<!--RULE -->
<xsl:template match="cac:InvoicePeriod/cbc:DescriptionCode" mode="M10" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine | cac:CreditNoteLine" mode="M10" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:Item/cac:AdditionalItemProperty" mode="M10" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = false()] | /ubl:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator = false()]" mode="M10" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = true()] | /ubl:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator = true()]" mode="M10" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal" mode="M10" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice | cac:CreditNote" mode="M10" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal" mode="M10" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine | cac:CreditNoteLine" mode="M10" priority="1005">
    <svrl:fired-rule context="cac:InvoiceLine | cac:CreditNoteLine" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator = false()] | //cac:CreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator = false()]" mode="M10" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator = true()] | //cac:CreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator = true()]" mode="M10" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:Note" mode="M10" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:AdditionalDocumentReference" mode="M10" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:BillingReference" mode="M10" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="string-length(normalize-space(cac:InvoiceDocumentReference/cbc:ID)) &lt;= 30" />
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(cac:InvoiceDocumentReference/cbc:ID)) &lt;= 30">
