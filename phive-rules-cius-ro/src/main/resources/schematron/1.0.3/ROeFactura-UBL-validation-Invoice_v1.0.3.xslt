...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.0.3 - CIUS-RO version 1.0.0 compatible - UBL - Invoice">
      <xsl:attribute name="phase">roefactura-model</xsl:attribute>
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.0.3 - CIUS-RO version 1.0.0 compatible - UBL - Invoice</svrl:text>
  <xsl:param name="RO-MAJOR-MINOR-PATCH-VERSION" select="'1.0.0'" />
  <xsl:param name="RO-CIUS-ID" select="concat('urn:cen.eu:en16931:2017#compliant#urn:efactura.mfinante.ro:CIUS-RO:', $RO-MAJOR-MINOR-PATCH-VERSION)" />
  <xsl:param name="RO-EMAIL-REGEX" select="'^[0-9a-zA-Z]([0-9a-zA-Z\.]*)[^\.\s@]@[^\.\s@]([0-9a-zA-Z\.]*)[0-9a-zA-Z]$'" />
  <xsl:param name="RO-TELEPHONE-REGEX" select="'.*([0-9].*){3,}.*'" />
  <xsl:param name="ISO-3166-RO-CODES" select="('RO-AB','RO-AG','RO-AR','RO-B','RO-BC','RO-BH','RO-BN','RO-BR','RO-BT','RO-BV','RO-BZ','RO-CJ','RO-CL','RO-CS','RO-CT', 'RO-CV', 'RO-DB', 'RO-DJ', 'RO-GJ', 'RO-GL', 'RO-GR', 'RO-HD', 'RO-HR' , 'RO-IF', 'RO-IL', 'RO-IS', 'RO-MH', 'RO-MM', 'RO-MS', 'RO-NT', 'RO-OT', 'RO-PH', 'RO-SB', 'RO-SJ', 'RO-SM', 'RO-SV', 'RO-TL', 'RO-TM', 'RO-TR', 'RO-VL', 'RO-VN', 'RO-VS')" />
  <xsl:param name="SECTOR-RO-CODES" select="('SECTOR1', 'SECTOR2', 'SECTOR3', 'SECTOR4', 'SECTOR5', 'SECTOR6')" />

<!--PATTERN ubl-pattern-->


	<!--RULE -->
<xsl:template match="/ubl:Invoice" mode="M13" priority="1014">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="string-length(normalize-space(cac:AdditionalDocumentReference/cbc:ID)) &lt;= 30" />
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(cac:AdditionalDocumentReference/cbc:ID)) &lt;= 30">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="string-length(normalize-space(cac:AdditionalDocumentReference/cbc:DocumentDescription)) &lt;= 100" />
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(cac:AdditionalDocumentReference/cbc:DocumentDescription)) &lt;= 100">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName)) &lt;= 150">
          ...
          <svrl:text>[BR-RO-L150]-Numărul maxim permis de caractere pentru Adresa de livrare - Linia 1 este 150.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="string-length(normalize-space(cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI)) &lt;= 200" />
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI)) &lt;= 200">
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="string-length(normalize-space(cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject/@filename)) &lt;= 200" />
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject/@filename)) &lt;= 200">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PaymentMeans" mode="M13" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress" mode="M13" priority="1012">
...
<xsl:if test="normalize-space(upper-case(cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M13" priority="1011">
...
<xsl:if test="normalize-space(upper-case(cac:Country/cbc:IdentificationCode)) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)">
	...
	<!--RULE -->
<xsl:template match="cac:InvoicePeriod/cbc:DescriptionCode" mode="M13" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine" mode="M13" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = false()]" mode="M13" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = true()]" mode="M13" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice" mode="M13" priority="1005">
    <svrl:fired-rule context="/ubl:Invoice" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal" mode="M13" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine" mode="M13" priority="1003">
    <svrl:fired-rule context="cac:InvoiceLine" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator = false()]" mode="M13" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator = true()]" mode="M13" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:Note" mode="M13" priority="1000">
