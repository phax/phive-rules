...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<!-- Tekstit alkavat -->
	<xsl:variable name="txtOtsikko">Finvoice message reception notification</xsl:variable>
	<xsl:variable name="txtMessageDate">Date</xsl:variable>
	<xsl:variable name="txtTimeStamp">Timestamp</xsl:variable>
	<xsl:variable name="txtMessageTypeCode">Message Type Code</xsl:variable>
	<xsl:variable name="txtMessageTypeText">Message Type</xsl:variable>
	<xsl:variable name="txtActionCode">Action</xsl:variable>
	<xsl:variable name="txtADD">Add</xsl:variable>
	<xsl:variable name="txtCHANGE">Change</xsl:variable>
	<xsl:variable name="txtDELETE">Delete</xsl:variable>
	<xsl:variable name="txtSenderInfoIdentifier">Sender info identifier</xsl:variable>
	<xsl:variable name="txtInvoiceSender">Invoice sender</xsl:variable>
	<xsl:variable name="txtInvoiceSenderAddress">Sender address</xsl:variable>
	<xsl:variable name="txtInvoiceSenderIntermediatorAddress">Sender intermediator address</xsl:variable>
	<xsl:variable name="txtSellerPartyIdentifier">Sender party identifier</xsl:variable>
	<xsl:variable name="txtSellerOrganisationName">Sender organisation name</xsl:variable>
	<xsl:variable name="txtSellerOrganisationBankName">Sender organisation name in bank</xsl:variable>
	<xsl:variable name="txtKatuosoite">Street address</xsl:variable>
	<xsl:variable name="txtPostiosoite">Mailing address</xsl:variable>
	<xsl:variable name="txtPostilokero">P.O. Box</xsl:variable>
	<xsl:variable name="txtMaa">Country</xsl:variable>
	<xsl:variable name="txtOrganisationUnitNumber">Organisation unit</xsl:variable>
	<xsl:variable name="txtWebaddressNameText">Website description</xsl:variable>
	<xsl:variable name="txtWebaddressText">Website address</xsl:variable>
	<xsl:variable name="txtInvoiceDetails">Invoice details</xsl:variable>
	<xsl:variable name="txtPaymentInstructionIdentifier">Payment instruction identifier</xsl:variable>
	<xsl:variable name="txtSellerInstructionFreeText">Sender instruction</xsl:variable>
	<xsl:variable name="txtSellerInvoiceTypeText">Invoice reason</xsl:variable>
	<xsl:variable name="txtSellerInvoiceIdentifierText">Invoice identifier</xsl:variable>
	<xsl:variable name="txtProposedDueDate">Proposed due date</xsl:variable>
	<xsl:variable name="txtProposedInvoicePeriod">Proposed invoice period</xsl:variable>
	<xsl:variable name="txtProposedInvoicePeriodInfo">(times per year)</xsl:variable>
	<xsl:variable name="txtSellerDirectDebitIdentifier">Direct debit identifier</xsl:variable>
	<xsl:variable name="txtSellerDirectPaymentIdentifier">Direct payment identifier</xsl:variable>
	<xsl:variable name="txtSellerAccountDetails">Sender account details</xsl:variable>
	<xsl:variable name="txtTilinumeroJaBIC">Account number and BIC code</xsl:variable>
	<xsl:variable name="txtTilinumero">Account number</xsl:variable>
	<xsl:variable name="txtBuyerPartyDetails">Recipient party details</xsl:variable>
	<xsl:variable name="txtBuyerPartyIdentifier">Recipient party identifier</xsl:variable>
	<xsl:variable name="txtBuyerOrganisationName">Recipient organisation name</xsl:variable>
	<xsl:variable name="txtInvoiceRecipientDetails">Invoice recipient details</xsl:variable>
	<xsl:variable name="txtInvoiceRecipientAddress">Invoice recipient address</xsl:variable>
	<xsl:variable name="txtInvoiceRecipientIntermediatorAddress">Invoice recipient intermediator address</xsl:variable>
	<xsl:variable name="txtSellerInvoiceIdentifier">Sender invoice identifier</xsl:variable>
	<xsl:variable name="txtEpiRemittanceIdentifier">Payment reference number</xsl:variable>
	<xsl:variable name="txtViestinTiedot">Message details</xsl:variable>
	<xsl:variable name="txtIdConversion">conversion</xsl:variable>
	<xsl:variable name="txtIdMaintenance">maintenance</xsl:variable>
	<xsl:variable name="txtLanguage">Language</xsl:variable>
	<xsl:variable name="txtSuomi">Finnish</xsl:variable>
	<xsl:variable name="txtRuotsi">Swedish</xsl:variable>
	<xsl:variable name="txtEnglanti">English</xsl:variable>
	<xsl:variable name="txtBuyerServiceCode">Service</xsl:variable>
	<xsl:variable name="txtELasku">E-invoice</xsl:variable>
	<xsl:variable name="txtSuoramaksu">Autogiro payment</xsl:variable>
	<!-- Tekstit loppuivat -->
	<xsl:template match="/">
		<html>
			<head>
