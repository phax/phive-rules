...
public final class UBLValidation
{
  ...
  public static final VESID VID_UBL_20_CATALOGUEITEMSPECIFICATIONUPDATE = new VESID (GROUP_ID,
                                                                                     ...
                                                                                     VERSION_20);
  public static final VESID VID_UBL_20_CATALOGUEPRICINGUPDATE = new VESID (GROUP_ID, "cataloguepricingupdate", VERSION_20);
  ...
  public static final VESID VID_UBL_20_FORWARDINGINSTRUCTIONS = new VESID (GROUP_ID, "forwardinginstructions", VERSION_20);
  ...
  public static final VESID VID_UBL_21_CATALOGUEITEMSPECIFICATIONUPDATE = new VESID (GROUP_ID,
                                                                                     "catalogueitemspecificationupdate",
                                                                                     VERSION_21);
  public static final VESID VID_UBL_21_CATALOGUEPRICINGUPDATE = new VESID (GROUP_ID, "cataloguepricingupdate", VERSION_21);
  ...
  public static final VESID VID_UBL_21_DOCUMENTSTATUSREQUEST = new VESID (GROUP_ID, "documentstatusrequest", VERSION_21);
  public static final VESID VID_UBL_21_EXCEPTIONCRITERIA = new VESID (GROUP_ID, "exceptioncriteria", VERSION_21);
  public static final VESID VID_UBL_21_EXCEPTIONNOTIFICATION = new VESID (GROUP_ID, "exceptionnotification", VERSION_21);
  ...
  public static final VESID VID_UBL_21_FORWARDINGINSTRUCTIONS = new VESID (GROUP_ID, "forwardinginstructions", VERSION_21);
  public static final VESID VID_UBL_21_FREIGHTINVOICE = new VESID (GROUP_ID, "freightinvoice", VERSION_21);
  public static final VESID VID_UBL_21_FULFILMENTCANCELLATION = new VESID (GROUP_ID, "fulfilmentcancellation", VERSION_21);
  ...
  public static final VESID VID_UBL_21_INSTRUCTIONFORRETURNS = new VESID (GROUP_ID, "instructionforreturns", VERSION_21);
  ...
  public static final VESID VID_UBL_21_ITEMINFORMATIONREQUEST = new VESID (GROUP_ID, "iteminformationrequest", VERSION_21);
  ...
  public static final VESID VID_UBL_21_PRIORINFORMATIONNOTICE = new VESID (GROUP_ID, "priorinformationnotice", VERSION_21);
  ...
  public static final VESID VID_UBL_21_STOCKAVAILABILITYREPORT = new VESID (GROUP_ID, "stockavailabilityreport", VERSION_21);
  public static final VESID VID_UBL_21_TENDER = new VESID (GROUP_ID, "tender", VERSION_21);
  public static final VESID VID_UBL_21_TENDERERQUALIFICATION = new VESID (GROUP_ID, "tendererqualification", VERSION_21);
  public static final VESID VID_UBL_21_TENDERERQUALIFICATIONRESPONSE = new VESID (GROUP_ID, "tendererqualificationresponse", VERSION_21);
  public static final VESID VID_UBL_21_TENDERRECEIPT = new VESID (GROUP_ID, "tenderreceipt", VERSION_21);
  public static final VESID VID_UBL_21_TRADEITEMLOCATIONPROFILE = new VESID (GROUP_ID, "tradeitemlocationprofile", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTATIONSTATUS = new VESID (GROUP_ID, "transportationstatus", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTATIONSTATUSREQUEST = new VESID (GROUP_ID, "transportationstatusrequest", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTEXECUTIONPLAN = new VESID (GROUP_ID, "transportexecutionplan", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTEXECUTIONPLANREQUEST = new VESID (GROUP_ID, "transportexecutionplanrequest", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTPROGRESSSTATUS = new VESID (GROUP_ID, "transportprogressstatus", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTPROGRESSSTATUSREQUEST = new VESID (GROUP_ID, "transportprogressstatusrequest", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTSERVICEDESCRIPTION = new VESID (GROUP_ID, "transportservicedescription", VERSION_21);
  public static final VESID VID_UBL_21_TRANSPORTSERVICEDESCRIPTIONREQUEST = new VESID (GROUP_ID,
                                                                                       ...
                                                                                       VERSION_21);
  public static final VESID VID_UBL_21_UNAWARDEDNOTIFICATION = new VESID (GROUP_ID, "unawardednotification", VERSION_21);
  ...
  public static final VESID VID_UBL_22_CATALOGUEITEMSPECIFICATIONUPDATE = new VESID (GROUP_ID,
                                                                                     "catalogueitemspecificationupdate",
                                                                                     VERSION_22);
  public static final VESID VID_UBL_22_CATALOGUEPRICINGUPDATE = new VESID (GROUP_ID, "cataloguepricingupdate", VERSION_22);
  ...
  public static final VESID VID_UBL_22_DOCUMENTSTATUSREQUEST = new VESID (GROUP_ID, "documentstatusrequest", VERSION_22);
  ...
  public static final VESID VID_UBL_22_EXCEPTIONNOTIFICATION = new VESID (GROUP_ID, "exceptionnotification", VERSION_22);
  public static final VESID VID_UBL_22_EXPRESSIONOFINTERESTREQUEST = new VESID (GROUP_ID, "expressionofinterestrequest", VERSION_22);
  public static final VESID VID_UBL_22_EXPRESSIONOFINTERESTRESPONSE = new VESID (GROUP_ID, "expressionofinterestresponse", VERSION_22);
  ...
  public static final VESID VID_UBL_22_FORWARDINGINSTRUCTIONS = new VESID (GROUP_ID, "forwardinginstructions", VERSION_22);
  public static final VESID VID_UBL_22_FREIGHTINVOICE = new VESID (GROUP_ID, "freightinvoice", VERSION_22);
  public static final VESID VID_UBL_22_FULFILMENTCANCELLATION = new VESID (GROUP_ID, "fulfilmentcancellation", VERSION_22);
  ...
  public static final VESID VID_UBL_22_INSTRUCTIONFORRETURNS = new VESID (GROUP_ID, "instructionforreturns", VERSION_22);
  ...
  public static final VESID VID_UBL_22_ITEMINFORMATIONREQUEST = new VESID (GROUP_ID, "iteminformationrequest", VERSION_22);
  ...
  public static final VESID VID_UBL_22_PRIORINFORMATIONNOTICE = new VESID (GROUP_ID, "priorinformationnotice", VERSION_22);
  ...
  public static final VESID VID_UBL_22_STOCKAVAILABILITYREPORT = new VESID (GROUP_ID, "stockavailabilityreport", VERSION_22);
  ...
  public static final VESID VID_UBL_22_TENDERERQUALIFICATION = new VESID (GROUP_ID, "tendererqualification", VERSION_22);
  public static final VESID VID_UBL_22_TENDERERQUALIFICATIONRESPONSE = new VESID (GROUP_ID, "tendererqualificationresponse", VERSION_22);
  ...
  public static final VESID VID_UBL_22_TRADEITEMLOCATIONPROFILE = new VESID (GROUP_ID, "tradeitemlocationprofile", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTATIONSTATUS = new VESID (GROUP_ID, "transportationstatus", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTATIONSTATUSREQUEST = new VESID (GROUP_ID, "transportationstatusrequest", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTEXECUTIONPLAN = new VESID (GROUP_ID, "transportexecutionplan", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTEXECUTIONPLANREQUEST = new VESID (GROUP_ID, "transportexecutionplanrequest", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTPROGRESSSTATUS = new VESID (GROUP_ID, "transportprogressstatus", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTPROGRESSSTATUSREQUEST = new VESID (GROUP_ID, "transportprogressstatusrequest", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTSERVICEDESCRIPTION = new VESID (GROUP_ID, "transportservicedescription", VERSION_22);
  public static final VESID VID_UBL_22_TRANSPORTSERVICEDESCRIPTIONREQUEST = new VESID (GROUP_ID,
                                                                                       "transportservicedescriptionrequest",
                                                                                       VERSION_22);
  public static final VESID VID_UBL_22_UNAWARDEDNOTIFICATION = new VESID (GROUP_ID, "unawardednotification", VERSION_22);
  ...
  public static final VESID VID_UBL_23_DOCUMENTSTATUSREQUEST = new VESID (GROUP_ID, "documentstatusrequest", VERSION_23);
  ...
  public static final VESID VID_UBL_23_EXCEPTIONNOTIFICATION = new VESID (GROUP_ID, "exceptionnotification", VERSION_23);
  public static final VESID VID_UBL_23_EXPORTCUSTOMSDECLARATION = new VESID (GROUP_ID, "exportcustomsdeclaration", VERSION_23);
  public static final VESID VID_UBL_23_EXPRESSIONOFINTERESTREQUEST = new VESID (GROUP_ID, "expressionofinterestrequest", VERSION_23);
  public static final VESID VID_UBL_23_EXPRESSIONOFINTERESTRESPONSE = new VESID (GROUP_ID, "expressionofinterestresponse", VERSION_23);
  ...
  public static final VESID VID_UBL_23_FORWARDINGINSTRUCTIONS = new VESID (GROUP_ID, "forwardinginstructions", VERSION_23);
  public static final VESID VID_UBL_23_FREIGHTINVOICE = new VESID (GROUP_ID, "freightinvoice", VERSION_23);
  public static final VESID VID_UBL_23_FULFILMENTCANCELLATION = new VESID (GROUP_ID, "fulfilmentcancellation", VERSION_23);
  ...
  public static final VESID VID_UBL_23_STOCKAVAILABILITYREPORT = new VESID (GROUP_ID, "stockavailabilityreport", VERSION_23);
  ...
  public static final VESID VID_UBL_23_TENDERERQUALIFICATION = new VESID (GROUP_ID, "tendererqualification", VERSION_23);
  public static final VESID VID_UBL_23_TENDERERQUALIFICATIONRESPONSE = new VESID (GROUP_ID, "tendererqualificationresponse", VERSION_23);
  ...
  public static final VESID VID_UBL_23_TRANSPORTEXECUTIONPLANREQUEST = new VESID (GROUP_ID, "transportexecutionplanrequest", VERSION_23);
  public static final VESID VID_UBL_23_TRANSPORTPROGRESSSTATUS = new VESID (GROUP_ID, "transportprogressstatus", VERSION_23);
  public static final VESID VID_UBL_23_TRANSPORTPROGRESSSTATUSREQUEST = new VESID (GROUP_ID, "transportprogressstatusrequest", VERSION_23);
  public static final VESID VID_UBL_23_TRANSPORTSERVICEDESCRIPTION = new VESID (GROUP_ID, "transportservicedescription", VERSION_23);
  public static final VESID VID_UBL_23_TRANSPORTSERVICEDESCRIPTIONREQUEST = new VESID (GROUP_ID,
                                                                                       "transportservicedescriptionrequest",
                                                                                       VERSION_23);
  public static final VESID VID_UBL_23_UNAWARDEDNOTIFICATION = new VESID (GROUP_ID, "unawardednotification", VERSION_23);
