 ...
 */
package com.helger.phive.serbia.mock;
...
public final class CTestFiles
{
  ...
  public static ICommonsList <? extends IReadableResource> getAllMatchingTestFiles (@NonNull final DVRCoordinate aVESID)
  {
    ...
    // 1.0.0
    if (aVESID.equals (SRBDTValidation.VID_SRBDT_UBL_CREDITNOTE_100))
    {
      // No test files
      return new CommonsArrayList <> (new String [] {}, x -> new ClassPathResource (sPrefix + "1.0.0/" + x));
    }
    if (aVESID.equals (SRBDTValidation.VID_SRBDT_UBL_INVOICE_100))
    {
      return new CommonsArrayList <> (new String [] { "faktura.xml",
                                                      "faktura-avansna.xml",
                                                      "faktura-jn.xml",
                                                      "faktura-kat-e.xml" },
