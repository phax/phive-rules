...
/**
 * SPI implementation that registers the Turkey eFatura validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class TurkeyEFaturaValidationSPI implements IValidationRulesRegistrarSPI
{
  @NonNull
