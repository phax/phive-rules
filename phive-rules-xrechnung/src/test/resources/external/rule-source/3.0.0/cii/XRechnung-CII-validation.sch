   ...
   <pattern id="peppol-cii-pattern-1">
      ...
      <rule context="ram:ApplicableHeaderTradeSettlement">
         ...
         <assert id="PEPPOL-EN16931-R053"
                 ...
                 flag="warning">Only one tax total amount must be provided where currency id equals document currency code.</assert>
         ...
         <assert id="PEPPOL-EN16931-R055"
                 ...
                 flag="warning">Invoice total VAT amount and Invoice total VAT amount in accounting currency MUST have the same operational sign</assert>
      </rule>
      ...
      <rule context="ram:SpecifiedTradeAllowanceCharge">
         <assert id="PEPPOL-EN16931-R040"
                 ...
                 flag="warning">Allowance/charge amount must equal base amount * percentage/100 if base amount and percentage exists</assert>
      ...
      <rule context="/rsm:CrossIndustryInvoice">
        ...
        <!-- Only if BG-19 exists, rules BR-DE-30 and BR-DE-31 should fail on missing elements BT-90 or BT-91.
         ...
         <assert test="rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradePaymentTerms[count(ram:Description) &lt; 2]"
                 flag="fatal"
                 id="BR-DE-18-a">[BR-DE-18-a] BT-20 darf nicht mehrfach vorhanden sein.</assert>
