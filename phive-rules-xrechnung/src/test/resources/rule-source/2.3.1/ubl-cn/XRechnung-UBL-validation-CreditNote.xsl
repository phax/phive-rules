...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Version 1.8.1 - XRechnung 2.3.1 compatible - UBL - CreditNote"
                              schemaVersion="">
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Version 1.8.1 - XRechnung 2.3.1 compatible - UBL - CreditNote</svrl:text>
