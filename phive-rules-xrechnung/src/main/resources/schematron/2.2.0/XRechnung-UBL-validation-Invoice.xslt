...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.7.1 - XRechnung 2.2.0 compatible - UBL - Invoice">
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.7.1 - XRechnung 2.2.0 compatible - UBL - Invoice</svrl:text>
