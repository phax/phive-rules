...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.7.0 - XRechnung 2.2.0 compatible - UBL - Invoice">
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.7.0 - XRechnung 2.2.0 compatible - UBL - Invoice</svrl:text>
...
<xsl:variable name="isExtension" select="exists(/ubl:Invoice/cbc:CustomizationID[text() = concat( 'urn:cen.eu:en16931:2017#compliant#urn:xoev-de:kosit:standard:xrechnung_', $XR-MAJOR-MINOR-VERSION ,'#conformant#urn:xoev-de:kosit:extension:xrechnung_', $XR-MAJOR-MINOR-VERSION) ] )" />
	...
	<!--RULE -->
<xsl:template match="cbc:EmbeddedDocumentBinaryObject[$isExtension]" mode="M9" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice[$isExtension]" mode="M9" priority="1005">
