...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.7.0 - XRechnung 2.2.0 compatible - UBL - CreditNote">
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.7.0 - XRechnung 2.2.0 compatible - UBL - CreditNote</svrl:text>
...
<xsl:variable name="XR-MAJOR-MINOR-VERSION" select="'2.2'" />
  ...
  <xsl:variable name="XR-EMAIL-REGEX" select="'^[0-9a-zA-Z]([0-9a-zA-Z\.]*)[^\.\s@]@[^\.\s@]([0-9a-zA-Z\.]*)[0-9a-zA-Z]$'" />
