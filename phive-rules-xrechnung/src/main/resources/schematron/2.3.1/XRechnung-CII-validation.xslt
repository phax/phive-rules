...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.8.1 - XRechnung 2.3.1 compatible - CII">
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.8.1 - XRechnung 2.3.1 compatible - CII</svrl:text>
