...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.5.0 - XRechnung 2.0.1 compatible - UBL - CreditNote">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.5.0 - XRechnung 2.0.1 compatible - UBL - CreditNote</svrl:text>
...
<!--PATTERN UBL-model-->
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote" mode="M8" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingSupplierParty" mode="M8" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M8" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact" mode="M8" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M8" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M8" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:PaymentMeans" mode="M8" priority="1001">
