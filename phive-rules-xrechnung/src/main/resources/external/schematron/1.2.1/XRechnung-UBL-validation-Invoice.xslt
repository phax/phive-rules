...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="XRechnung 1.1 - Schematron - UBL - Invoice">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>XRechnung 1.1 - Schematron - UBL - Invoice</svrl:text>

<!--PATTERN UBL-model-->


	<!--RULE -->
<xsl:template match="//ubl:Invoice" mode="M8" priority="1006">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="cbc:InvoiceTypeCode = ('326', '380', '384', '389', '381')" />
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:InvoiceTypeCode = ('326', '380', '384', '389', '381')">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:Invoice/cac:AccountingSupplierParty" mode="M8" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M8" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact" mode="M8" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M8" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M8" priority="1001">
