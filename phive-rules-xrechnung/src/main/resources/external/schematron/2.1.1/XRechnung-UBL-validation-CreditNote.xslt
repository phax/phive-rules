...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.6.0 - XRechnung 2.1.1 compatible - UBL - CreditNote">
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.6.0 - XRechnung 2.1.1 compatible - UBL - CreditNote</svrl:text>
