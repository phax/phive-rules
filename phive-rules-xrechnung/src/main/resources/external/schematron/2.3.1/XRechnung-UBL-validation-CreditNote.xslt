...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.8.1 - XRechnung 2.3.1 compatible - UBL - CreditNote">
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.8.1 - XRechnung 2.3.1 compatible - UBL - CreditNote</svrl:text>
...
<!--PATTERN ubl-pattern-->
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote" mode="M8" priority="1009">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not((cac:AllowanceCharge/cac:TaxCategory/cbc:ID[ancestor::cac:AllowanceCharge/cbc:ChargeIndicator = 'false'] = ('S', 'Z', 'E', 'AE', 'K', 'G', 'L', 'M')) or (cac:AllowanceCharge/cac:TaxCategory/cbc:ID[ancestor::cac:AllowanceCharge/cbc:ChargeIndicator = 'true'] = ('S', 'Z', 'E', 'AE', 'K', 'G', 'L', 'M')) or (cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[following-sibling::cac:TaxScheme/cbc:ID = 'VAT'] = ('S', 'Z', 'E', 'AE', 'K', 'G', 'L', 'M'))) or (cac:TaxRepresentativeParty, cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID[boolean(normalize-space(.))])">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:CreditNoteTypeCode = ('326', '380', '384', '389', '381', '875', '876', '877')">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:CreditNoteTypeCode = 384) or (cac:BillingReference/cac:InvoiceDocumentReference)">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty" mode="M8" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M8" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact" mode="M8" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M8" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M8" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans[cbc:PaymentMeansCode = (30,58)]" mode="M8" priority="1003">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentMeans[cbc:PaymentMeansCode = (30,58)]" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans[cbc:PaymentMeansCode = (48,54,55)]" mode="M8" priority="1002">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentMeans[cbc:PaymentMeansCode = (48,54,55)]" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans[cbc:PaymentMeansCode = 59]" mode="M8" priority="1001">
    <svrl:fired-rule context="/ubl:CreditNote/cac:PaymentMeans[cbc:PaymentMeansCode = 59]" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal" mode="M8" priority="1000">
...
<xsl:variable name="isExtension" select="exists(/ubl:CreditNote/cbc:CustomizationID[text() = concat( 'urn:cen.eu:en16931:2017#compliant#urn:xoev-de:kosit:standard:xrechnung_', $XR-MAJOR-MINOR-VERSION ,'#conformant#urn:xoev-de:kosit:extension:xrechnung_', $XR-MAJOR-MINOR-VERSION) ] )" />

	<!--RULE -->
<xsl:template match="cac:PartyIdentification/cbc:ID[@schemeID and $isExtension]" mode="M9" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PartyLegalEntity/cbc:CompanyID[@schemeID and $isExtension]" mode="M9" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:StandardItemIdentification/cbc:ID[@schemeID and $isExtension]" mode="M9" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:EndpointID[@schemeID and $isExtension]" mode="M9" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:DeliveryLocation/cbc:ID[@schemeID and $isExtension]" mode="M9" priority="1000">
