...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.3.0 - XRechnung 1.2.2 compatible - UBL - CreditNote">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.3.0 - XRechnung 1.2.2 compatible - UBL - CreditNote</svrl:text>

<!--PATTERN UBL-model-->


	<!--RULE -->
<xsl:template match="//ubl:CreditNote" mode="M7" priority="1007">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:CustomizationID = 'urn:cen.eu:en16931:2017#compliant#urn:xoev-de:kosit:standard:xrechnung_1.2'">
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingSupplierParty" mode="M7" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M7" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact" mode="M7" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M7" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address" mode="M7" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:PaymentMeans" mode="M7" priority="1001">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:PaymentMeansCode = '58') or matches(cac:PayeeFinancialAccount/cbc:ID, '^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{0,30}$') and xs:integer( replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace( upper-case(concat(substring(cac:PayeeFinancialAccount/cbc:ID,5),substring(cac:PayeeFinancialAccount/cbc:ID,1,4))) ,'A','10'),'B','11'),'C','12'),'D','13'),'E','14'),'F','15'),'G','16'),'H','17'),'I','18'),'J','19'),'K','20'),'L','21'),'M','22') ,'N','23'),'O','24'),'P','25'),'Q','26'),'R','27'),'S','28'),'T','29'),'U','30'),'V','31'),'W','32'),'X','33'),'Y','34'),'Z','35') ) mod 97 = 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:PaymentMeansCode = '59') or matches(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID, '^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{0,30}$') and xs:integer( replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace( upper-case(concat(substring(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID,5),substring(cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID,1,4))) ,'A','10'),'B','11'),'C','12'),'D','13'),'E','14'),'F','15'),'G','16'),'H','17'),'I','18'),'J','19'),'K','20'),'L','21'),'M','22') ,'N','23'),'O','24'),'P','25'),'Q','26'),'R','27'),'S','28'),'T','29'),'U','30'),'V','31'),'W','32'),'X','33'),'Y','34'),'Z','35') ) mod 97 = 1">
	...
	<!--RULE -->
<xsl:template match="//ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal" mode="M7" priority="1000">
