...
/**
 * SPI implementation that registers the XRechnung validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class XRechnungValidationSPI implements IValidationRulesRegistrarSPI
{
  @NonNull
  public ESuccess registerValidationRules (@NonNull final IValidationExecutorSetRegistry <IValidationSourceXML> aRegistry)
  {
    // XRechnung is a CIUS of EN 16931 - ensure the EN 16931 rules are registered first
    try
    {
