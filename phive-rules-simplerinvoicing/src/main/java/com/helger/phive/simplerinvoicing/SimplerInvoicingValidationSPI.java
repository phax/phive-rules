...
/**
 * SPI implementation that registers the SimplerInvoicing validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class SimplerInvoicingValidationSPI implements IValidationRulesRegistrarSPI
{
