...
<!--
     ...
     The rules include SI-UBL version 2.0.3.9, as well as a modified version of the CenPC-434, to allow for multiple
...
<schema xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
    ...
    <title>SI-UBL G-Account extension validation, version 1.0.9</title>
