...
/**
 * SPI implementation that registers the Singapore IRAS validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class SingaporeIRASValidationSPI implements IValidationRulesRegistrarSPI
{
