...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="starts-with($customizationID, 'urn:peppol:pint:billing-1@om-1')">
...
<svrl:text>
		...
		<!--ASSERT fatal-->
<xsl:choose>
      <xsl:when test="starts-with($profileID, 'urn:peppol:bis:billing')" />
      <xsl:otherwise>
        <svrl:failed-assert test="starts-with($profileID, 'urn:peppol:bis:billing')">
...
<svrl:text>
          ...
          <svrl:text>[ALIGNED-IBRP-002-OM] - Business process (IBT-023) must follow the expected format 'urn:peppol:bis:billing'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
