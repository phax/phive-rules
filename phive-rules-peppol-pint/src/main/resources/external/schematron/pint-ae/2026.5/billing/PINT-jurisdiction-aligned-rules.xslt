...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M12" priority="1036">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cbc:StreetName) and (cbc:CityName) and (cbc:CountrySubentity)">
          ...
          <svrl:text>[ibr-143-ae]-In Seller postal address (IBG-05), Seller address line 1 (IBT-035),  Seller city (IBT-037) and Seller country subdivision (IBT-039) must be provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M12" select="@*|*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches((ancestor::*[local-name()='Invoice' or local-name()='CreditNote'][1]/cbc:ProfileExecutionID)[1], '^[01]{5}1[01]{2}$')) or exists(cac:PartyTaxScheme/cbc:CompanyID)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(count(cac:PartyTaxScheme) = 2 and count(cac:PartyTaxScheme[cac:TaxScheme/cbc:ID = &quot;VAT&quot;]) = 1) or count(cac:PartyTaxScheme) &lt; 2">
          ...
          <svrl:text>[ibr-178-ae]-Tax scheme code, if provided in (IBT-031-1) shall not be 'VAT' when Seller tax registration identifier (IBT-032) is provided</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:EndpointID/@schemeID = &quot;0235&quot; and not(cac:PartyLegalEntity/cbc:CompanyID))">
...
<xsl:template match="cac:Price/cac:AllowanceCharge" mode="M12" priority="1034">
    <svrl:fired-rule context="cac:Price/cac:AllowanceCharge" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(cbc:BaseAmount) or (../cbc:PriceAmount castable as xs:decimal and cbc:BaseAmount castable as xs:decimal and cbc:Amount castable as xs:decimal and xs:decimal(../cbc:PriceAmount) = xs:decimal(cbc:BaseAmount) - xs:decimal(cbc:Amount))" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:BaseAmount) or (../cbc:PriceAmount castable as xs:decimal and cbc:BaseAmount castable as xs:decimal and cbc:Amount castable as xs:decimal and xs:decimal(../cbc:PriceAmount) = xs:decimal(cbc:BaseAmount) - xs:decimal(cbc:Amount))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:PaymentMeansCode = &quot;30&quot;) or cac:PayeeFinancialAccount/cbc:ID">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cac:Country/cbc:IdentificationCode=&quot;AE&quot; and cbc:CountrySubentity = (&quot;AUH&quot;, &quot;DXB&quot;, &quot;SHJ&quot;, &quot;UAQ&quot;, &quot;FUJ&quot;, &quot;AJM&quot;, &quot;RAK&quot;)) or not(cac:Country/cbc:IdentificationCode=&quot;AE&quot;)">
          ...
          <svrl:text>[ibr-128-ae]-When Country code (IBT-040, IBT-055, IBT-069, IBT-080) is AE, then country subdivision (IBT-039, IBT-054, IBT-068, IBT-079) must be one of (AUH, DXB, SHJ, UAQ, FUJ, AJM, RAK).</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M12" select="@*|*" />
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge[cbc:ChargeIndicator = false()][not(ancestor::cac:Price)]" mode="M12" priority="1030">
    <svrl:fired-rule context="cac:AllowanceCharge[cbc:ChargeIndicator = false()][not(ancestor::cac:Price)]" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:TaxCategory/cbc:ID = &quot;N&quot;)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(exists(cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID) != &quot;E&quot;])) or (exists(cac:ItemPriceExtension/cac:TaxTotal/cbc:TaxAmount) and exists(cac:ItemPriceExtension/cbc:Amount))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="((../(cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot; or ../(cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;480&quot;) and count(cac:Item/cac:ClassifiedTaxCategory) = 1) or not(../(cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot; or ../(cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;480&quot;)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches(cbc:ProfileExecutionID, &quot;^1[01]{7}$&quot;)) or cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID">
          ...
          <svrl:text>[ibr-007-ae]-When Invoice Transaction-type code (BTAE-02) has value 1XXXXXXX (Free trade zone), then Beneficiary ID (BTAE-01) MUST be provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:InvoiceTypeCode = &quot;480&quot; or cbc:CreditNoteTypeCode = &quot;81&quot;) or exists(cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(matches(cbc:ProfileExecutionID, &quot;^[01]{5}1[01]{2}$&quot;) and cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID) or not(matches(cbc:ProfileExecutionID, &quot;^[01]{5}1[01]{2}$&quot;))">
          ...
          <svrl:text>[ibr-137-ae]-Principal ID (BTAE-14) is MUST, where Invoice transaction type code [BTAE-02] is XXXXX1XX (Disclosed Agent billing).</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;381&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot;) and (((cac:BillingReference) and (cac:DiscrepancyResponse/cbc:ResponseCode != &quot;VD&quot;)) or (not(cac:BillingReference) and (cac:DiscrepancyResponse/cbc:ResponseCode = &quot;VD&quot;)))) or not((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;381&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot;)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(exists(//cac:TaxCategory[cac:TaxScheme/normalize-space(upper-case(cbc:ID))=&quot;VAT&quot;]/cbc:ID[normalize-space(.) = &quot;N&quot;]) and (count(//cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cbc:ID='N']) = 1)) or not(exists(//cac:TaxCategory[cac:TaxScheme/normalize-space(upper-case(cbc:ID))=&quot;VAT&quot;]/cbc:ID[normalize-space(.) = &quot;N&quot;]))" />
      <xsl:otherwise>
        <svrl:failed-assert test="(exists(//cac:TaxCategory[cac:TaxScheme/normalize-space(upper-case(cbc:ID))=&quot;VAT&quot;]/cbc:ID[normalize-space(.) = &quot;N&quot;]) and (count(//cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cbc:ID='N']) = 1)) or not(exists(//cac:TaxCategory[cac:TaxScheme/normalize-space(upper-case(cbc:ID))=&quot;VAT&quot;]/cbc:ID[normalize-space(.) = &quot;N&quot;]))">
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;480&quot;) or (every $cat in (//cac:TaxCategory/cbc:ID | //cac:ClassifiedTaxCategory/cbc:ID) satisfies normalize-space($cat) = (&quot;E&quot;,&quot;O&quot;,&quot;Z&quot;))" />
      <xsl:otherwise>
        <svrl:failed-assert test="not((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;480&quot;) or (every $cat in (//cac:TaxCategory/cbc:ID | //cac:ClassifiedTaxCategory/cbc:ID) satisfies normalize-space($cat) = (&quot;E&quot;,&quot;O&quot;,&quot;Z&quot;))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;381&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot;) or not(cbc:TaxPointDate)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;381&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot; or cbc:CreditNoteTypeCode = &quot;261&quot; or matches(cbc:ProfileExecutionID, &quot;^[01]1[01]{6}$&quot;)) or not(cac:LegalMonetaryTotal/cbc:PayableAmount > 0) or exists(cbc:DueDate)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches(cbc:ProfileExecutionID, &quot;^[01]{2}1[01]{5}$&quot;)) or not((//cac:TaxCategory/cbc:ID | //cac:ClassifiedTaxCategory/cbc:ID)[normalize-space(.) != &quot;N&quot;])">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;380&quot;) or ((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;381&quot;)) or exists((cac:InvoiceLine | cac:CreditNoteLine)/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID) != &quot;E&quot; and normalize-space(cbc:ID) != &quot;O&quot;])">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches(cbc:ProfileExecutionID, &quot;^[01]{7}1$&quot;)) or cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode = &quot;AE&quot; or (cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName and cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName and cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;480&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot;) and matches(cbc:ProfileExecutionID, &quot;^[01]{2}1[01]{5}$|^[01]1[01]{6}$|^[01]{3}1[01]{4}$&quot;))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;381&quot; and not(exists(cac:DiscrepancyResponse/cbc:ResponseCode)))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cbc:DocumentCurrencyCode != &quot;AED&quot; and (exists(//cac:TaxExchangeRate/cbc:CalculationRate))) or cbc:DocumentCurrencyCode = &quot;AED&quot;">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(matches(cbc:ProfileExecutionID, &quot;^[01]{5}1[01]{2}$&quot;) and cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID != cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID) or not(matches(cbc:ProfileExecutionID, &quot;^[01]{5}1[01]{2}$&quot;))">
          ...
          <svrl:text>[ibr-176-ae]-When Invoice transaction type code [BTAE-02] is XXXXX1XX (Disclosed agent billing), then the value in field Seller VAT Identifier [IBT-031] and Principal ID [BTAE-14] should not be the same.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="not(//cac:TaxCategory/cbc:ID = &quot;S&quot;) or (every $p in //cac:TaxCategory[cbc:ID = &quot;S&quot;]/cbc:Percent satisfies ($p castable as xs:decimal and xs:decimal($p) = 5.00))" />
      <xsl:otherwise>
        <svrl:failed-assert test="not(//cac:TaxCategory/cbc:ID = &quot;S&quot;) or (every $p in //cac:TaxCategory[cbc:ID = &quot;S&quot;]/cbc:Percent satisfies ($p castable as xs:decimal and xs:decimal($p) = 5.00))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="((cbc:InvoiceTypeCode|cbc:CreditNoteTypeCode) = &quot;81&quot; or (cbc:InvoiceTypeCode|cbc:CreditNoteTypeCode) = &quot;381&quot; or (cbc:InvoiceTypeCode|cbc:CreditNoteTypeCode) = &quot;261&quot; or matches(cbc:ProfileExecutionID, &quot;^[01]1[01]{6}$&quot;)) or exists(cac:PaymentMeans/cbc:PaymentMeansCode)">
          <xsl:attribute name="id">ibr-191-ae</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-191-ae]- Payment means type code (ibt-081) must be provided except when the invoice type code (ibt-003) is 'Credit note' or "Credit note related to goods or services", or Invoice transaction-type code (BTAE-002) is X1XXXXXX (Deemed supply).</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:ClassifiedTaxCategory/cbc:ID = &quot;AE&quot;) or exists(cac:CommodityClassification/cbc:NatureCode)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cac:CommodityClassification/cbc:CommodityCode = &quot;B&quot;) or (exists(cac:CommodityClassification/cbc:ItemClassificationCode) and exists(cac:AdditionalItemIdentification/cbc:ID))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cac:TaxCategory[cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']/cbc:Percent) or (cac:TaxCategory[cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']/normalize-space(cbc:ID)=('O','E'))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cac:TaxCategory/cbc:ID = (&quot;O&quot;,&quot;E&quot;) and not(cac:TaxCategory/cbc:Percent)) or (not(cac:TaxCategory/cbc:ID = (&quot;O&quot;,&quot;E&quot;)) and cac:TaxCategory/cbc:Percent)">
          <xsl:attribute name="id">ibr-119-ae</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-119-ae]-Each VAT breakdown (IBG-23) shall have a VAT category rate (IBT-119), except if the Invoice is not subject to VAT or Exempt from Tax.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M12" select="@*|*" />
...
<xsl:template match="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID) = 'S'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT'] | cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID) = 'S'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']" mode="M12" priority="1023">
    <svrl:fired-rule context="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID) = 'S'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT'] | cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID) = 'S'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(cbc:Percent castable as xs:decimal and xs:decimal(cbc:Percent) > 0)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(cbc:Percent castable as xs:decimal and xs:decimal(cbc:Percent) > 0)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(cbc:Percent castable as xs:decimal and ../cbc:TaxableAmount castable as xs:decimal and ../cbc:TaxAmount castable as xs:decimal) and u:slack(abs(xs:decimal(../cbc:TaxAmount)) , round((abs(xs:decimal(../cbc:TaxableAmount)) * (xs:decimal(cbc:Percent) div 100)) * 10 * 10) div 100 ,0.02 )" />
      <xsl:otherwise>
        <svrl:failed-assert test="(cbc:Percent castable as xs:decimal and ../cbc:TaxableAmount castable as xs:decimal and ../cbc:TaxAmount castable as xs:decimal) and u:slack(abs(xs:decimal(../cbc:TaxAmount)) , round((abs(xs:decimal(../cbc:TaxableAmount)) * (xs:decimal(cbc:Percent) div 100)) * 10 * 10) div 100 ,0.02 )">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:TaxExemptionReason) and not(cbc:TaxExemptionReasonCode)">
          ...
          <svrl:text>[aligned-ibrp-s-10]-A VAT breakdown (ibg-23) with VAT Category code (ibt-118) "Standard rate" MUST not have a VAT exemption reason code (IBT-186) or VAT exemption reason text (IBT-185).</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M12" select="@*|*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(../../cac:ItemPriceExtension/cac:TaxTotal/cbc:TaxAmount)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cbc:Percent)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cbc:Percent) and normalize-space(cbc:Percent) != '' and cbc:Percent castable as xs:decimal and xs:decimal(normalize-space(cbc:Percent)) = 0">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(.) = 15 and starts-with(., &quot;1&quot;) and ends-with(., &quot;03&quot;) and matches(., &quot;^[0-9]+$&quot;)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test=". = &quot;VAT&quot; or exists(//cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID[ string-length(normalize-space(.)) = 10 and starts-with(normalize-space(.), &quot;1&quot;) and translate(normalize-space(.), &quot;0123456789&quot;, &quot;&quot;) = &quot;&quot;])">
          <xsl:attribute name="id">ibr-133-ae</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-133-ae]-VAT scheme code, if provided in (IBT-095-1) or (IBT-031-1) or (IBT-048-1) or (IBT-063-1) or (IBT-102-1) or (IBT-118-1) shall be 'VAT' except when Seller tax registration identifier (IBT-032) is provided.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M12" select="@*|*" />
