...
public final class PeppolValidationPintJP_SB
{
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_0_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                          "invoice",
                                                                                                          "1.0.1");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_0_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                              "credit-note",
                                                                                                              "1.0.1");
  ...
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_1_0 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                          "invoice",
                                                                                                          "1.1.0");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_1_0 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                              "credit-note",
                                                                                                              "1.1.0");
  ...
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_1_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                          "invoice",
                                                                                                          "1.1.1");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_1_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                              "credit-note",
                                                                                                              "1.1.1");
  ...
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_1_2 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                          "invoice",
                                                                                                          "1.1.2");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_1_2 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                              "credit-note",
                                                                                                              "1.1.2");
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_1_3 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                          "invoice",
                                                                                                          "1.1.3");
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_1_3 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                              "credit-note",
                                                                                                              "1.1.3");
  ...
  public static void init (@NonNull final IValidationExecutorSetRegistry <IValidationSourceXML> aRegistry)
  {
    ...
    // 1.0.1
    {
      ...
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_0_1)
                   .displayName ("Peppol PINT Japan Self Billing Invoice (UBL) 1.0.1")
                   .deprecated ()
      ...
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_0_1)
                   .displayName ("Peppol PINT Japan Self Billing Credit Note (UBL) 1.0.1")
                   .deprecated ()
    ...
    // 1.1.0
    {
      ...
      final ClassPathResource aCPR2 = new ClassPathResource (BASE_PATH +
                                                             ...
                                                             _getCL ());
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_1_0)
                   .displayName ("Peppol PINT Japan Self Billing Invoice (UBL) 1.1.0")
                   .deprecated ()
                   ...
                   .registerInto (aRegistry);
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_1_0)
                   .displayName ("Peppol PINT Japan Self Billing Credit Note (UBL) 1.1.0")
                   .deprecated ()
                   .validFrom (V1_1_0_VALID_PER_UTC)
                   .addSchematron (PhiveRulesHelper.createXSLT (aCPR1, aNSCtxCreditNote))
                   .addSchematron (PhiveRulesHelper.createXSLT (aCPR2, aNSCtxCreditNote))
    ...
    // 1.1.1
    {
      ...
      final ClassPathResource aCPR2 = new ClassPathResource (BASE_PATH +
                                                             ...
                                                             _getCL ());
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_JP_PINT_SB_INVOICE_1_1_1)
                   .displayName ("Peppol PINT Japan Self Billing Invoice (UBL) 1.1.1")
                   .deprecated ()
                   ...
                   .registerInto (aRegistry);
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_JP_PINT_SB_CREDIT_NOTE_1_1_1)
                   .displayName ("Peppol PINT Japan Self Billing Credit Note (UBL) 1.1.1")
                   .deprecated ()
                   .validFrom (V1_1_1_VALID_PER_UTC)
                   .addSchematron (PhiveRulesHelper.createXSLT (aCPR1, aNSCtxCreditNote))
                   .addSchematron (PhiveRulesHelper.createXSLT (aCPR2, aNSCtxCreditNote))
