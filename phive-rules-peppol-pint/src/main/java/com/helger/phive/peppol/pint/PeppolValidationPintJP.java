...
public final class PeppolValidationPintJP
{
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_INVOICE_012 = DVRHelper.createCoordinate ("org.peppol.jp.pint", "invoice", "0.1.2");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_CREDIT_NOTE_012 = DVRHelper.createCoordinate ("org.peppol.jp.pint", "credit-note", "0.1.2");

  // 1.0.2
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_INVOICE_1_0_2 = DVRHelper.createCoordinate (GROUP_ID, "invoice", "1.0.2");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_CREDIT_NOTE_1_0_2 = DVRHelper.createCoordinate (GROUP_ID, "credit-note", "1.0.2");

  // 1.0.3
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_INVOICE_1_0_3 = DVRHelper.createCoordinate (GROUP_ID, "invoice", "1.0.3");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_CREDIT_NOTE_1_0_3 = DVRHelper.createCoordinate (GROUP_ID, "credit-note", "1.0.3");
  ...
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_INVOICE_1_1_0 = DVRHelper.createCoordinate (GROUP_ID, "invoice", "1.1.0");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_CREDIT_NOTE_1_1_0 = DVRHelper.createCoordinate (GROUP_ID, "credit-note", "1.1.0");
  ...
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_INVOICE_1_1_1 = DVRHelper.createCoordinate (GROUP_ID, "invoice", "1.1.1");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_CREDIT_NOTE_1_1_1 = DVRHelper.createCoordinate (GROUP_ID, "credit-note", "1.1.1");
  // 1.1.2 - 09.03.2026
  ...
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_INVOICE_1_1_2 = DVRHelper.createCoordinate (GROUP_ID, "invoice", "1.1.2");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_CREDIT_NOTE_1_1_2 = DVRHelper.createCoordinate (GROUP_ID, "credit-note", "1.1.2");
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_INVOICE_1_1_3 = DVRHelper.createCoordinate (GROUP_ID, "invoice", "1.1.3");
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_CREDIT_NOTE_1_1_3 = DVRHelper.createCoordinate (GROUP_ID, "credit-note", "1.1.3");
