...
public final class PeppolValidationPintOM
{
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_INVOICE_1_0_0 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                       "invoice",
                                                                                                       "1.0.0");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_CREDIT_NOTE_1_0_0 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                           "creditnote",
                                                                                                           "1.0.0");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_SB_INVOICE_1_0_0 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                          "invoice-self-billing",
                                                                                                          "1.0.0");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_SB_CREDIT_NOTE_1_0_0 = DVRHelper.createCoordinate (GROUP_ID,
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_INVOICE_1_0_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                       "invoice",
                                                                                                       "1.0.1");
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_CREDIT_NOTE_1_0_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                           "creditnote",
                                                                                                           "1.0.1");
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_SB_INVOICE_1_0_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                          "invoice-self-billing",
                                                                                                          "1.0.1");
  public static final DVRCoordinate VID_OPENPEPPOL_OM_PINT_SB_CREDIT_NOTE_1_0_1 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                              "creditnote-self-billing",
                                                                                                              "1.0.1");
  ...
  public static void init (@NonNull final IValidationExecutorSetRegistry <IValidationSourceXML> aRegistry)
  {
    ...
    // 1.0.1
    {
      final String sBase = BASE_PATH + "1.0.1/";
      final String sBaseBilling = sBase + "billing/";
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_OM_PINT_INVOICE_1_0_1)
                   .displayName ("Peppol PINT OM Invoice (UBL) 1.0.1")
                   .notDeprecated ()
                   .validFrom (OM_PINT_1_0_1_VALID_PER_UTC)
                   .addXSD (UBL21Marshaller.getAllInvoiceXSDs ())
                   .addSchematron (PhiveRulesHelper.createXSLT (new ClassPathResource (sBaseBilling +
                                                                                       "PINT-UBL-validation-preprocessed.xslt",
                                                                                       _getCL ()), aNSCtxInvoice))
                   ...
                   .registerInto (aRegistry);
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_OM_PINT_CREDIT_NOTE_1_0_1)
                   .displayName ("Peppol PINT OM Credit Note (UBL) 1.0.1")
                   .notDeprecated ()
                   .validFrom (OM_PINT_1_0_1_VALID_PER_UTC)
                   .addXSD (UBL21Marshaller.getAllCreditNoteXSDs ())
                   .addSchematron (PhiveRulesHelper.createXSLT (new ClassPathResource (sBaseBilling +
      ...
      final String sBaseSelfBilling = sBase + "selfbilling/";
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_OM_PINT_SB_INVOICE_1_0_1)
                   .displayName ("Peppol PINT OM Invoice Self-Billing (UBL) 1.0.1")
                   .notDeprecated ()
                   .validFrom (OM_PINT_1_0_1_VALID_PER_UTC)
                   .addXSD (UBL21Marshaller.getAllInvoiceXSDs ())
                   .addSchematron (PhiveRulesHelper.createXSLT (new ClassPathResource (sBaseSelfBilling +
                   ...
                   .registerInto (aRegistry);
      VesXmlBuilder.builder ()
                   .vesID (VID_OPENPEPPOL_OM_PINT_SB_CREDIT_NOTE_1_0_1)
                   .displayName ("Peppol PINT OM Credit Note Self-Billing (UBL) 1.0.1")
                   .notDeprecated ()
                   .validFrom (OM_PINT_1_0_1_VALID_PER_UTC)
                   .addXSD (UBL21Marshaller.getAllCreditNoteXSDs ())
                   .addSchematron (PhiveRulesHelper.createXSLT (new ClassPathResource (sBaseSelfBilling +
