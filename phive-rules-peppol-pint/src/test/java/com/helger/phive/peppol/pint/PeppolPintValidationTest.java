...
import com.helger.phive.peppol.pint.mock.CTestFiles;
 ...
 */
public final class PeppolPintValidationTest
{
  @Test
  public void testRegistrationNotEmpty ()
  {
    assertTrue (CTestFiles.VES_REGISTRY.getAll ().isNotEmpty ());
  }
