...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="BIIRULES  T10 bound to UBL">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>BIIRULES  T10 bound to UBL</svrl:text>

<!--PATTERN UBL-T10-->


	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:AllowanceCharge" mode="M7" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:InvoiceLine" mode="M7" priority="1006">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cac:Item/cac:ClassifiedTaxCategory/cbc:ID) or not(/ubl:Invoice/cac:TaxTotal/*/*/*/cbc:ID='VAT')">
	...
	<!--RULE -->
<xsl:template match="//cac:InvoicePeriod" mode="M7" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:PaymentMeans" mode="M7" priority="1004">
...
<!--PATTERN CodesT10-->
	...
	<!--RULE -->
<xsl:template match="cbc:InvoiceTypeCode" mode="M8" priority="1007">
