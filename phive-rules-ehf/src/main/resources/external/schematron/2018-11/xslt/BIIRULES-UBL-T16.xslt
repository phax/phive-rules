...
<!--PATTERN UBL-T16-->
	...
	<!--RULE -->
<xsl:template match="//cac:DeliveryCustomerParty" mode="M6" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:DespatchAdvice" mode="M6" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:DespatchLine" mode="M6" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:Shipment" mode="M6" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:DespatchSupplierParty" mode="M6" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Item/cac:StandardItemIdentification/cbc:ID" mode="M6" priority="1000">
    <svrl:fired-rule context="cac:Item/cac:StandardItemIdentification/cbc:ID" />
