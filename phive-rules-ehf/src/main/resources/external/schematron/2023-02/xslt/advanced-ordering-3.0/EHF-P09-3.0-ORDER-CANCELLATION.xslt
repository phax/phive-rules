...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="iso" title="EHF Advanced Order Cancellation 3.0">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>EHF Advanced Order Cancellation 3.0</svrl:text>
...
<xsl:variable name="clICD" select="tokenize('0002 0003 0004 0005 0006 0007 0008 0009 0010 0011 0012 0013 0014 0015 0016 0017 0018 0019 0020 0021 0022 0023 0024 0025 0026 0027 0028 0029 0030 0031 0032 0033 0034 0035 0036 0037 0038 0039 0040 0041 0042 0043 0044 0045 0046 0047 0048 0049 0050 0051 0052 0053 0054 0055 0056 0057 0058 0059 0060 0061 0062 0063 0064 0065 0066 0067 0068 0069 0070 0071 0072 0073 0074 0075 0076 0077 0078 0079 0080 0081 0082 0083 0084 0085 0086 0087 0088 0089 0090 0091 0093 0094 0095 0096 0097 0098 0099 0100 0101 0102 0104 0105 0106 0107 0108 0109 0110 0111 0112 0113 0114 0115 0116 0117 0118 0119 0120 0121 0122 0123 0124 0125 0126 0127 0128 0129 0130 0131 0132 0133 0134 0135 0136 0137 0138 0139 0140 0141 0142 0143 0144 0145 0146 0147 0148 0149 0150 0151 0152 0153 0154 0155 0156 0157 0158 0159 0160 0161 0162 0163 0164 0165 0166 0167 0168 0169 0170 0171 0172 0173 0174 0175 0176 0177 0178 0179 0180 0183 0184 0185 0186 0187 0188 0189 0190 0191 0192 0193 0194 0195 0196 0197 0198 0199 0200 0201 0202 0203 0204 0205 0206 0207 0208 0209 0210 0211 0212 0213 0214 0215 0216', '\s')" />
  ...
  <xsl:variable name="clISO3166" select="tokenize('AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE BF BG BH BI BJ BL BM BN BO BQ BR BS BT BV BW BY BZ CA CC CD CF CG CH CI CK CL CM CN CO CR CU CV CW CX CY CZ DE DJ DK DM DO DZ EC EE EG EH ER ES ET FI FJ FK FM FO FR GA GB GD GE GF GG GH GI GL GM GN GP GQ GR GS GT GU GW GY HK HM HN HR HT HU ID IE IL IM IN IO IQ IR IS IT JE JM JO JP KE KG KH KI KM KN KP KR KW KY KZ LA LB LC LI LK LR LS LT LU LV LY MA MC MD ME MF MG MH MK ML MM MN MO MP MQ MR MS MT MU MV MW MX MY MZ NA NC NE NF NG NI NL NO NP NR NU NZ OM PA PE PF PG PH PK PL PM PN PR PS PT PW PY QA RE RO RS RU RW SA SB SC SD SE SG SH SI SJ SK SL SM SN SO SR SS ST SV SX SY SZ TC TD TF TG TH TJ TK TL TM TN TO TR TT TV TW TZ UA UG UM US UY UZ VA VC VE VG VI VN VU WF WS YE YT ZA ZM ZW 1A XI', '\s')" />
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation" mode="M20" priority="1183">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:CustomizationID" mode="M20" priority="1182">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:CustomizationID/*" mode="M20" priority="1181">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:CustomizationID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:ProfileID" mode="M20" priority="1180">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:ProfileID/*" mode="M20" priority="1179">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:ProfileID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:UUID" mode="M20" priority="1178">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:UUID" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:UUID/*" mode="M20" priority="1177">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:UUID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:ID" mode="M20" priority="1176">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:ID" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:ID/*" mode="M20" priority="1175">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:IssueDate" mode="M20" priority="1174">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:IssueDate" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:IssueDate/*" mode="M20" priority="1173">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:IssueDate/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:IssueTime" mode="M20" priority="1172">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:IssueTime" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:IssueTime/*" mode="M20" priority="1171">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:IssueTime/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:Note" mode="M20" priority="1170">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:Note" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:Note/*" mode="M20" priority="1169">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:Note/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:CancellationNote" mode="M20" priority="1168">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:CancellationNote" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:CancellationNote/*" mode="M20" priority="1167">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:CancellationNote/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OrderReference" mode="M20" priority="1166">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OrderReference/cbc:ID" mode="M20" priority="1165">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OrderReference/cbc:ID" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OrderReference/cbc:ID/*" mode="M20" priority="1164">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OrderReference/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OrderReference/*" mode="M20" priority="1163">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OrderReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorDocumentReference" mode="M20" priority="1162">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorDocumentReference/cbc:ID" mode="M20" priority="1161">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorDocumentReference/cbc:ID/*" mode="M20" priority="1160">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorDocumentReference/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorDocumentReference/*" mode="M20" priority="1159">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorDocumentReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference" mode="M20" priority="1158">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:ID" mode="M20" priority="1157">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:ID/*" mode="M20" priority="1156">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:DocumentType" mode="M20" priority="1155">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:DocumentType" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:DocumentType/*" mode="M20" priority="1154">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:DocumentType/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment" mode="M20" priority="1153">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject" mode="M20" priority="1152">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject/*" mode="M20" priority="1151">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference" mode="M20" priority="1150">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI" mode="M20" priority="1149">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI/*" mode="M20" priority="1148">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/*" mode="M20" priority="1147">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/*" mode="M20" priority="1146">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/*" mode="M20" priority="1145">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:Contract" mode="M20" priority="1144">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:Contract/cbc:ID" mode="M20" priority="1143">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:Contract/cbc:ID" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:Contract/cbc:ID/*" mode="M20" priority="1142">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:Contract/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:Contract/*" mode="M20" priority="1141">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:Contract/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty" mode="M20" priority="1140">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party" mode="M20" priority="1139">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cbc:EndpointID" mode="M20" priority="1138">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cbc:EndpointID/*" mode="M20" priority="1137">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cbc:EndpointID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification" mode="M20" priority="1136">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M20" priority="1135">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/*" mode="M20" priority="1134">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/*" mode="M20" priority="1133">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName" mode="M20" priority="1132">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/cbc:Name" mode="M20" priority="1131">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/cbc:Name/*" mode="M20" priority="1130">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/cbc:Name/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/*" mode="M20" priority="1129">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress" mode="M20" priority="1128">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M20" priority="1127">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName/*" mode="M20" priority="1126">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M20" priority="1125">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName/*" mode="M20" priority="1124">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M20" priority="1123">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName/*" mode="M20" priority="1122">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M20" priority="1121">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone/*" mode="M20" priority="1120">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M20" priority="1119">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity/*" mode="M20" priority="1118">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine" mode="M20" priority="1117">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line" mode="M20" priority="1116">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line/*" mode="M20" priority="1115">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/*" mode="M20" priority="1114">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country" mode="M20" priority="1113">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M20" priority="1112">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode/*" mode="M20" priority="1111">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/*" mode="M20" priority="1110">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/*" mode="M20" priority="1109">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme" mode="M20" priority="1108">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M20" priority="1107">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID/*" mode="M20" priority="1106">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M20" priority="1105">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M20" priority="1104">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID/*" mode="M20" priority="1103">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/*" mode="M20" priority="1102">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/*" mode="M20" priority="1101">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity" mode="M20" priority="1100">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M20" priority="1099">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName/*" mode="M20" priority="1098">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M20" priority="1097">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/*" mode="M20" priority="1096">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" mode="M20" priority="1095">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M20" priority="1094">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName/*" mode="M20" priority="1093">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M20" priority="1092">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M20" priority="1091">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/*" mode="M20" priority="1090">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" mode="M20" priority="1089">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" mode="M20" priority="1088">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/*" mode="M20" priority="1087">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact" mode="M20" priority="1086">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Name" mode="M20" priority="1085">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Name/*" mode="M20" priority="1084">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Name/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Telephone" mode="M20" priority="1083">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Telephone/*" mode="M20" priority="1082">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Telephone/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M20" priority="1081">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail/*" mode="M20" priority="1080">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/*" mode="M20" priority="1079">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/*" mode="M20" priority="1078">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/*" mode="M20" priority="1077">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty" mode="M20" priority="1076">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party" mode="M20" priority="1075">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cbc:EndpointID" mode="M20" priority="1074">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cbc:EndpointID/*" mode="M20" priority="1073">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cbc:EndpointID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification" mode="M20" priority="1072">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M20" priority="1071">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID/*" mode="M20" priority="1070">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/*" mode="M20" priority="1069">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName" mode="M20" priority="1068">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/cbc:Name" mode="M20" priority="1067">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/cbc:Name/*" mode="M20" priority="1066">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/cbc:Name/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/*" mode="M20" priority="1065">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress" mode="M20" priority="1064">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M20" priority="1063">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName/*" mode="M20" priority="1062">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M20" priority="1061">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName/*" mode="M20" priority="1060">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M20" priority="1059">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName/*" mode="M20" priority="1058">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M20" priority="1057">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone/*" mode="M20" priority="1056">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M20" priority="1055">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity/*" mode="M20" priority="1054">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine" mode="M20" priority="1053">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line" mode="M20" priority="1052">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line/*" mode="M20" priority="1051">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/*" mode="M20" priority="1050">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country" mode="M20" priority="1049">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M20" priority="1048">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode/*" mode="M20" priority="1047">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/*" mode="M20" priority="1046">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/*" mode="M20" priority="1045">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity" mode="M20" priority="1044">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M20" priority="1043">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName/*" mode="M20" priority="1042">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M20" priority="1041">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/*" mode="M20" priority="1040">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" mode="M20" priority="1039">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M20" priority="1038">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName/*" mode="M20" priority="1037">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M20" priority="1036">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M20" priority="1035">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/*" mode="M20" priority="1034">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" mode="M20" priority="1033">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" mode="M20" priority="1032">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/*" mode="M20" priority="1031">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact" mode="M20" priority="1030">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Name" mode="M20" priority="1029">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Name/*" mode="M20" priority="1028">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Name/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Telephone" mode="M20" priority="1027">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Telephone/*" mode="M20" priority="1026">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Telephone/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M20" priority="1025">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail/*" mode="M20" priority="1024">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/*" mode="M20" priority="1023">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/*" mode="M20" priority="1022">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/*" mode="M20" priority="1021">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty" mode="M20" priority="1020">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party" mode="M20" priority="1019">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification" mode="M20" priority="1018">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M20" priority="1017">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/*" mode="M20" priority="1016">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification/*" mode="M20" priority="1015">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName" mode="M20" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/cbc:Name" mode="M20" priority="1013">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/cbc:Name/*" mode="M20" priority="1012">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/cbc:Name/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/*" mode="M20" priority="1011">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact" mode="M20" priority="1010">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Name" mode="M20" priority="1009">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Name/*" mode="M20" priority="1008">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Name/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Telephone" mode="M20" priority="1007">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M20" select="@*|*|comment()|processing-instruction()" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Telephone/*" mode="M20" priority="1006">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Telephone/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M20" priority="1005">
