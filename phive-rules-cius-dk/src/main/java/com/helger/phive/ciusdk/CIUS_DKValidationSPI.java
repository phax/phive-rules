...
/**
 * SPI implementation that registers the CIUS-DK validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class CIUS_DKValidationSPI implements IValidationRulesRegistrarSPI
{
  @Override
  @NonNull
  @ReturnsMutableCopy
  ...
  {
    return CIUS_DKValidation.getAllPrerequisites ();
  }
