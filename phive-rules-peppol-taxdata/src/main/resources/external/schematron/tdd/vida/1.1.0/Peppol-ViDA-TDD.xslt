...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(pxs:TransmissionUUID)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(exists(pxs:TransmissionUUID)) or matches(normalize-space(pxs:TransmissionUUID), '^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$')">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(exists(cbc:UUID)) or matches(normalize-space(cbc:UUID), '^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-5[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$')">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not($rr_doc = 'C3') or exists(cac:TaxTotal/cbc:TaxAmount[@currencyID = normalize-space(../../cbc:DocumentCurrencyCode)])">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not($rr_doc = 'C3') or exists(pxs:MonetaryTotal/cbc:TaxInclusiveAmount)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not($rr_doc = 'C3') or not(exists(cbc:TaxCurrencyCode)) or exists(cac:TaxTotal/cbc:TaxAmount[@currencyID = normalize-space(../../cbc:TaxCurrencyCode)])">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not($rr_sub = 'C3') or (exists(cbc:TaxAmount) and exists(cac:TaxCategory/cbc:ID) and exists(cac:TaxCategory/cbc:Percent))">
