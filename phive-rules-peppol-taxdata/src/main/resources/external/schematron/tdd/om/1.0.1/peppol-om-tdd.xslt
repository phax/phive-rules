...
<xsl:stylesheet xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cec="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:cn="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:inv="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:pxc="urn:peppol:xslt:custom-function" xmlns:pxs="urn:peppol:schema:om-taxdata:1.0" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="OpenPeppol OM TDD Schematron">
      <xsl:comment>
    ...
    Author:
      ...
      <svrl:ns-prefix-in-attribute-values prefix="pxs" uri="urn:peppol:schema:om-taxdata:1.0" />
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>OpenPeppol OM TDD Schematron</svrl:text>
...
<xsl:template match="/pxs:TaxData" mode="M10" priority="1020">
    ...
    <xsl:variable name="rtCount" select="count(pxs:ReportedTransaction)" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="normalize-space(cbc:CustomizationID) = 'urn:peppol:taxdata:om-1'" />
      <xsl:otherwise>
        <svrl:failed-assert test="normalize-space(cbc:CustomizationID) = 'urn:peppol:taxdata:om-1'">
          <xsl:attribute name="id">ibr-tdd-01</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-tdd-01] The Specification identifier (tdt-001) ID MUST use the value 'urn:peppol:taxdata:om-1'</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cbc:UUID)">
          ...
          <svrl:text>[ibr-tdd-58] – The cbc:UUID (TDT-003) element MUST be present.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(normalize-space(cbc:IssueTime), '^(([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]|24:00:00)(\.[0-9]+)?(Z|[+-][0-9]{2}:[0-9]{2})?$')">
          <xsl:attribute name="id">ibr-tdd-05</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-tdd-05] The Tax Data Document issue time (tdt-005) MUST be a valid Issue time (as per UBL recommendations)</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportingParty" mode="M10" priority="1019">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReceivingParty" mode="M10" priority="1018">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportersRepresentative" mode="M10" priority="1017">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportersRepresentative/cac:PartyIdentification" mode="M10" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction" mode="M10" priority="1015">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cbc:IssueDate)">
          ...
          <svrl:text>[ibr-tdd-59] The date when the original document was received (tdom-04) MUST be present</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(normalize-space(cbc:IssueTime), '^(([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]|24:00:00)(\.[0-9]+)?(Z|[+-][0-9]{2}:[0-9]{2})?$')">
          ...
          <svrl:text>[ibr-tdd-60] The time when the original document was received (tdom-05) MUST be present</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument" mode="M10" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty" mode="M10" priority="1013">
    <svrl:fired-rule context="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty" />
    <xsl:variable name="currentPath" select="pxc:genPath(.)" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $child in ('CustomerAssignedAccountID', 'DataSendingCapability',                                                                    'DespatchContact', 'AccountingContact', 'SellerContact')                                                     satisfies count (*[local-name(.) = $child]) = 0" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $child in ('CustomerAssignedAccountID', 'DataSendingCapability', 'DespatchContact', 'AccountingContact', 'SellerContact') satisfies count (*[local-name(.) = $child]) = 0">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party" mode="M10" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme" mode="M10" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity" mode="M10" priority="1010">
    <svrl:fired-rule context="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $child in ('CompanyID', 'RegistrationDate', 'RegistrationExpirationDate', 'CompanyLegalFormCode', 'CompanyLegalForm', 'SoleProprietorshipIndicator', 'CompanyLiquidationStatusCode', 'CorporateStockAmount',  'FullyPaidSharesIndicator', 'RegistrationAddress', 'CorporateRegistrationScheme', 'HeadOfficeParty', 'ShareholderParty')                                                     satisfies count (*[local-name(.) = $child]) = 0" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $child in ('CompanyID', 'RegistrationDate', 'RegistrationExpirationDate', 'CompanyLegalFormCode', 'CompanyLegalForm', 'SoleProprietorshipIndicator', 'CompanyLiquidationStatusCode', 'CorporateStockAmount', 'FullyPaidSharesIndicator', 'RegistrationAddress', 'CorporateRegistrationScheme', 'HeadOfficeParty', 'ShareholderParty') satisfies count (*[local-name(.) = $child]) = 0">
          <xsl:attribute name="id">ibr-tdd-61</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-tdd-61] Only XML elements defined in this specification are allowed to be used</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="exists(cbc:RegistrationName)" />
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cbc:RegistrationName)">
          <xsl:attribute name="id">ibr-tdd-62</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-tdd-62] The Seller name (ibt-027) MUST be present</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M10" select="*|comment()|processing-instruction()" />
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty" mode="M10" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party" mode="M10" priority="1008">
    <svrl:fired-rule context="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $child in ('MarkCareIndicator', 'MarkAttentionIndicator', 'WebsiteURI', 'LogoReferenceID', 'EndpointID',                                                                   'IndustryClassificationCode', 'PartyName', 'Language', 'PostalAddress', 'PhysicalLocation', 'Contact', 'Person', 'AgentParty', 'ServiceProviderParty', 'PowerOfAttorney', 'FinancialAccount')                                                    satisfies count (*[local-name(.) = $child]) = 0" />
      <xsl:otherwise>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification" mode="M10" priority="1007">
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme" mode="M10" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity" mode="M10" priority="1005">
    <svrl:fired-rule context="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="every $child in ('CompanyID', 'RegistrationDate', 'RegistrationExpirationDate', 'CompanyLegalFormCode', 'CompanyLegalForm', 'SoleProprietorshipIndicator', 'CompanyLiquidationStatusCode', 'CorporateStockAmount', 'FullyPaidSharesIndicator', 'RegistrationAddress', 'CorporateRegistrationScheme', 'HeadOfficeParty', 'ShareholderParty') satisfies count (*[local-name(.) = $child]) = 0">
          ...
          <svrl:text>[ibr-tdd-63] Only XML elements defined in this specification are allowed to be used</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cbc:RegistrationName)">
          ...
          <svrl:text>[ibr-tdd-64] The Buyer name (ibt-044) MUST be present</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M10" select="*|comment()|processing-instruction()" />
