...
/**
 * SPI implementation that registers the Peppol Tax Data validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class PeppolValidationTaxDataSPI implements IValidationRulesRegistrarSPI
{
