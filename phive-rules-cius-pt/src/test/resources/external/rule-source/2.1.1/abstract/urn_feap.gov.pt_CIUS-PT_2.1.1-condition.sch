<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="condition">
  ...
  <rule context="$Invoice ">
	...
	<assert test="$DT-CIUS-PT-176_1" flag="fatal" id="DT-CIUS-PT-176">[DT-CIUS-PT-176]-An Invoice that contains Invoice lines (BG-25) with diferent VAT exemption reason codes, where the VAT category code (BT-151) is “Exempt from
	VAT”, shall contain exactly one VATBReakdown (BG-23) with the VAT category code (BT-118) equal to "Exempt from VAT", for each VAT exemption reason code (BT-121).</assert>
