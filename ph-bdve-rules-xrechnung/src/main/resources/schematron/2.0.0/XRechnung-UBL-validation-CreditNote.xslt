...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.4.0 - XRechnung 2.0.0 compatible - UBL - CreditNote">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.4.0 - XRechnung 2.0.0 compatible - UBL - CreditNote</svrl:text>
