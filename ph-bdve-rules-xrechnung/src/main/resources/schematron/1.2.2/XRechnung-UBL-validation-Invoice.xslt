...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Schematron Version 1.3.0 - XRechnung 1.2.2 compatible - UBL - Invoice">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>Schematron Version 1.3.0 - XRechnung 1.2.2 compatible - UBL - Invoice</svrl:text>
