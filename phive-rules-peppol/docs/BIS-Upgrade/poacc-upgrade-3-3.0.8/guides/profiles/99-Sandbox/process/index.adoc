...
If the BusinessDocumentSender has requested an MLR back,footnote:[This specification does not prescribe how a request for MLR is made or communicated.] the BusinessDocumentReceiver either:
