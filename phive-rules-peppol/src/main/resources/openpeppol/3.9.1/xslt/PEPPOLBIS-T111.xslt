...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:poacc:trns:invoice_response:3'">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:Response[contains( ' CA UQ RE ',concat(' ',normalize-space(cbc:ResponseCode),' '))]" mode="M11" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Status[cbc:StatusReasonCode='OTH']" mode="M11" priority="1000">
