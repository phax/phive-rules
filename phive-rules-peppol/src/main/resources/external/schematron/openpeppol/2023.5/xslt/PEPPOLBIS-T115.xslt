...
<xsl:variable name="cleas" select="tokenize('0002 0007 0009 0037 0060 0088 0096 0097 0106 0130 0135 0142 0151 0183 0184 0188 0190 0191 0192 0193 0195 0196 0198 0199 0200 0201 0202 0204 0208 0209 0210 0211 0212 0213 0215 0216 0221 0230 9901 9910 9913 9914 9915 9918 9919 9920 9922 9923 9924 9925 9926 9927 9928 9929 9930 9931 9932 9933 9934 9935 9936 9937 9938 9939 9940 9941 9942 9943 9944 9945 9946 9947 9948 9949 9950 9951 9952 9953 9957 9959', '\s')" />
  ...
  <xsl:variable name="clMimeCode" select="tokenize('application/pdf image/png image/jpeg image/tiff application/acad application/dwg drawing/dwg application/vnd.openxmlformats-officedocument.spreadsheetml.sheet application/vnd.oasis.opendocument.spreadsheet', '\s')" />
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation" mode="M19" priority="1118">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:CustomizationID" mode="M19" priority="1117">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:ProfileID" mode="M19" priority="1116">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:ID" mode="M19" priority="1115">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:ID" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:IssueDate" mode="M19" priority="1114">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:IssueDate" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:IssueTime" mode="M19" priority="1113">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:IssueTime" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:Note" mode="M19" priority="1112">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:Note" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cbc:CancellationNote" mode="M19" priority="1111">
    <svrl:fired-rule context="/ubl:OrderCancellation/cbc:CancellationNote" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OrderReference" mode="M19" priority="1110">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OrderReference/cbc:ID" mode="M19" priority="1109">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OrderReference/cbc:ID" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OrderReference/*" mode="M19" priority="1108">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OrderReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorDocumentReference" mode="M19" priority="1107">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorDocumentReference/cbc:ID" mode="M19" priority="1106">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorDocumentReference/*" mode="M19" priority="1105">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorDocumentReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference" mode="M19" priority="1104">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:ID" mode="M19" priority="1103">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:DocumentType" mode="M19" priority="1102">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cbc:DocumentType" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment" mode="M19" priority="1101">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject" mode="M19" priority="1100">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference" mode="M19" priority="1099">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/cbc:URI" mode="M19" priority="1098">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/*" mode="M19" priority="1097">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/*" mode="M19" priority="1096">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/cac:Attachment/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:AdditionalDocumentReference/*" mode="M19" priority="1095">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:AdditionalDocumentReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:Contract" mode="M19" priority="1094">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:Contract/cbc:ID" mode="M19" priority="1093">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:Contract/cbc:ID" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:Contract/*" mode="M19" priority="1092">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:Contract/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty" mode="M19" priority="1091">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party" mode="M19" priority="1090">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cbc:EndpointID" mode="M19" priority="1089">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification" mode="M19" priority="1088">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M19" priority="1087">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName" mode="M19" priority="1086">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/cbc:Name" mode="M19" priority="1085">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress" mode="M19" priority="1084">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M19" priority="1083">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M19" priority="1082">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M19" priority="1081">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M19" priority="1080">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M19" priority="1079">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine" mode="M19" priority="1078">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line" mode="M19" priority="1077">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country" mode="M19" priority="1076">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M19" priority="1075">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/*" mode="M19" priority="1074">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/*" mode="M19" priority="1073">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme" mode="M19" priority="1072">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M19" priority="1071">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M19" priority="1070">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" mode="M19" priority="1069">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/*" mode="M19" priority="1068">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/*" mode="M19" priority="1067">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyTaxScheme/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity" mode="M19" priority="1066">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M19" priority="1065">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M19" priority="1064">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" mode="M19" priority="1063">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M19" priority="1062">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M19" priority="1061">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M19" priority="1060">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" mode="M19" priority="1059">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" mode="M19" priority="1058">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/*" mode="M19" priority="1057">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact" mode="M19" priority="1056">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Name" mode="M19" priority="1055">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Telephone" mode="M19" priority="1054">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M19" priority="1053">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/*" mode="M19" priority="1052">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/cac:Contact/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/*" mode="M19" priority="1051">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/cac:Party/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:BuyerCustomerParty/*" mode="M19" priority="1050">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:BuyerCustomerParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty" mode="M19" priority="1049">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party" mode="M19" priority="1048">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cbc:EndpointID" mode="M19" priority="1047">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification" mode="M19" priority="1046">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M19" priority="1045">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName" mode="M19" priority="1044">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/cbc:Name" mode="M19" priority="1043">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress" mode="M19" priority="1042">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" mode="M19" priority="1041">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName" mode="M19" priority="1040">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" mode="M19" priority="1039">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" mode="M19" priority="1038">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" mode="M19" priority="1037">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine" mode="M19" priority="1036">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line" mode="M19" priority="1035">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country" mode="M19" priority="1034">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" mode="M19" priority="1033">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/*" mode="M19" priority="1032">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/*" mode="M19" priority="1031">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity" mode="M19" priority="1030">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName" mode="M19" priority="1029">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" mode="M19" priority="1028">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress" mode="M19" priority="1027">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cbc:CityName" mode="M19" priority="1026">
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country" mode="M19" priority="1025">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/cbc:IdentificationCode" mode="M19" priority="1024">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" mode="M19" priority="1023">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" mode="M19" priority="1022">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/*" mode="M19" priority="1021">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact" mode="M19" priority="1020">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Name" mode="M19" priority="1019">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Telephone" mode="M19" priority="1018">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M19" priority="1017">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/*" mode="M19" priority="1016">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/cac:Contact/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/*" mode="M19" priority="1015">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/cac:Party/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:SellerSupplierParty/*" mode="M19" priority="1014">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:SellerSupplierParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty" mode="M19" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party" mode="M19" priority="1012">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification" mode="M19" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" mode="M19" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName" mode="M19" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/cbc:Name" mode="M19" priority="1008">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact" mode="M19" priority="1007">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Name" mode="M19" priority="1006">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Telephone" mode="M19" priority="1005">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" mode="M19" priority="1004">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M19" select="@*|*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/*" mode="M19" priority="1003">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/cac:Contact/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/*" mode="M19" priority="1002">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/cac:Party/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/cac:OriginatorCustomerParty/*" mode="M19" priority="1001">
    <svrl:fired-rule context="/ubl:OrderCancellation/cac:OriginatorCustomerParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderCancellation/*" mode="M19" priority="1000">
    <svrl:fired-rule context="/ubl:OrderCancellation/*" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cbc:ProfileID" mode="M20" priority="1001">
