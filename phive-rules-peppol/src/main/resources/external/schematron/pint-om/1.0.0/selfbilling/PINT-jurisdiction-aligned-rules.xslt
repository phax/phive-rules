...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:param name="txnSafe"
              select="if ($isValidBitString) then $txnType else 'XXXXXXXXXXXXXXXXXXXX'"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="*[local-name() = ('Invoice','CreditNote') and namespace-uri() = ( 'urn:oasis:names:specification:ubl:schema:xsd:Invoice-2', 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2')]">
               ...
               <svrl:diagnostic-reference diagnostic="d-BTOM-PRE-001">
   ...
   <xsl:template match="ubl:Invoice | cn:CreditNote" priority="1011" mode="M51">
      ...
      <xsl:if test="true()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="true()">
            ...
            <svrl:diagnostic-reference diagnostic="d-BTOM-META-001">
      ...
      <xsl:if test="$debugMode">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$debugMode">
            <xsl:attribute name="role">information</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="starts-with($customizationID, 'urn:peppol:pint:selfbilling-1@om-1')">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not( $lines[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='Z'] or $allowances[cac:TaxCategory/cbc:ID='Z'] or $charges[cac:TaxCategory/cbc:ID='Z'] ) or ( (not($isSimplified) and count(cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cbc:ID='Z']) = 1) or ($isSimplified and count(cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cbc:ID='Z']) &lt;= 1) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($lines[cac:Item/cac:ClassifiedTaxCategory/cbc:ID = 'S']) or (every $line in $lines[cac:Item/cac:ClassifiedTaxCategory/cbc:ID = 'S'] satisfies ($line/cac:Item/cac:ClassifiedTaxCategory/cbc:Percent/normalize-space(.) castable as xs:decimal and xs:decimal($line/cac:Item/cac:ClassifiedTaxCategory/cbc:Percent) = $standardVatRate))">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="string-length($txnType) = 20 and matches($txnType, '^[X1]{20}$')">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(normalize-space(cbc:UUID), '^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$')">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($taxCurrency='OMR' and $invoiceCurrency!='OMR') or (exists($exchangeRate) and $exchangeRate = round($exchangeRate * $sevenDecimalScale) div $sevenDecimalScale)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isExport and $lines//cbc:TaxExemptionReasonCode ='VATZR-OM-12') or (exists($doc/cac:AdditionalDocumentReference [not(cbc:DocumentTypeCode='130')] [cbc:ID and cbc:UUID]))">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isSelfBilled or $isImportRCM or $isProfitMarginSelf or $isImportGoods) or cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme[cac:TaxScheme/cbc:ID='VAT']/cbc:CompanyID">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isFullTax or $isThirdParty or $isSelfBilled or $isExport or $isImportRCM or $isProfitMargin or $isProfitMarginSelf or $isImportGoods or $isSpecialZone or $isSummary) or (cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName and cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName and cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName and cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone and cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isSelfBilled or $isImportRCM or $isProfitMarginSelf or $isImportGoods) or cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode='OM'">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($invoiceCurrency != 'OMR' and $taxCurrency = 'OMR') or ( $exchangeRate castable as xs:decimal and u:slack( xs:decimal((cac:TaxTotal[cbc:TaxAmount/@currencyID = $taxCurrency]/cbc:TaxAmount)[1]), xs:decimal($exchangeRate * (cac:TaxTotal[cbc:TaxAmount/@currencyID = $invoiceCurrency]/cbc:TaxAmount)[1]), 0.01 ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isProfitMargin or $isProfitMarginSelf) or ( cac:AdditionalDocumentReference[cbc:DocumentTypeCode='PM_TOTAL']/cbc:DocumentDescription castable as xs:decimal and u:slack( xs:decimal(cac:AdditionalDocumentReference[cbc:DocumentTypeCode='PM_TOTAL']/cbc:DocumentDescription), xs:decimal(sum($lines/cac:ItemPriceExtension/cbc:Amount/xs:decimal(.))), 0.01 ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isProfitMarginSelf) or cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode='OM'">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not( ( descendant::cbc:TaxExclusiveAmount | descendant::cbc:TaxInclusiveAmount | descendant::cbc:AllowanceTotalAmount | descendant::cbc:ChargeTotalAmount | descendant::cbc:PrepaidAmount | descendant::cbc:PayableAmount | descendant::cbc:Amount | descendant::cbc:PriceAmount | descendant::cbc:BaseAmount | descendant::cbc:Quantity | descendant::cbc:BaseQuantity | descendant::cbc:InvoicedQuantity | descendant::cbc:CreditedQuantity | descendant::cbc:TaxAmount | descendant::cbc:LineExtensionAmount ) [ local-name() != 'PayableRoundingAmount' and normalize-space(.) != '' and . castable as xs:decimal and xs:decimal(.) &lt; 0 ] )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isSimplified and ($isSelfBilled or $isSummary or $isExport or $isImportRCM or $isProfitMargin or $isProfitMarginSelf or $isImportGoods))">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cac:Delivery/cac:Shipment/cac:Delivery/cbc:ActualDeliveryDate) or (matches(cac:Delivery/cac:Shipment/cac:Delivery/cbc:ActualDeliveryDate, '^\d{4}-\d{2}-\d{2}$') and cac:Delivery/cac:Shipment/cac:Delivery/cbc:ActualDeliveryDate castable as xs:date)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cac:AdditionalDocumentReference[cbc:DocumentTypeCode='PM_TOTAL']/cbc:DocumentDescription) or cac:AdditionalDocumentReference[cbc:DocumentTypeCode='PM_TOTAL']/cbc:ID = 'OMR'">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cbc:IssueDate) or (cbc:IssueDate castable as xs:date and xs:date(cbc:IssueDate) &lt;= xs:date(adjust-dateTime-to-timezone(current-dateTime(), xs:dayTimeDuration('PT4H'))))">
   ...
   <xsl:template match="ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal | cn:CreditNote/cac:TaxTotal/cac:TaxSubtotal"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isInvoiceCurrency) or ($vatCategory = ('E', 'O')) or exists(cac:TaxCategory/cbc:Percent)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isInvoiceCurrency) or $isSimplified or not($vatCategory = 'E') or ( cbc:TaxableAmount castable as xs:decimal and u:slack( xs:decimal(cbc:TaxableAmount), xs:decimal(round(u:vatBase($vatCategory, $lines, $allowances, $charges) * 100) div 100), $amountTolerance ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isInvoiceCurrency) or $isSimplified or not($vatCategory = 'O') or ( cbc:TaxableAmount castable as xs:decimal and u:slack( xs:decimal(cbc:TaxableAmount), xs:decimal(round(u:vatBase($vatCategory, $lines, $allowances, $charges) * 100) div 100), $amountTolerance ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isInvoiceCurrency) or $isSimplified or not($vatCategory = 'Z') or ( cbc:TaxableAmount castable as xs:decimal and u:slack( xs:decimal(cbc:TaxableAmount), xs:decimal(round(u:vatBase($vatCategory, $lines, $allowances, $charges) * 100) div 100), $amountTolerance ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isInvoiceCurrency) or not($vatCategory = 'S') or ( cbc:TaxableAmount castable as xs:decimal and cac:TaxCategory/cbc:Percent castable as xs:decimal and u:slack( xs:decimal(cbc:TaxableAmount), xs:decimal(round(( sum($lines[cac:Item/cac:ClassifiedTaxCategory/cbc:ID = $vatCategory and xs:decimal(cac:Item/cac:ClassifiedTaxCategory/cbc:Percent) = xs:decimal(current()/cac:TaxCategory/cbc:Percent)]/cbc:LineExtensionAmount/xs:decimal(.)) + sum($charges[cac:TaxCategory/cbc:ID = $vatCategory and xs:decimal(cac:TaxCategory/cbc:Percent) = xs:decimal(current()/cac:TaxCategory/cbc:Percent)]/cbc:Amount/xs:decimal(.)) - sum($allowances[cac:TaxCategory/cbc:ID = $vatCategory and xs:decimal(cac:TaxCategory/cbc:Percent) = xs:decimal(current()/cac:TaxCategory/cbc:Percent)]/cbc:Amount/xs:decimal(.)) ) * 100) div 100), $amountTolerance ))">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isInvoiceCurrency) or not($vatCategory = 'S') or ( cbc:TaxAmount castable as xs:decimal and u:slack( xs:decimal(cbc:TaxAmount), xs:decimal( round( ( sum($lines[ cac:Item/cac:ClassifiedTaxCategory/cbc:ID = $vatCategory and xs:decimal(cac:Item/cac:ClassifiedTaxCategory/cbc:Percent) = xs:decimal(current()/cac:TaxCategory/cbc:Percent) ]/cac:ItemPriceExtension/cac:TaxTotal/cbc:TaxAmount/xs:decimal(.)) + sum(for $c in $charges[ cac:TaxCategory/cbc:ID = $vatCategory and cac:TaxCategory/cbc:Percent castable as xs:decimal and xs:decimal(cac:TaxCategory/cbc:Percent) = xs:decimal(current()/cac:TaxCategory/cbc:Percent) ] return xs:decimal($c/cbc:Amount) * xs:decimal($c/cac:TaxCategory/cbc:Percent) div 100) - sum(for $a in $allowances[ cac:TaxCategory/cbc:ID = $vatCategory and cac:TaxCategory/cbc:Percent castable as xs:decimal and xs:decimal(cac:TaxCategory/cbc:Percent) = xs:decimal(current()/cac:TaxCategory/cbc:Percent) ] return xs:decimal($a/cbc:Amount) * xs:decimal($a/cac:TaxCategory/cbc:Percent) div 100) ) * 100 ) div 100 ), $amountTolerance ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($taxCurrency != '' and $isTaxCurrency and $vatCategory = 'S') or ( $rate castable as xs:decimal and xs:decimal($rate) = $standardVatRate )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($taxCurrency != '' and $isTaxCurrency and $vatCategory='E') or not(cac:TaxCategory/cbc:Percent)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($taxCurrency != '' and $isTaxCurrency and $vatCategory='O') or not(cac:TaxCategory/cbc:Percent)">
   ...
   <xsl:template match="ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = 'true'] | cn:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator = 'true']"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-058">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($cat='S') or (cac:TaxCategory/cbc:Percent castable as xs:decimal and xs:decimal(cac:TaxCategory/cbc:Percent) = $standardVatRate)">
   ...
   <xsl:template match="ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = 'false'] | cn:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator = 'false']"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cbc:BaseAmount and cbc:MultiplierFactorNumeric) or ( cbc:Amount castable as xs:decimal and cbc:BaseAmount castable as xs:decimal and cbc:MultiplierFactorNumeric castable as xs:decimal and u:slack( xs:decimal(cbc:Amount), xs:decimal( round( ( xs:decimal(cbc:BaseAmount) * xs:decimal(cbc:MultiplierFactorNumeric) div 100 ) * 100 ) div 100 ), 0.01 ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-IBR-041">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-IBR-063">
   ...
   <xsl:template match="cac:InvoiceLine | cac:CreditNoteLine"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($vatCategory='E') or not(cac:Item/cac:ClassifiedTaxCategory/cbc:Percent)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($vatCategory='O') or not(cac:Item/cac:ClassifiedTaxCategory/cbc:Percent)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($vatCategory='E') or u:isZeroOrEmpty($lineTaxAmount)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($vatCategory='O') or u:isZeroOrEmpty($lineTaxAmount)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode) or cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listID = ('HS','MP')">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="u:slack( u:to-decimal($lineExtensionAmount), u:to-decimal(($quantity * (u:to-decimal($priceAmount) div $baseQuantity)) + $chargesTotal - $allowancesTotal), 0.01)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($vatCategory='Z') or u:isZeroOrEmpty($lineTaxAmount)">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode[@listID='HS']) or string-length(normalize-space(cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode[@listID='HS'])) = 12">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isProfitMarginSelf) or $vatCategory='O'">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($isProfitMargin) or (every $code in cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode[@listID='HS'] satisfies not( starts-with(normalize-space($code),'7101') or starts-with(normalize-space($code),'7102') or starts-with(normalize-space($code),'7103') or starts-with(normalize-space($code),'7104') or starts-with(normalize-space($code),'01') or starts-with(normalize-space($code),'06')))">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cac:Price/cac:AllowanceCharge/cbc:BaseAmount) or ( cac:Price/cbc:PriceAmount castable as xs:decimal and cac:Price/cac:AllowanceCharge/cbc:BaseAmount castable as xs:decimal and u:slack( xs:decimal(cac:Price/cbc:PriceAmount), xs:decimal( round( ( xs:decimal(cac:Price/cac:AllowanceCharge/cbc:BaseAmount) - sum(cac:Price/cac:AllowanceCharge/cbc:Amount/xs:decimal(.)) ) * 100 ) div 100 ), 0.01 ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not($vatRate) or ( $lineTaxAmount castable as xs:decimal and cbc:LineExtensionAmount castable as xs:decimal and $vatRate castable as xs:decimal and u:slack( xs:decimal($lineTaxAmount), round( ( xs:decimal(cbc:LineExtensionAmount) * xs:decimal($vatRate) div 100 ) * 100 ) div 100, 0.01 ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="$isProfitMargin or ( cac:ItemPriceExtension/cbc:Amount castable as xs:decimal and u:slack( xs:decimal(cac:ItemPriceExtension/cbc:Amount), xs:decimal(xs:decimal(cbc:LineExtensionAmount) + xs:decimal($lineTaxAmount)), 0.01 ) )">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-CL-02-OM">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-CL-03-OM">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-CL-04-OM">
   ...
   <xsl:template match="cac:Item/cac:ItemSpecificationDocumentReference[cbc:ID/@schemeName='MP']/cbc:DocumentTypeCode"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="((not(contains(normalize-space(.), ' ')) and contains(' G S ', concat(' ', normalize-space(.), ' '))))">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-CL-09-OM">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-CL-11-OM">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:diagnostic-reference diagnostic="d-CL-13-OM">
