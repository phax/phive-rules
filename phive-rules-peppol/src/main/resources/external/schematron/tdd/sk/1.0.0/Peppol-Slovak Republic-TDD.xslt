...
<xsl:stylesheet xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:pxc="urn:peppol:xslt:custom-function" xmlns:pxs="urn:peppol:schema:sk-taxdata:1.0" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
...
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="OpenPeppol TDD Schematron">
      ...
      <svrl:ns-prefix-in-attribute-values prefix="pxs" uri="urn:peppol:schema:sk-taxdata:1.0" />
...
<xsl:variable name="cl_dtc" select="' S R D '" />
  ...
  <xsl:variable name="regex_pidscheme" select="'^[0-9]{4}$'" />
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData" mode="M7" priority="1051">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="normalize-space(cbc:CustomizationID) = 'urn:peppol:taxdata:sk-1'">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="pxs:TaxData/pxs:TaxAuthority" mode="M7" priority="1050">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportingParty" mode="M7" priority="1049">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReceivingParty" mode="M7" priority="1048">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportersRepresentative" mode="M7" priority="1047">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction" mode="M7" priority="1046">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument" mode="M7" priority="1045">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:InvoicePeriod" mode="M7" priority="1044">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/pxs:DocumentLine/cac:InvoicePeriod" mode="M7" priority="1043">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:BillingReference/cac:InvoiceDocumentReference" mode="M7" priority="1042">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty" mode="M7" priority="1041">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party" mode="M7" priority="1040">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress" mode="M7" priority="1039">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country" mode="M7" priority="1038">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme" mode="M7" priority="1037">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M7" priority="1036">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty" mode="M7" priority="1035">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party" mode="M7" priority="1034">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress" mode="M7" priority="1033">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country" mode="M7" priority="1032">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme" mode="M7" priority="1031">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme" mode="M7" priority="1030">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity" mode="M7" priority="1029">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(*[not(self::cbc:RegistrationName)]) = 0">
