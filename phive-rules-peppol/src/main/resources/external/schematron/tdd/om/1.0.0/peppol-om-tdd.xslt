...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:pxs="urn:peppol:schema:om-taxdata:1.0"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="OpenPeppol OM TDD Schematron"
                              schemaVersion="">
         <xsl:comment>
    ...
    Author:
      Susheel Kumar
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2"
                                             prefix="cec"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:peppol:schema:om-taxdata:1.0" prefix="pxs"/>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">OpenPeppol OM TDD Schematron</svrl:text>
   <!--PATTERN default-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="normalize-space(cbc:CustomizationID) = 'urn:peppol:taxdata:om-1'">
   ...
   <xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:ReportedDocument/cac:AccountingSupplierParty"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="every $child in ('CustomerAssignedAccountID', 'DataSendingCapability', 'DespatchContact', 'AccountingContact', 'SellerContact') satisfies count (*[local-name(.) = $child]) = 0">
   ...
   <xsl:template match="/pxs:TaxData/pxs:ReportedTransaction/pxs:SourceDocument/cec:ExtensionContent"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="exists(inv:Invoice) or exists(cn:CreditNote)">
