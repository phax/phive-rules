...
<xsl:function as="xs:string" name="f:schemeAndValue">
  ...
  <xsl:key match="/tsr:TransactionStatisticsReport/tsr:Subtotal[normalize-space(@type) = 'PerTP']" name="key-tp" use="f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'TP'])" />
  <xsl:key match="/tsr:TransactionStatisticsReport/tsr:Subtotal[normalize-space(@type) = 'PerSP-DT-PR']" name="key-spdtpr" use="concat (f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'SP']),'::',                         f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'DT']),'::',                         f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'PR']))" />
  <xsl:key match="/tsr:TransactionStatisticsReport/tsr:Subtotal[normalize-space(@type) = 'PerSP-DT-PR-CC']" name="key-spdtprcc" use="concat (f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'SP']),'::',                         f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'DT']),'::',                         f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'PR']),'::',                         f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'SenderCountry']),'::',                         f:schemeAndValue(tsr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'ReceiverCountry']))" />
...
<xsl:variable name="cl_iso3166" select="' 1A AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE BF BG BH BI BJ BL BM BN BO BQ BR BS BT BV BW BY BZ CA CC CD CF CG CH CI CK CL CM CN CO CR CU CV CW CX CY CZ DE DJ DK DM DO DZ EC EE EG EH EL ER ES ET FI FJ FK FM FO FR GA GB GD GE GF GG GH GI GL GM GN GP GQ GR GS GT GU GW GY HK HM HN HR HT HU ID IE IL IM IN IO IQ IR IS IT JE JM JO JP KE KG KH KI KM KN KP KR KW KY KZ LA LB LC LI LK LR LS LT LU LV LY MA MC MD ME MF MG MH MK ML MM MN MO MP MQ MR MS MT MU MV MW MX MY MZ NA NC NE NF NG NI NL NO NP NR NU NZ OM PA PE PF PG PH PK PL PM PN PR PS PT PW PY QA RE RO RS RU RW SA SB SC SD SE SG SH SI SJ SK SL SM SN SO SR SS ST SV SX SY SZ TC TD TF TG TH TJ TK TL TM TN TO TR TT TV TW TZ UA UG UM US UY UZ VA VC VE VG VI VN VU WF WS XI XK YE YT ZA ZM ZW ZZ '" />
  ...
  <xsl:variable name="name_spdtprcc" select="'Service Provider ID, Dataset Type ID, Process ID, Sender Country and Receiver Country'" />
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport" mode="M8" priority="1008">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$cc_empty or tsr:Subtotal[normalize-space(@type) = 'PerSP-DT-PR-CC']">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$cc_empty or sum(tsr:Subtotal[normalize-space(@type) = 'PerSP-DT-PR-CC']/tsr:Incoming) = tsr:Total/tsr:Incoming">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Header" mode="M8" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Header/tsr:ReporterID" mode="M8" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Subtotal/tsr:Key[normalize-space(@schemeID) = 'CertSubjectCN']" mode="M8" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Subtotal/tsr:Key[normalize-space(@schemeID) = 'SenderCountry' or                                                                           normalize-space(@schemeID) = 'ReceiverCountry']" mode="M8" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Subtotal[normalize-space(@type) = 'PerTP']" mode="M8" priority="1003">
    ...
    <xsl:variable name="name" select="'The subtotal per Transport Protocol ID'" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $tp in (tsr:Key[normalize-space(@metaSchemeID) = 'TP']) satisfies                                                    count(key('key-tp', f:schemeAndValue($tp))) = 1" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $tp in (tsr:Key[normalize-space(@metaSchemeID) = 'TP']) satisfies count(key('key-tp', f:schemeAndValue($tp))) = 1">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Subtotal[normalize-space(@type) = 'PerSP-DT-PR']" mode="M8" priority="1002">
    ...
    <xsl:variable name="name" select="'The subtotal per Service Provider ID, Dataset Type ID and Process ID'" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $sp in (tsr:Key[normalize-space(@metaSchemeID) = 'SP']),                                                        $dt in (tsr:Key[normalize-space(@metaSchemeID) = 'DT']),                                                        $pr in (tsr:Key[normalize-space(@metaSchemeID) = 'PR']) satisfies                                                    count(key('key-spdtpr', concat (f:schemeAndValue($sp),'::',                                                                                    f:schemeAndValue($dt),'::',                                                                                    f:schemeAndValue($pr)))) = 1" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $sp in (tsr:Key[normalize-space(@metaSchemeID) = 'SP']), $dt in (tsr:Key[normalize-space(@metaSchemeID) = 'DT']), $pr in (tsr:Key[normalize-space(@metaSchemeID) = 'PR']) satisfies count(key('key-spdtpr', concat (f:schemeAndValue($sp),'::', f:schemeAndValue($dt),'::', f:schemeAndValue($pr)))) = 1">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Subtotal[normalize-space(@type) = 'PerSP-DT-PR-CC']" mode="M8" priority="1001">
    ...
    <xsl:variable name="name" select="'The subtotal per Service Provider ID, Dataset Type ID, Sender Country and Receiver Country'" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $sp in (tsr:Key[normalize-space(@metaSchemeID) = 'SP']),                                                        $dt in (tsr:Key[normalize-space(@metaSchemeID) = 'DT']),                                                        $pr in (tsr:Key[normalize-space(@metaSchemeID) = 'PR']),                                                        $sc in (tsr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'SenderCountry']),                                                        $rc in (tsr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'ReceiverCountry']) satisfies                                                    count(key('key-spdtprcc', concat (f:schemeAndValue($sp),'::',                                                                                      f:schemeAndValue($dt),'::',                                                                                      f:schemeAndValue($pr),'::',                                                                                      f:schemeAndValue($sc),'::',                                                                                      f:schemeAndValue($rc)))) = 1" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $sp in (tsr:Key[normalize-space(@metaSchemeID) = 'SP']), $dt in (tsr:Key[normalize-space(@metaSchemeID) = 'DT']), $pr in (tsr:Key[normalize-space(@metaSchemeID) = 'PR']), $sc in (tsr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'SenderCountry']), $rc in (tsr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'ReceiverCountry']) satisfies count(key('key-spdtprcc', concat (f:schemeAndValue($sp),'::', f:schemeAndValue($dt),'::', f:schemeAndValue($pr),'::', f:schemeAndValue($sc),'::', f:schemeAndValue($rc)))) = 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="tsr:Outgoing = 0">
	...
	<!--RULE -->
<xsl:template match="/tsr:TransactionStatisticsReport/tsr:Subtotal" mode="M8" priority="1000">
