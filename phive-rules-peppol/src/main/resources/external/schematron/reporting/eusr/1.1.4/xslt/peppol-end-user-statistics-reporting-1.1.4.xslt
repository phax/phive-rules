...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset/eusr:Key[normalize-space(@schemeID) = 'EndUserCountry']" mode="M3" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR-EUC']" mode="M3" priority="1002">
