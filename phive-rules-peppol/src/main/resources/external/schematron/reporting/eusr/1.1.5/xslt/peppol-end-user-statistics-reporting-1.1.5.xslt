...
<!--KEYS AND FUNCTIONS-->
<xsl:function as="xs:string" name="f:schemeAndValue">
    <xsl:param name="node" />
    <xsl:variable as="xs:integer" name="count" select="count($node)" />
    <xsl:choose>
  ...
  <xsl:key match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR']" name="key-dtpr" use="concat (f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'DT']),'::',                         f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'PR']))" />
  <xsl:key match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR-EUC']" name="key-dtpreuc" use="concat (f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'DT']),'::',                         f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'PR']),'::',                         f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']))" />
  <xsl:key match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-EUC']" name="key-dteuc" use="concat (f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'DT']),'::',                         f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']))" />
  <xsl:key match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerEUC']" name="key-euc" use="f:schemeAndValue(eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry'])" />
...
<xsl:template match="/">
    ...
    History
      ...
      <svrl:ns-prefix-in-attribute-values prefix="f" uri="#functions" />
      <svrl:active-pattern>
...
<xsl:variable name="cl_iso3166" select="' 1A AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE BF BG BH BI BJ BL BM BN BO BQ BR BS BT BV BW BY BZ CA CC CD CF CG CH CI CK CL CM CN CO CR CU CV CW CX CY CZ DE DJ DK DM DO DZ EC EE EG EH EL ER ES ET FI FJ FK FM FO FR GA GB GD GE GF GG GH GI GL GM GN GP GQ GR GS GT GU GW GY HK HM HN HR HT HU ID IE IL IM IN IO IQ IR IS IT JE JM JO JP KE KG KH KI KM KN KP KR KW KY KZ LA LB LC LI LK LR LS LT LU LV LY MA MC MD ME MF MG MH MK ML MM MN MO MP MQ MR MS MT MU MV MW MX MY MZ NA NC NE NF NG NI NL NO NP NR NU NZ OM PA PE PF PG PH PK PL PM PN PR PS PT PW PY QA RE RO RS RU RW SA SB SC SD SE SG SH SI SJ SK SL SM SN SO SR SS ST SV SX SY SZ TC TD TF TG TH TJ TK TL TM TN TO TR TT TV TW TZ UA UG UM US UY UZ VA VC VE VG VI VN VU WF WS XI XK YE YT ZA ZM ZW '" />
  <xsl:variable name="cl_spidtype" select="' CertSubjectCN '" />
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport" mode="M9" priority="1007">
    <svrl:fired-rule context="/eusr:EndUserStatisticsReport" />
    <xsl:variable name="total" select="xs:integer(eusr:FullSet/eusr:SendingEndUsers) + xs:integer(eusr:FullSet/eusr:ReceivingEndUsers)" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="normalize-space(eusr:CustomizationID) = 'urn:fdc:peppol.eu:edec:trns:end-user-statistics-report:1.1'">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$empty or max(eusr:Subset/eusr:SendingEndUsers) le xs:integer(eusr:FullSet/eusr:SendingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$empty or max(eusr:Subset/eusr:ReceivingEndUsers) le xs:integer(eusr:FullSet/eusr:ReceivingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$empty or max(eusr:Subset/eusr:SendingOrReceivingEndUsers) le xs:integer(eusr:FullSet/eusr:SendingOrReceivingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="xs:integer(eusr:FullSet/eusr:SendingOrReceivingEndUsers) &lt;= $total">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="xs:integer(eusr:FullSet/eusr:SendingOrReceivingEndUsers) >= xs:integer(eusr:FullSet/eusr:SendingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="xs:integer(eusr:FullSet/eusr:SendingOrReceivingEndUsers) >= xs:integer(eusr:FullSet/eusr:ReceivingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(eusr:Subset[normalize-space(@type) !='PerDT-PR' and normalize-space(@type) !='PerDT-PR-EUC' and normalize-space(@type) !='PerDT-EUC' and normalize-space(@type) !='PerEUC']) = 0">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="every $st in (eusr:Subset) satisfies xs:integer($st/eusr:SendingOrReceivingEndUsers) &lt;= xs:integer($st/eusr:SendingEndUsers + $st/eusr:ReceivingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="every $st in (eusr:Subset) satisfies xs:integer($st/eusr:SendingOrReceivingEndUsers) >= xs:integer($st/eusr:SendingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="every $st in (eusr:Subset) satisfies xs:integer($st/eusr:SendingOrReceivingEndUsers) >= xs:integer($st/eusr:ReceivingEndUsers)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="every $st in (eusr:Subset) satisfies xs:integer($st/eusr:SendingOrReceivingEndUsers) > 0">
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Header" mode="M9" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Header/eusr:ReporterID" mode="M9" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset/eusr:Key[normalize-space(@schemeID) = 'EndUserCountry']" mode="M9" priority="1004">
    <svrl:fired-rule context="/eusr:EndUserStatisticsReport/eusr:Subset/eusr:Key[normalize-space(@schemeID) = 'EndUserCountry']" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR']" mode="M9" priority="1003">
    ...
    <xsl:variable name="name" select="'The subset per Dataset Type ID and Process ID'" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $dt in (eusr:Key[normalize-space(@metaSchemeID) = 'DT']),                                                         $pr in (eusr:Key[normalize-space(@metaSchemeID) = 'PR']) satisfies                                                     count(key('key-dtpr', concat (f:schemeAndValue($dt),'::',                                                                                   f:schemeAndValue($pr)))) = 1" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $dt in (eusr:Key[normalize-space(@metaSchemeID) = 'DT']), $pr in (eusr:Key[normalize-space(@metaSchemeID) = 'PR']) satisfies count(key('key-dtpr', concat (f:schemeAndValue($dt),'::', f:schemeAndValue($pr)))) = 1">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR-EUC']" mode="M9" priority="1002">
    <svrl:fired-rule context="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR-EUC']" />
    <xsl:variable name="name" select="'The subset per Dataset Type ID, Process ID and End User Country'" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $dt in (eusr:Key[normalize-space(@metaSchemeID) = 'DT']),                                                         $pr in (eusr:Key[normalize-space(@metaSchemeID) = 'PR']),                                                         $euc in (eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']) satisfies                                                     count(key('key-dtpreuc', concat (f:schemeAndValue($dt),'::',                                                                                      f:schemeAndValue($pr),'::',                                                                                      f:schemeAndValue($euc)))) = 1" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $dt in (eusr:Key[normalize-space(@metaSchemeID) = 'DT']), $pr in (eusr:Key[normalize-space(@metaSchemeID) = 'PR']), $euc in (eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']) satisfies count(key('key-dtpreuc', concat (f:schemeAndValue($dt),'::', f:schemeAndValue($pr),'::', f:schemeAndValue($euc)))) = 1">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(eusr:Key) = 3">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-EUC']" mode="M9" priority="1001">
    ...
    <xsl:variable name="name" select="'The subset per Dataset Type ID and End User Country'" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $dt in (eusr:Key[normalize-space(@metaSchemeID) = 'DT']),                                                         $euc in (eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']) satisfies                                                     count(key('key-dteuc', concat (f:schemeAndValue($dt),'::',                                                                                    f:schemeAndValue($euc)))) = 1" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $dt in (eusr:Key[normalize-space(@metaSchemeID) = 'DT']), $euc in (eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']) satisfies count(key('key-dteuc', concat (f:schemeAndValue($dt),'::', f:schemeAndValue($euc)))) = 1">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerEUC']" mode="M9" priority="1000">
    ...
    <xsl:variable name="name" select="'The subset per End User Country'" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="every $euc in (eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']) satisfies                                                     count(key('key-euc', f:schemeAndValue($euc))) = 1" />
      <xsl:otherwise>
        <svrl:failed-assert test="every $euc in (eusr:Key[normalize-space(@metaSchemeID) = 'CC'][normalize-space(@schemeID) = 'EndUserCountry']) satisfies count(key('key-euc', f:schemeAndValue($euc))) = 1">
