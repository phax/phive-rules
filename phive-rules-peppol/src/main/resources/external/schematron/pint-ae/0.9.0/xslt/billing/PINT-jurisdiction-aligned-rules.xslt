...
<!--PATTERN UBL-modelaligned-->
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" mode="M12" priority="1038">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="((cbc:InvoiceTypeCode = &quot;480&quot; or cbc:InvoiceTypeCode = &quot;81&quot;) and cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID) or not(cbc:InvoiceTypeCode = &quot;480&quot; or cbc:InvoiceTypeCode = &quot;81&quot;)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="((cac:PartyIdentification/cbc:ID or cac:PartyTaxScheme/cbc:CompanyID) and (not(matches(../../cbc:ProfileExecutionID, &quot;^\d{7}1$&quot;)) and cbc:EndpointID/@schemeID = &quot;0235&quot; and not(matches(cbc:EndpointID, &quot;^1\d{9}$&quot;)))) or not(not(matches(../../cbc:ProfileExecutionID, &quot;^\d{7}1$&quot;)) and cbc:EndpointID/@schemeID = &quot;0235&quot; and not(matches(cbc:EndpointID, &quot;^1\d{9}$&quot;)))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches(cbc:ProfileExecutionID, &quot;^1[01]{6}$&quot;)) or cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cbc:InvoiceTypeCode = &quot;480&quot; or cbc:InvoiceTypeCode = &quot;81&quot;) and cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme[cac:TaxScheme/cbc:ID = &quot;VAT&quot;]/cbc:CompanyID) or (cbc:InvoiceTypeCode = &quot;480&quot; or cbc:InvoiceTypeCode = &quot;81&quot;)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches(cbc:ProfileExecutionID, &quot;^.{7}1$&quot;)) or (cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName and cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName and cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CountrySubentity)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:TaxCurrencyCode = &quot;AED&quot; and cbc:DocumentCurrencyCode != &quot;AED&quot; and (not(cac:PricingExchangeRate/cbc:SourceCurrencyCode = cbc:DocumentCurrencyCode) or not(cac:PricingExchangeRate/cbc:TargetCurrencyCode = cbc:TaxCurrencyCode) or not(cac:PricingExchangeRate/cbc:CalculationRate)))">
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="((matches(cbc:ProfileExecutionID, &quot;^[01]{1}1[01]{6}$&quot;)) and matches(cac:AccountingCustomerParty/cac:Party/cbc:EndpointID[@schemeID=&quot;0235&quot;],&quot;^1[0-9]{9}$&quot;)) or not(matches(cbc:ProfileExecutionID, &quot;^[01]{1}1[01]{6}$&quot;))" />
      <xsl:otherwise>
        <svrl:failed-assert test="((matches(cbc:ProfileExecutionID, &quot;^[01]{1}1[01]{6}$&quot;)) and matches(cac:AccountingCustomerParty/cac:Party/cbc:EndpointID[@schemeID=&quot;0235&quot;],&quot;^1[0-9]{9}$&quot;)) or not(matches(cbc:ProfileExecutionID, &quot;^[01]{1}1[01]{6}$&quot;))">
          <xsl:attribute name="id">ibr-155-ae</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-155-ae]-Where Invoice transaction-type code (BTAE-02) is X1XXXXXX (Deemed supply), then the document is not required to be exchanged and defined end point (0235:1XXXXXXXXXXX) should be used for buyer.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="cbc:DocumentCurrencyCode = &quot;AED&quot; or (cbc:DocumentCurrencyCode != &quot;AED&quot; and cbc:TaxCurrencyCode = &quot;AED&quot; and round(cac:TaxTotal/cbc:TaxAmount[@currencyID = &quot;AED&quot;], 2) = round(cac:PricingExchangeRate/cbc:CalculationRate * cac:TaxTotal/cbc:TaxAmount[@currencyID != &quot;AED&quot;], 2))" />
      <xsl:otherwise>
        <svrl:failed-assert test="cbc:DocumentCurrencyCode = &quot;AED&quot; or (cbc:DocumentCurrencyCode != &quot;AED&quot; and cbc:TaxCurrencyCode = &quot;AED&quot; and round(cac:TaxTotal/cbc:TaxAmount[@currencyID = &quot;AED&quot;], 2) = round(cac:PricingExchangeRate/cbc:CalculationRate * cac:TaxTotal/cbc:TaxAmount[@currencyID != &quot;AED&quot;], 2))">
          <xsl:attribute name="id">ibr-175-ae</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-175-ae]-When Invoice currency code [IBT-005] is other than 'AED' and VAT accounting currency [IBT-006] is 'AED', then the value in Invoice total VAT amount in VAT accounting currency [IBT-111] should be Currency exchange rate [BTAE-004] * Invoice Total VAT amount [IBT-110] and the value should be rounded off and should not be more than 2 decimals.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cac:PaymentMeans/cbc:PaymentMeansCode) = not((cbc:InvoiceTypeCode|cbc:CreditNoteTypeCode) = &quot;81&quot; or (cbc:InvoiceTypeCode|cbc:CreditNoteTypeCode) = &quot;381&quot; or (cbc:InvoiceTypeCode|cbc:CreditNoteTypeCode) = &quot;261&quot;or matches(cbc:ProfileExecutionID, &quot;^\d1\d{6}$&quot;))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(cbc:ProfileExecutionID) &lt;= 8 and (matches(cbc:ProfileExecutionID, &quot;^[01]{1,8}$&quot;))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="../../cac:TaxTotal/cbc:TaxAmount =  (round( ../../cbc:LineExtensionAmount * (cbc:Percent) * 100) div 100) div 100" />
      <xsl:otherwise>
        <svrl:failed-assert test="../../cac:TaxTotal/cbc:TaxAmount = (round( ../../cbc:LineExtensionAmount * (cbc:Percent) * 100) div 100) div 100">
          <xsl:attribute name="id">ibr-161-ae</xsl:attribute>
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>[ibr-161-ae]-In Line VAT information (IBG-30) in case the Invoiced item VAT category code (IBT-151) is 'Standard Rate', VAT Line amount [BTAE-08] shall be Invoice line net amount (IBT131) * Invoice item VAT rate (IBT 152) / 100..</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M12" select="@*|*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(cbc:TaxAmount)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="../../cac:TaxTotal/cbc:TaxAmount = 0" />
      <xsl:otherwise>
        <svrl:failed-assert test="../../cac:TaxTotal/cbc:TaxAmount = 0">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AE']/cac:PartyTaxScheme/cbc:CompanyID" mode="M12" priority="1002">
    <svrl:fired-rule context="cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AE']/cac:PartyTaxScheme/cbc:CompanyID" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID" mode="M12" priority="1001">
