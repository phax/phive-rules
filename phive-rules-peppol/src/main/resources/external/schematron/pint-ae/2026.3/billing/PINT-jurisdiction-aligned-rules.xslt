...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches((ancestor::*[local-name()='Invoice' or local-name()='CreditNote'][1]/cbc:ProfileExecutionID)[1], '^[01]51[01]2$')) or exists(cac:PartyTaxScheme/cbc:CompanyID) or exists(cac:PartyIdentification/cbc:ID)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;480&quot;) and (//cac:TaxCategory/cbc:ID = &quot;E&quot; or //cac:TaxCategory/cbc:ID = &quot;O&quot; or //cac:TaxCategory/cbc:ID = &quot;Z&quot;) and (//cac:ClassifiedTaxCategory/cbc:ID = &quot;E&quot; or //cac:ClassifiedTaxCategory/cbc:ID = &quot;O&quot; or //cac:ClassifiedTaxCategory/cbc:ID = &quot;Z&quot;)) or not((cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;81&quot; or (cbc:InvoiceTypeCode | cbc:CreditNoteTypeCode) = &quot;480&quot;)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="not(matches(cbc:ProfileExecutionID, &quot;^[01]{2}1[01]{5}$&quot;)) or not(//cac:TaxCategory/cbc:ID[normalize-space(.) != &quot;N&quot;])">
