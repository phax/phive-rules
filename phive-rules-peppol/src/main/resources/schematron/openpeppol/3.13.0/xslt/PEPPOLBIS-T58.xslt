...
<xsl:variable name="cleas" select="tokenize('0002 0007 0009 0037 0060 0088 0096 0097 0106 0130 0135 0142 0151 0183 0184 0190 0191 0192 0193 0195 0196 0198 0199 0200 0201 0202 0204 0208 0209 0210 0211 0212 0213 9901 9906 9907 9910 9913 9914 9915 9918 9919 9920 9922 9923 9924 9925 9926 9927 9928 9929 9930 9931 9932 9933 9934 9935 9936 9937 9938 9939 9940 9941 9942 9943 9944 9945 9946 9947 9948 9949 9950 9951 9952 9953 9955 9957', '\s')" />
  ...
  <xsl:variable name="clUNCL4343" select="tokenize('AB AP RE', '\s')" />
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse" mode="M18" priority="1032">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:CustomizationID" mode="M18" priority="1031">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:CustomizationID" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:ProfileID" mode="M18" priority="1030">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:ID" mode="M18" priority="1029">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:ID" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:IssueDate" mode="M18" priority="1028">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:IssueDate" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:IssueTime" mode="M18" priority="1027">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:IssueTime" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:Note" mode="M18" priority="1026">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:Note" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty" mode="M18" priority="1025">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cbc:EndpointID" mode="M18" priority="1024">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyIdentification" mode="M18" priority="1023">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyIdentification/cbc:ID" mode="M18" priority="1022">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity" mode="M18" priority="1021">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/cbc:RegistrationName" mode="M18" priority="1020">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/*" mode="M18" priority="1019">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/*" mode="M18" priority="1018">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty" mode="M18" priority="1017">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cbc:EndpointID" mode="M18" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification" mode="M18" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification/cbc:ID" mode="M18" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity" mode="M18" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/cbc:RegistrationName" mode="M18" priority="1012">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/*" mode="M18" priority="1011">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/*" mode="M18" priority="1010">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:ReceiverParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse" mode="M18" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response" mode="M18" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:ResponseCode" mode="M18" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/*" mode="M18" priority="1006">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference" mode="M18" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:ID" mode="M18" priority="1004">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:VersionID" mode="M18" priority="1003">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:VersionID" />
    <xsl:apply-templates mode="M18" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/*" mode="M18" priority="1002">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/*" />
