...
/**
 * OpenPeppol validation artefacts release May 2026.<br>
 * Covers Peppol BIS Billing 3.0.21, Peppol BIS Self-Billing 3.0.2 and Peppol BIS 3.0.17 (Upgrade-3
 * Post-Award).<br>
 * Publication date: 2026-05-18.<br>
 * Mandatory use from: Monday 2026-08-17
 *
...
public final class PeppolValidation2026_05
{
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_CREDIT_NOTE_UBL_V3 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                    ...
                                                                                                    VERSION_STR);
  // Self-Billing 3.0.2
  public static final DVRCoordinate VID_OPENPEPPOL_INVOICE_SELF_BILLING_UBL_V3 = DVRHelper.createCoordinate (GROUP_ID,
                                                                                                             "invoice-self-billing",
                                                                                                             VERSION_STR);
  public static final DVRCoordinate VID_OPENPEPPOL_CREDIT_NOTE_SELF_BILLING_UBL_V3 = DVRHelper.createCoordinate (GROUP_ID,
