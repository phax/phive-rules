  ...
  public static void init (@NonNull final IValidationExecutorSetRegistry <IValidationSourceXML> aRegistry)
  {
    ...
    // 1.1.2
    {
      ...
      final ClassPathResource aCPR2 = new ClassPathResource (BASE_PATH +
                                                             ...
                                                             _getCL ());
      aRegistry.registerValidationExecutorSet (ValidationExecutorSet.create (VID_OPENPEPPOL_JP_PINT_NTR_INVOICE_1_1_2,
                                                                             "Peppol PINT Japan Invoice for Non-tax Registered Businesses (UBL) 1.1.2",
                                                                             PhiveRulesHelper.createSimpleStatus (bNotDeprecated,
                                                                             ...
                                                                             PhiveRulesHelper.createXSLT (aCPR2,
                                                                                                          aNSCtxInvoice)));
      aRegistry.registerValidationExecutorSet (ValidationExecutorSet.create (VID_OPENPEPPOL_JP_PINT_NTR_CREDIT_NOTE_1_1_2,
                                                                             "Peppol PINT Japan Credit Note for Non-tax Registered Businesses (UBL) 1.1.2",
                                                                             PhiveRulesHelper.createSimpleStatus (bNotDeprecated,
                                                                                                                  V1_1_2_VALID_PER_UTC),
                                                                             PhiveRulesHelper.createXSLT (aCPR1,
                                                                                                          aNSCtxCreditNote),
