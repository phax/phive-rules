...
public final class PeppolValidationPintJP_NTR
{
  ...
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_NTR_INVOICE_1_1_2 = PhiveRulesHelper.createCoordinate (GROUP_ID,
                                                                                                                  "invoice",
                                                                                                                  "1.1.2");
  @Deprecated (forRemoval = false)
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_NTR_CREDIT_NOTE_1_1_2 = PhiveRulesHelper.createCoordinate (GROUP_ID,
                                                                                                                      "credit-note",
                                                                                                                      "1.1.2");
  ...
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_NTR_INVOICE_1_1_3 = PhiveRulesHelper.createCoordinate (GROUP_ID,
                                                                                                                  "invoice",
                                                                                                                  "1.1.3");
  public static final DVRCoordinate VID_OPENPEPPOL_JP_PINT_NTR_CREDIT_NOTE_1_1_3 = PhiveRulesHelper.createCoordinate (GROUP_ID,
                                                                                                                      "credit-note",
                                                                                                                      "1.1.3");
