<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:pxc="urn:peppol:xslt:custom-function" queryBinding="xslt2">
  ...
  <pattern id="default">
    ...
    <rule context="/pxs:TaxData/pxs:ReceivingParty">
      ...
      <assert id="ibr-tdd-17" flag="fatal" test="not(exists(cbc:EndpointID/@schemeID)) or (cbc:EndpointID/@schemeID = '0242')">[ibr-tdd-17] Receivers Endpoint Scheme identifier (tdt-008-1) MUST refer to an SPIS</assert>
    </rule>
    ...
    <rule context="/pxs:TaxData/pxs:ReportersRepresentative/cac:PartyIdentification">
      ...
      <assert id="ibr-tdd-21" flag="fatal" test="not(exists(cbc:ID/@schemeID)) or                                                   (cbc:ID/@schemeID = '0242')">[ibr-tdd-21] Reporters Representative ID Scheme identifier (tdt-009-1) MUST refer to an SPIS</assert>
    </rule>
    ...
    <rule context="/pxs:TaxData/pxs:ReportedTransaction">
      ...
      <assert id="ibr-tdd-22" flag="fatal" test="exists(pxs:ReportedDocument) or ($checkForReportedDocument)">[ibr-tdd-22] The REPORTED DOCUMENT (tdg-02) MUST be present</assert>
