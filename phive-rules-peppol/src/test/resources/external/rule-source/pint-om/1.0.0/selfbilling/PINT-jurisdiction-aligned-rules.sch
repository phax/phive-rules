   ...
   <xsl:function name="u:to-decimal" as="xs:decimal">
    ...
    <pattern id="Aligned-om-rules">
        ...
        <rule context="ubl:Invoice | cn:CreditNote">
            ...
            <assert id="ALIGNED-IBRP-002-OM" flag="fatal" role="fatal" test="starts-with($profileID, 'urn:peppol:pint:selfbilling')" diagnostics="d-002">[ALIGNED-IBRP-002-OM] - Business process (IBT-023) must follow the expected format 'urn:peppol:pint:selfbilling'.</assert>
