<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern>
	     ...
	     <rule context="cac:Status[cbc:StatusReasonCode='PPD']">
		       <assert id="PEPPOL-T111-R004" test="exists(cbc:StatusReason)" flag="fatal">[PEPPOL-T111-R004]-If Clarification code is PPD, indicating partial payment, then Clarification reason SHALL be provided.</assert>
