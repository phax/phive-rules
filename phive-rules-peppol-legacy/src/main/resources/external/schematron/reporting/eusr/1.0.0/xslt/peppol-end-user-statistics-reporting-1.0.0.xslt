...
<xsl:variable name="cl_iso3166" select="' 1A AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE BF BG BH BI BJ BL BM BN BO BQ BR BS BT BV BW BY BZ CA CC CD CF CG CH CI CK CL CM CN CO CR CU CV CW CX CY CZ DE DJ DK DM DO DZ EC EE EG EH EL ER ES ET FI FJ FK FM FO FR GA GB GD GE GF GG GH GI GL GM GN GP GQ GR GS GT GU GW GY HK HM HN HR HT HU ID IE IL IM IN IO IQ IR IS IT JE JM JO JP KE KG KH KI KM KN KP KR KW KY KZ LA LB LC LI LK LR LS LT LU LV LY MA MC MD ME MF MG MH MK ML MM MN MO MP MQ MR MS MT MU MV MW MX MY MZ NA NC NE NF NG NI NL NO NP NR NU NZ OM PA PE PF PG PH PK PL PM PN PR PS PT PW PY QA RE RO RS RU RW SA SB SC SD SE SG SH SI SJ SK SL SM SN SO SR SS ST SV SX SY SZ TC TD TF TG TH TJ TK TL TM TN TO TR TT TV TW TZ UA UG UM US UY UZ VA VC VE VG VI VN VU WF WS XI XK YE YT ZA ZM ZW '" />
  <xsl:variable name="cl_spidtype" select="' CertSubjectCN '" />
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport" mode="M3" priority="1005">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="count(eusr:Subset[normalize-space(@type) !='PerDT-PR' and                                                                      normalize-space(@type) !='PerDT-PR-CC']) = 0" />
      <xsl:otherwise>
        <svrl:failed-assert test="count(eusr:Subset[normalize-space(@type) !='PerDT-PR' and normalize-space(@type) !='PerDT-PR-CC']) = 0">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Header" mode="M3" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Header/eusr:ReporterID" mode="M3" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset/eusr:Key[normalize-space(@schemeID) = 'SenderCountry' or                                                                        normalize-space(@schemeID) = 'ReceiverCountry']" mode="M3" priority="1002">
    <svrl:fired-rule context="/eusr:EndUserStatisticsReport/eusr:Subset/eusr:Key[normalize-space(@schemeID) = 'SenderCountry' or                                                                        normalize-space(@schemeID) = 'ReceiverCountry']" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR']" mode="M3" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/eusr:EndUserStatisticsReport/eusr:Subset[normalize-space(@type) = 'PerDT-PR-CC']" mode="M3" priority="1000">
