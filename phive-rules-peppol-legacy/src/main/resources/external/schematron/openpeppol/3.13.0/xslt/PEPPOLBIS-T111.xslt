...
<xsl:variable name="clOPStatusReason" select="tokenize('NON REF LEG REC QUA DEL PRI QTY ITM PAY UNR FIN PPD OTH', '\s')" />
  ...
  <xsl:variable name="clOPStatusAction" select="tokenize('NOA PIN NIN CNF CNP CNA OTH', '\s')" />
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse" mode="M17" priority="1059">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:CustomizationID" mode="M17" priority="1058">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:CustomizationID" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:ProfileID" mode="M17" priority="1057">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:ID" mode="M17" priority="1056">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:ID" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:IssueDate" mode="M17" priority="1055">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:IssueDate" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:IssueTime" mode="M17" priority="1054">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:IssueTime" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cbc:Note" mode="M17" priority="1053">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cbc:Note" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty" mode="M17" priority="1052">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cbc:EndpointID" mode="M17" priority="1051">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyIdentification" mode="M17" priority="1050">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyIdentification/cbc:ID" mode="M17" priority="1049">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity" mode="M17" priority="1048">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/cbc:RegistrationName" mode="M17" priority="1047">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/*" mode="M17" priority="1046">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact" mode="M17" priority="1045">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/cbc:Name" mode="M17" priority="1044">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/cbc:Name" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/cbc:Telephone" mode="M17" priority="1043">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/cbc:Telephone" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/cbc:ElectronicMail" mode="M17" priority="1042">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/cbc:ElectronicMail" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/*" mode="M17" priority="1041">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/*" mode="M17" priority="1040">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:SenderParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty" mode="M17" priority="1039">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cbc:EndpointID" mode="M17" priority="1038">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification" mode="M17" priority="1037">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification/cbc:ID" mode="M17" priority="1036">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity" mode="M17" priority="1035">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/cbc:RegistrationName" mode="M17" priority="1034">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/cbc:RegistrationName" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/*" mode="M17" priority="1033">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:ReceiverParty/cac:PartyLegalEntity/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/*" mode="M17" priority="1032">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:ReceiverParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse" mode="M17" priority="1031">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response" mode="M17" priority="1030">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:ResponseCode" mode="M17" priority="1029">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:EffectiveDate" mode="M17" priority="1028">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:EffectiveDate" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status" mode="M17" priority="1027">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cbc:StatusReasonCode" mode="M17" priority="1026">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cbc:StatusReason" mode="M17" priority="1025">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cbc:StatusReason" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cac:Condition" mode="M17" priority="1024">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cac:Condition/cbc:AttributeID" mode="M17" priority="1023">
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cac:Condition/cbc:Description" mode="M17" priority="1022">
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cac:Condition/*" mode="M17" priority="1021">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/cac:Condition/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/*" mode="M17" priority="1020">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/cac:Status/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/*" mode="M17" priority="1019">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:Response/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference" mode="M17" priority="1018">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:ID" mode="M17" priority="1017">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:ID" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:IssueDate" mode="M17" priority="1016">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:IssueDate" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/cbc:DocumentTypeCode" mode="M17" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/*" mode="M17" priority="1014">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:DocumentReference/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty" mode="M17" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty/cac:PartyIdentification" mode="M17" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty/cac:PartyIdentification/cbc:ID" mode="M17" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty/cac:PartyName" mode="M17" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty/cac:PartyName/cbc:Name" mode="M17" priority="1009">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty/*" mode="M17" priority="1008">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:IssuerParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty" mode="M17" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty/cac:PartyIdentification" mode="M17" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty/cac:PartyIdentification/cbc:ID" mode="M17" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty/cac:PartyName" mode="M17" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty/cac:PartyName/cbc:Name" mode="M17" priority="1003">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty/cac:PartyName/cbc:Name" />
    <xsl:apply-templates mode="M17" select="*" />
  </xsl:template>

	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty/*" mode="M17" priority="1002">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/cac:RecipientParty/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/*" mode="M17" priority="1001">
    <svrl:fired-rule context="/ubl:ApplicationResponse/cac:DocumentResponse/*" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse/*" mode="M17" priority="1000">
    <svrl:fired-rule context="/ubl:ApplicationResponse/*" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:Response[contains( ' CA UQ RE ',concat(' ',normalize-space(cbc:ResponseCode),' '))]" mode="M18" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Status[cbc:StatusReasonCode='OTH']" mode="M18" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:CustomizationID" mode="M18" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Status[cbc:StatusReasonCode='PPD']" mode="M18" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:Status[cbc:StatusReasonCode/@listID='OPStatusAction']" mode="M19" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Status[cbc:StatusReasonCode/@listID='OPStatusReason']" mode="M19" priority="1000">
