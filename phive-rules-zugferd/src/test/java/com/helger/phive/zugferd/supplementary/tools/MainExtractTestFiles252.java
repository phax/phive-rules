...
public final class MainExtractTestFiles252
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainExtractTestFiles252.class);

  public static void main (final String [] args)
  {
    // TODO edit the following 2 lines for a new version
    final File fBasePath = new File ("docs/2.5/ZUGFeRD_2.5.2_EN/Examples").getAbsoluteFile ();
    final File fTargetPath = new File ("src/test/resources/external/test-files/2.5.2").getAbsoluteFile ();
